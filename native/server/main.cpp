...
struct Session {
 D5Session sdk=nullptr;std::string config_key;uint64_t frame=0;uint32_t source_width=0,source_height=0;CUdevice device=0;CUcontext context=nullptr;CUstream stream=nullptr;
