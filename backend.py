...
class Backend:
    ...
    def report(self):
        report={'backend':'TileLang SM89 NVRTC + frozen Torch graph','counters':dict(self.stats),
                ...
                'temporal_inputs_scope':'F32 cache/current concatenation and APE addition to exact Half projection inputs; shared KV and contiguous Q, original projections/attention/raw caches.',
                'depth_attention_scope':'DINO direct probability consumer dtype; original F32 softmax accumulation, QK/PV, autocast mode and complete metric-depth/cache proposal.',
