...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(const uchar* __restrict__ A, int* __restrict__ C0, uchar* __restrict__ Raw, const uchar* __restrict__ Skip, const uchar* __restrict__ Weight) {
  ...
  for (int r = 0; r < 4; ++r) {
    for (int n = 0; n < 8; ++n) {
      for (int h = 0; h < 2; ++h) {
        c[(((r * 16) + (n * 2)) + h)] = (uint)0;
        v = (uint)0;
        if ((((((int)blockIdx.x) % 3) * 2) + (r & 1)) < 5) {
          v = ((nr_ld32((&(Skip[(((((((((((((((((int)blockIdx.x) / 3) * 81920) + (((((int)threadIdx.x) >> 5) & 3) * 20480)) + ((n >> 1) * 5120)) + (((int)blockIdx.y) * 2560)) + ((r >> 1) * 1280)) + (h * 640)) + (((((int)threadIdx.x) & 31) >> 4) * 320)) + ((((int)blockIdx.x) % 3) * 128)) + ((r & 1) * 64)) + (((((int)threadIdx.x) & 15) >> 2) * 16)) + ((((((((int)blockIdx.x) / 3) * 256) + (((((int)threadIdx.x) >> 5) & 3) * 64)) + (n * 8)) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 1)) + (((((((((int)blockIdx.x) / 3) * 256) + (((((int)threadIdx.x) >> 5) & 3) * 64)) + (n * 8)) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 6) << 1)) + (((((((((int)blockIdx.x) / 3) * 256) + (((((int)threadIdx.x) >> 5) & 3) * 64)) + (n * 8)) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 8) >> 2)) & -4)]))) >> ((uint)((((((((((((((((((int)blockIdx.x) / 3) * 81920) + (((((int)threadIdx.x) >> 5) & 3) * 20480)) + ((n >> 1) * 5120)) + (((int)blockIdx.y) * 2560)) + ((r >> 1) * 1280)) + (h * 640)) + (((((int)threadIdx.x) & 31) >> 4) * 320)) + ((((int)blockIdx.x) % 3) * 128)) + ((r & 1) * 64)) + (((((int)threadIdx.x) & 15) >> 2) * 16)) + ((((((((int)blockIdx.x) / 3) * 256) + (((((int)threadIdx.x) >> 5) & 3) * 64)) + (n * 8)) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 1)) + (((((((((int)blockIdx.x) / 3) * 256) + (((((int)threadIdx.x) >> 5) & 3) * 64)) + (n * 8)) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 6) << 1)) + (((((((((int)blockIdx.x) / 3) * 256) + (((((int)threadIdx.x) >> 5) & 3) * 64)) + (n * 8)) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 8) >> 2)) & 3) * 8))) & (uint)65535);
        }
        uint a = nr_decode2(v);
  ...
  for (int t = 0; t < 4; ++t) {
    if ((((((int)blockIdx.x) % 3) * 2) + (t & 1)) < 5) {
      for (int z_2 = 0; z_2 < 8; ++z_2) {
        ...
        nr_st32((&(Raw[(((((((((((int)blockIdx.y) * 81920) + ((t >> 1) * 40960)) + ((((int)blockIdx.x) % 3) * 16384)) + ((t & 1) * 8192)) + ((((int)blockIdx.x) / 3) * 4096)) + (((((int)threadIdx.x) >> 5) & 3) * 1024)) + ((z_2 >> 2) * 512)) + ((((int)threadIdx.x) & 31) * 16)) + ((z_2 & 3) * 4))])), v_1);
      }
    }
  }
