...
extern "C" __global__ void main_kernel(uchar* __restrict__ A, int* __restrict__ C0, int* __restrict__ C1, uchar* __restrict__ R, uchar* __restrict__ W, int n0, int n1, int rows, int sizes_4, int v0, int v1);
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(uchar* __restrict__ A, int* __restrict__ C0, int* __restrict__ C1, uchar* __restrict__ R, uchar* __restrict__ W, int n0, int n1, int rows, int sizes_4, int v0, int v1) {
  uint c[64];
  ...
  for (int h_1 = 0; h_1 < 2; ++h_1) {
    ...
    for (int st = 0; st < 2; ++st) {
      nr_tl_vit_joint::cp((&(sh[((((h_1 * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (st * 512)) + ((((int)threadIdx.x) & 31) * 16))])), (&(A[0])), (((((((int)blockIdx.x) * 131072) + (h_1 * 65536)) + ((((int)threadIdx.x) >> 5) * 16384)) + (st * 512)) + ((((int)threadIdx.x) & 31) * 16)), ((int)((((((int)blockIdx.x) * 128) + (h_1 * 64)) + ((((int)threadIdx.x) >> 5) * 16)) < rows)));
    }
  }
  #pragma unroll
  for (int j = 0; j < 4; ++j) {
  ...
  for (int h_2 = 0; h_2 < 2; ++h_2) {
    ...
    for (int st_1 = 0; st_1 < 2; ++st_1) {
      nr_tl_vit_joint::cp((&(sh[(((((h_2 * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (st_1 * 512)) + ((((int)threadIdx.x) & 31) * 16)) + 16384)])), (&(A[0])), ((((((((int)blockIdx.x) * 131072) + (h_2 * 65536)) + ((((int)threadIdx.x) >> 5) * 16384)) + (st_1 * 512)) + ((((int)threadIdx.x) & 31) * 16)) + 1024), ((int)((((((int)blockIdx.x) * 128) + (h_2 * 64)) + ((((int)threadIdx.x) >> 5) * 16)) < rows)));
    }
  }
  #pragma unroll
    ...
    if (phase < 14) {
      ...
      for (int h_3 = 0; h_3 < 2; ++h_3) {
        ...
        for (int st_2 = 0; st_2 < 2; ++st_2) {
          nr_tl_vit_joint::cp((&(sh[(((((((phase + 2) % 3) * 16384) + (h_3 * 4096)) + ((((int)threadIdx.x) >> 5) * 1024)) + (st_2 * 512)) + ((((int)threadIdx.x) & 31) * 16))])), (&(A[0])), (((((((((int)blockIdx.x) * 131072) + (h_3 * 65536)) + ((((int)threadIdx.x) >> 5) * 16384)) + (phase * 1024)) + (st_2 * 512)) + ((((int)threadIdx.x) & 31) * 16)) + 2048), ((int)((((((int)blockIdx.x) * 128) + (h_3 * 64)) + ((((int)threadIdx.x) >> 5) * 16)) < rows)));
        }
      }
      #pragma unroll
  ...
  for (int t = 0; t < 8; ++t) {
    ...
    if (((((((((((((((int)blockIdx.x) * 524288) + ((((int)threadIdx.x) >> 6) * 262144)) + ((t >> 1) * 65536)) + ((((((int)blockIdx.y) * 128) + (((((int)threadIdx.x) & 63) >> 5) * 64)) >> 5) * 512)) + ((t & 1) * 512)) + (((((((int)blockIdx.x) * 128) + ((((int)threadIdx.x) >> 6) * 64)) + ((t >> 1) * 16)) & 7) * 64)) + ((((int)threadIdx.x) & 31) * 16)) + ((((((((int)blockIdx.x) * 128) + ((((int)threadIdx.x) >> 6) * 64)) + ((t >> 1) * 16)) >> 3) & 1) * 4)) + (((((int)blockIdx.y) * 128) + (((((int)threadIdx.x) & 63) >> 5) * 64)) & 1)) + ((((((int)blockIdx.y) * 128) + (((((int)threadIdx.x) & 63) >> 5) * 64)) & 6) << 3)) + ((((((int)blockIdx.y) * 128) + (((((int)threadIdx.x) & 63) >> 5) * 64)) & 8) >> 2)) + ((((((int)blockIdx.y) * 128) + (((((int)threadIdx.x) & 63) >> 5) * 64)) & 16) >> 1)) < sizes_4) {
      nr_tl_vit_joint::store4((&(R[((((((((((((((int64_t)((int)blockIdx.x)) * (int64_t)524288) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)6) * (int64_t)262144)) + ((((int64_t)t) >> (int64_t)1) * (int64_t)65536)) + ((((((int64_t)((int)blockIdx.y)) * (int64_t)128) + (((((int64_t)((int)threadIdx.x)) & (int64_t)63) >> (int64_t)5) * (int64_t)64)) >> (int64_t)5) * (int64_t)512)) + ((((int64_t)t) & (int64_t)1) * (int64_t)512)) + (((((((int64_t)((int)blockIdx.x)) * (int64_t)128) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)6) * (int64_t)64)) + ((((int64_t)t) >> (int64_t)1) * (int64_t)16)) & (int64_t)7) * (int64_t)64)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)31) * (int64_t)16)) + ((((((((int64_t)((int)blockIdx.x)) * (int64_t)128) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)6) * (int64_t)64)) + ((((int64_t)t) >> (int64_t)1) * (int64_t)16)) >> (int64_t)3) & (int64_t)1) * (int64_t)4)) + (((((int64_t)((int)blockIdx.y)) * (int64_t)128) + (((((int64_t)((int)threadIdx.x)) & (int64_t)63) >> (int64_t)5) * (int64_t)64)) & (int64_t)1)) + ((((((int64_t)((int)blockIdx.y)) * (int64_t)128) + (((((int64_t)((int)threadIdx.x)) & (int64_t)63) >> (int64_t)5) * (int64_t)64)) & (int64_t)6) << (int64_t)3)) + ((((((int64_t)((int)blockIdx.y)) * (int64_t)128) + (((((int64_t)((int)threadIdx.x)) & (int64_t)63) >> (int64_t)5) * (int64_t)64)) & (int64_t)8) >> (int64_t)2)) + ((((((int64_t)((int)blockIdx.y)) * (int64_t)128) + (((((int64_t)((int)threadIdx.x)) & (int64_t)63) >> (int64_t)5) * (int64_t)64)) & (int64_t)16) >> (int64_t)1))])), res[0], res[1], res[2], res[3]);
    }
  }
