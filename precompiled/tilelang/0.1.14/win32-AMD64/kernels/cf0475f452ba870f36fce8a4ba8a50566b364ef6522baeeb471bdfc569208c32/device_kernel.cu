...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(const uchar* __restrict__ A, int* __restrict__ C0, int* __restrict__ C1, uchar* __restrict__ Raw, const uchar* __restrict__ Skip, const uchar* __restrict__ Weight, int H, int W, int n0, int n1, int sizes_3, int v0, int v1) {
  ...
  for (int r = 0; r < 2; ++r) {
    for (int n = 0; n < 8; ++n) {
      for (int h = 0; h < 2; ++h) {
        c[(((r * 16) + (n * 2)) + h)] = (uint)0;
        int y = max(((((sx * 8) + (((((((int)threadIdx.x) >> 7) * 2) + r) & 1) * 4)) + (h * 2)) + ((((int)threadIdx.x) & 31) >> 4)), ((((sx * 8) + (((((((int)threadIdx.x) >> 7) * 2) + r) & 1) * 4)) + (h * 2)) + ((((int)threadIdx.x) & 31) >> 4)));
        v = (uint)0;
        if ((y < H) && ((((((int)blockIdx.y) * 8) + ((((int)threadIdx.x) >> 7) * 4)) + ((((int)threadIdx.x) & 15) >> 2)) < W)) {
          int off = max((((((((((((sx * 16384) + (((H >> 2) * ((((int)blockIdx.y) * 2) + (((int)threadIdx.x) >> 7))) * 8192)) + (((((((int)threadIdx.x) >> 7) * 2) + r) & 1) * 8192)) + (g * 1024)) + (((n * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 1)) + ((((n * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 6) << 3)) + ((((n * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 8) >> 2)) + ((((n * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 16) >> 1)) + ((((n * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 32) << 4)) + (((((((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) >> 2) & 1) * 8) + ((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) & 3) * 2)) + ((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) >> 3) & 1)) & 1) << 2)) + (((((((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) >> 2) & 1) * 8) + ((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) & 3) * 2)) + ((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) >> 3) & 1)) & 14) << 5)), (((((((((((sx * 16384) + (((H >> 2) * ((((int)blockIdx.y) * 2) + (((int)threadIdx.x) >> 7))) * 8192)) + (((((((int)threadIdx.x) >> 7) * 2) + r) & 1) * 8192)) + (g * 1024)) + (((n * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 1)) + ((((n * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 6) << 3)) + ((((n * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 8) >> 2)) + ((((n * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 16) >> 1)) + ((((n * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 32) << 4)) + (((((((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) >> 2) & 1) * 8) + ((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) & 3) * 2)) + ((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) >> 3) & 1)) & 1) << 2)) + (((((((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) >> 2) & 1) * 8) + ((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) & 3) * 2)) + ((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) >> 3) & 1)) & 14) << 5)));
  ...
  for (int g_1 = 0; g_1 < 8; ++g_1) {
    for (int z = 0; z < 4; ++z) {
      int i_2 = max((((((((sx * 16384) + (((H >> 2) * ((((int)blockIdx.y) * 2) + (((int)threadIdx.x) >> 7))) * 8192)) + (((((int)threadIdx.x) >> 6) & 1) * 8192)) + (g_1 * 1024)) + (((((int)threadIdx.x) >> 5) & 1) * 512)) + ((((int)threadIdx.x) & 31) * 16)) + (z * 4)), (((((((sx * 16384) + (((H >> 2) * ((((int)blockIdx.y) * 2) + (((int)threadIdx.x) >> 7))) * 8192)) + (((((int)threadIdx.x) >> 6) & 1) * 8192)) + (g_1 * 1024)) + (((((int)threadIdx.x) >> 5) & 1) * 512)) + ((((int)threadIdx.x) & 31) * 16)) + (z * 4)));
      uint condval;
      if (((((((int)blockIdx.y) * 2) + (((int)threadIdx.x) >> 7)) < (W >> 2)) && (((sx * 2) + ((((int)threadIdx.x) >> 6) & 1)) < (H >> 2)))) {
  ...
  for (int r_2 = 0; r_2 < 2; ++r_2) {
    for (int n_2 = 0; n_2 < 8; ++n_2) {
      for (int h_1 = 0; h_1 < 2; ++h_1) {
        ...
        int y_1 = max(((((sx * 8) + (((((((int)threadIdx.x) >> 7) * 2) + r_2) & 1) * 4)) + (h_1 * 2)) + ((((int)threadIdx.x) & 31) >> 4)), ((((sx * 8) + (((((((int)threadIdx.x) >> 7) * 2) + r_2) & 1) * 4)) + (h_1 * 2)) + ((((int)threadIdx.x) & 31) >> 4)));
      }
    }
  }
  __syncthreads();
  for (int r_3 = 0; r_3 < 2; ++r_3) {
    if ((((((int)blockIdx.y) * 2) + (((int)threadIdx.x) >> 7)) < (W >> 2)) && (((sx * 2) + ((((((int)threadIdx.x) >> 7) * 2) + r_3) & 1)) < (H >> 2))) {
      for (int z_2 = 0; z_2 < 8; ++z_2) {
        int i_5 = max((((((((sx * 16384) + (((H >> 2) * ((((int)blockIdx.y) * 2) + (((int)threadIdx.x) >> 7))) * 8192)) + (((((((int)threadIdx.x) >> 7) * 2) + r_3) & 1) * 8192)) + (g * 1024)) + ((z_2 >> 2) * 512)) + ((((int)threadIdx.x) & 31) * 16)) + ((z_2 & 3) * 4)), (((((((sx * 16384) + (((H >> 2) * ((((int)blockIdx.y) * 2) + (((int)threadIdx.x) >> 7))) * 8192)) + (((((((int)threadIdx.x) >> 7) * 2) + r_3) & 1) * 8192)) + (g * 1024)) + ((z_2 >> 2) * 512)) + ((((int)threadIdx.x) & 31) * 16)) + ((z_2 & 3) * 4)));
        uint v_1 = nr_ld32((&(((uchar*)packed)[((((((((int)threadIdx.x) >> 5) * 4096) + (r_3 * 1024)) + ((z_2 >> 2) * 512)) + ((((int)threadIdx.x) & 31) * 16)) + ((z_2 & 3) * 4))])));
        if (0 <= i_5) {
          if (i_5 < sizes_3) {
