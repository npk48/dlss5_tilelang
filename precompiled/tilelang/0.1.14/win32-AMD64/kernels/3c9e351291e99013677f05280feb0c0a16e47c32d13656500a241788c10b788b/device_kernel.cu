...
extern "C" __global__ void __launch_bounds__(128, 1) kernel_kernel(const int* __restrict__ AG, const int* __restrict__ FG, const int* __restrict__ Gate, const int* __restrict__ Inv, const int* __restrict__ Proj, int* __restrict__ RW, const int* __restrict__ WB, const int* __restrict__ WP, const int* __restrict__ WQ, const int* __restrict__ WR, const int* __restrict__ WS, const int* __restrict__ WT, const int* __restrict__ WX) {
  ...
  for (int m = 0; m < 4; ++m) {
    ...
    for (int word = 0; word < 4; ++word) {
      ...
      for (int b_6 = 0; b_6 < 4; ++b_6) {
        int condval;
        if (((((1 <= (((((int)blockIdx.x) % 11) * 2) + ((((((m * 16) + ((word & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7) >> 2))) & ((((((int)blockIdx.x) % 11) * 2) + ((((((m * 16) + ((word & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7) >> 2)) < 21)) & (bool)1) & (bool)1)) {
          condval = (((((((((((int)blockIdx.x) / 11) * 81920) + (((((((m * 16) + ((word & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) >> 1) * 40960)) + ((((int)blockIdx.x) % 11) * 4096)) + (((((((m * 16) + ((word & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7) >> 2) * 2048)) + (((((((((((int)threadIdx.x) >> 5) * 32) + ((((((((word >> 1) * 16) + ((((int)threadIdx.x) & 3) * 4)) + ((b_6 >> 1) * 2)) & -15) | ((((((word >> 1) * 16) + ((((int)threadIdx.x) & 3) * 4)) + ((b_6 >> 1) * 2)) & 2) << 2)) | ((((((word >> 1) * 16) + ((((int)threadIdx.x) & 3) * 4)) + ((b_6 >> 1) * 2)) & 4) >> 1)) | ((((((word >> 1) * 16) + ((((int)threadIdx.x) & 3) * 4)) + ((b_6 >> 1) * 2)) & 8) >> 1))) + (b_6 & 1)) & 1) | ((((((((int)threadIdx.x) >> 5) * 32) + ((((((((word >> 1) * 16) + ((((int)threadIdx.x) & 3) * 4)) + ((b_6 >> 1) * 2)) & -15) | ((((((word >> 1) * 16) + ((((int)threadIdx.x) & 3) * 4)) + ((b_6 >> 1) * 2)) & 2) << 2)) | ((((((word >> 1) * 16) + ((((int)threadIdx.x) & 3) * 4)) + ((b_6 >> 1) * 2)) & 4) >> 1)) | ((((((word >> 1) * 16) + ((((int)threadIdx.x) & 3) * 4)) + ((b_6 >> 1) * 2)) & 8) >> 1))) + (b_6 & 1)) & 6) << 3)) | ((((((((int)threadIdx.x) >> 5) * 32) + ((((((((word >> 1) * 16) + ((((int)threadIdx.x) & 3) * 4)) + ((b_6 >> 1) * 2)) & -15) | ((((((word >> 1) * 16) + ((((int)threadIdx.x) & 3) * 4)) + ((b_6 >> 1) * 2)) & 2) << 2)) | ((((((word >> 1) * 16) + ((((int)threadIdx.x) & 3) * 4)) + ((b_6 >> 1) * 2)) & 4) >> 1)) | ((((((word >> 1) * 16) + ((((int)threadIdx.x) & 3) * 4)) + ((b_6 >> 1) * 2)) & 8) >> 1))) + (b_6 & 1)) & 8) >> 2)) | ((((((((int)threadIdx.x) >> 5) * 32) + ((((((((word >> 1) * 16) + ((((int)threadIdx.x) & 3) * 4)) + ((b_6 >> 1) * 2)) & -15) | ((((((word >> 1) * 16) + ((((int)threadIdx.x) & 3) * 4)) + ((b_6 >> 1) * 2)) & 2) << 2)) | ((((((word >> 1) * 16) + ((((int)threadIdx.x) & 3) * 4)) + ((b_6 >> 1) * 2)) & 4) >> 1)) | ((((((word >> 1) * 16) + ((((int)threadIdx.x) & 3) * 4)) + ((b_6 >> 1) * 2)) & 8) >> 1))) + (b_6 & 1)) & 16) >> 1)) | ((((((((int)threadIdx.x) >> 5) * 32) + ((((((((word >> 1) * 16) + ((((int)threadIdx.x) & 3) * 4)) + ((b_6 >> 1) * 2)) & -15) | ((((((word >> 1) * 16) + ((((int)threadIdx.x) & 3) * 4)) + ((b_6 >> 1) * 2)) & 2) << 2)) | ((((((word >> 1) * 16) + ((((int)threadIdx.x) & 3) * 4)) + ((b_6 >> 1) * 2)) & 4) >> 1)) | ((((((word >> 1) * 16) + ((((int)threadIdx.x) & 3) * 4)) + ((b_6 >> 1) * 2)) & 8) >> 1))) + (b_6 & 1)) & 224) << 4))) + ((((((((((((int)blockIdx.x) / 11) * 8) + ((((((m * 16) + ((word & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((m * 16) + ((word & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) >> 1) & 1) | ((((((((int)blockIdx.x) % 11) * 8) + (((((m * 16) + ((word & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7)) - 4) & 3) << 1)) | ((((((((int)blockIdx.x) / 11) * 8) + ((((((m * 16) + ((word & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((m * 16) + ((word & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) & 1) << 3)) & 1) << 2)) + ((((((((((((int)blockIdx.x) / 11) * 8) + ((((((m * 16) + ((word & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((m * 16) + ((word & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) >> 1) & 1) | ((((((((int)blockIdx.x) % 11) * 8) + (((((m * 16) + ((word & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7)) - 4) & 3) << 1)) | ((((((((int)blockIdx.x) / 11) * 8) + ((((((m * 16) + ((word & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((m * 16) + ((word & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) & 1) << 3)) & 14) << 5)) - 2048);
        } else {
          condval = -1;
        }
        v = condval;
        ...
        if (0 <= raw) {
          ...
          int condval_2;
          if (((0 <= condval_3) && (condval_4 < 49424))) {
            int condval_5;
            if ((raw < 655360)) {
          ...
          int condval_8;
          if (((0 <= condval_9) && (condval_10 < 163840))) {
            int condval_11;
            if ((raw < 655360)) {
  ...
  for (int slab = 0; slab < 4; ++slab) {
    ...
    for (int kp = 0; kp < 3; ++kp) {
      ...
      for (int pair = 0; pair < 2; ++pair) {
        *(int4*)(b + 0) = *(int4*)(WX + ((((((((int)threadIdx.x) >> 5) * 4096) + (kp * 1024)) + (slab * 256)) + (pair * 128)) + ((((int)threadIdx.x) & 31) * 4)));
        #pragma unroll
    ...
    for (int m_5 = 0; m_5 < 4; ++m_5) {
      *(int4*)(a_1 + 0) = *(int4*)(S + (((m_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1536));
      ...
      for (int pair_1 = 0; pair_1 < 2; ++pair_1) {
        *(int4*)(b_1 + 0) = *(int4*)(WX + ((((((((int)threadIdx.x) >> 5) * 4096) + (slab * 256)) + (pair_1 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 3072));
        #pragma unroll
      ...
      for (int n_3 = 0; n_3 < 4; ++n_3) {
        uint64_t r_2 = wide_mma(A[0], A[1], A[2], A[3], WR[(((((((((int)threadIdx.x) >> 5) * 1024) + (slab * 256)) + ((n_3 >> 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + ((n_3 & 1) * 2)) + 16384)], WR[(((((((((int)threadIdx.x) >> 5) * 1024) + (slab * 256)) + ((n_3 >> 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + ((n_3 & 1) * 2)) + 16385)], C[((m_5 * 8) + (n_3 * 2))], C[(((m_5 * 8) + (n_3 * 2)) + 1)]);
  ...
  for (int m_7 = 0; m_7 < 4; ++m_7) {
    ...
    for (int n_5 = 0; n_5 < 4; ++n_5) {
      int g = FG[(((((((int)threadIdx.x) >> 5) * 16) + (n_5 * 4)) + (((int)threadIdx.x) & 3)) + 32768)];
  ...
  for (int kp_2 = 0; kp_2 < 3; ++kp_2) {
    ...
    for (int pair_3 = 0; pair_3 < 6; ++pair_3) {
      *(int4*)(b_3 + 0) = *(int4*)(WQ + (((((kp_2 * 3072) + ((((int)threadIdx.x) >> 5) * 768)) + (pair_3 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 32896));
      #pragma unroll
    ...
    for (int dest = 0; dest < 4; ++dest) {
      *(int4*)(a_4 + 0) = *(int4*)(S + (((dest * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1536));
      ...
      for (int pair_4 = 0; pair_4 < 2; ++pair_4) {
        *(int4*)(b_4 + 0) = *(int4*)(WQ + ((((((((int)threadIdx.x) >> 5) * 768) + (comp * 256)) + (pair_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 42112));
        #pragma unroll
      ...
      if (comp == 0) {
        ...
        for (int j = 0; j < 2; ++j) {
          ...
          for (int n_8 = 0; n_8 < 4; ++n_8) {
            ...
            int v__3 = WS[((((int)threadIdx.x) >> 5) + 53376)];
            Z[(((dest * 24) + (n_8 * 2)) + j)] = wide_mul(Z[(((dest * 24) + (n_8 * 2)) + j)], wide_splat((*(float *)(&(v__3)))));
          }
        }
        #pragma unroll
  ...
  for (int slab_1 = 0; slab_1 < 2; ++slab_1) {
    ...
    for (int m_14 = 0; m_14 < 2; ++m_14) {
      ...
      for (int n_13 = 0; n_13 < 8; ++n_13) {
        uint64_t r_6 = wide_mma(Q[((slab_1 * 8) + (m_14 * 4))], Q[(((slab_1 * 8) + (m_14 * 4)) + 1)], Q[(((slab_1 * 8) + (m_14 * 4)) + 2)], Q[(((slab_1 * 8) + (m_14 * 4)) + 3)], K[(n_13 * 2)], K[((n_13 * 2) + 1)], WB[(((((((((((int)threadIdx.x) >> 5) * 2048) + (slab_1 * 1024)) + (m_14 * 512)) + ((n_13 >> 2) * 256)) + ((n_13 & 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + (((n_13 & 3) >> 1) * 2)) + 45184)], WB[(((((((((((int)threadIdx.x) >> 5) * 2048) + (slab_1 * 1024)) + (m_14 * 512)) + ((n_13 >> 2) * 256)) + ((n_13 & 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + (((n_13 & 3) >> 1) * 2)) + 45185)]);
    ...
    for (int word_7 = 0; word_7 < 8; ++word_7) {
      int v__4 = S[((((((((int)threadIdx.x) >> 5) * 512) + (slab_1 * 256)) + ((word_7 >> 2) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + (((word_7 & 3) >> 1) * 2))];
      int v__5 = S[(((((((((int)threadIdx.x) >> 5) * 512) + (slab_1 * 256)) + ((word_7 >> 2) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + (((word_7 & 3) >> 1) * 2)) + 1)];
      int condval_15;
      if (((word_7 % 2) == 0)) {
        condval_15 = 21520;
      } else {
      ...
      Residual[word_7] = wide_packet_prmt((*(uint *)(&(v__4))), (*(uint *)(&(v__5))), condval_15);
    }
    __syncthreads();
    #pragma unroll
    for (int word_8 = 0; word_8 < 8; ++word_8) {
      ...
      uint _reinterpret_tmp_5 = v_27;
      S[((((((((int)threadIdx.x) >> 5) * 512) + (slab_1 * 256)) + ((word_8 >> 2) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + (word_8 & 3))] = (*(int *)(&(_reinterpret_tmp_5)));
    }
    __syncthreads();
    #pragma unroll
    for (int m_16 = 0; m_16 < 2; ++m_16) {
      ...
      for (int n_17 = 0; n_17 < 4; ++n_17) {
        int g_1 = AG[(((((((int)threadIdx.x) >> 5) * 16) + (n_17 * 4)) + (((int)threadIdx.x) & 3)) + 57476)];
    ...
    for (int kp_4 = 0; kp_4 < 4; ++kp_4) {
      ...
      for (int pair_5 = 0; pair_5 < 2; ++pair_5) {
        *(int4*)(b_5 + 0) = *(int4*)(WP + (((((kp_4 * 1024) + ((((int)threadIdx.x) >> 5) * 256)) + (pair_5 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 53380));
        #pragma unroll
    ...
    for (int parity = 0; parity < 2; ++parity) {
      int condval_16;
      if (((((1 <= (((((int)blockIdx.x) % 11) * 2) + ((((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7) >> 2))) & ((((((int)blockIdx.x) % 11) * 2) + ((((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7) >> 2)) < 21)) & (bool)1) & (bool)1)) {
        condval_16 = (((((((((((int)blockIdx.x) / 11) * 81920) + (((((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) >> 1) * 40960)) + ((((int)blockIdx.x) % 11) * 4096)) + (((((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7) >> 2) * 2048)) + ((((((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 2)) & 1) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 2)) & 6) << 3)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 2)) & 8) >> 2)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 2)) & 16) >> 1)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 2)) & 224) << 4))) + ((((((((((((int)blockIdx.x) / 11) * 8) + ((((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) >> 1) & 1) | ((((((((int)blockIdx.x) % 11) * 8) + (((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7)) - 4) & 3) << 1)) | ((((((((int)blockIdx.x) / 11) * 8) + ((((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) & 1) << 3)) & 1) << 2)) + ((((((((((((int)blockIdx.x) / 11) * 8) + ((((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) >> 1) & 1) | ((((((((int)blockIdx.x) % 11) * 8) + (((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7)) - 4) & 3) << 1)) | ((((((((int)blockIdx.x) / 11) * 8) + ((((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) & 1) << 3)) & 14) << 5)) - 2048);
      } else {
        condval_16 = -1;
      }
      v_28 = condval_16;
      ...
      for (int j_3 = 0; j_3 < 4; ++j_3) {
        ...
        temp[j_3] = wide_packet_prmt(P[(((j_3 & 1) * 4) + ((j_3 >> 1) * 2))], P[((((j_3 & 1) * 4) + ((j_3 >> 1) * 2)) + 1)], condval_17);
      }
      if ((0 <= raw_1) & (raw_1 <= 19889552)) {
        {
          int RW_local_cast[4];
          int4 __1;
          ...
          *(int4*)(RW + (((raw_1 >> 4) * 4) + 10117120)) = *(int4*)(RW_local_cast + 0);
        }
      }
    }
    __syncthreads();
