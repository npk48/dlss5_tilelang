...
extern "C" __global__ void __launch_bounds__(128, 1) kernel_kernel(const int* __restrict__ AG, const int* __restrict__ FG, const int* __restrict__ Matrix, const int* __restrict__ PI, const int* __restrict__ PO, uchar* __restrict__ R, int* __restrict__ RW, const int* __restrict__ SW, const int* __restrict__ WB, const int* __restrict__ WP, const int* __restrict__ WQ, const int* __restrict__ WR, const int* __restrict__ WS, const int* __restrict__ WT, const int* __restrict__ WX, int counter, int gx, int height, int inp, int mn, int out, int pin, int pon, int poolout, int rn, int sn, int sx, int sy, int tiles, int width, int wns_0, int wns_1, int wns_2, int wns_3, int wns_4, int wns_5, int wns_6, int wns_7, int wns_8) {
  ...
  for (int slab_2 = 0; slab_2 < 2; ++slab_2) {
    ...
    for (int word_6 = 0; word_6 < 8; ++word_6) {
      int v__3 = ((int*)S)[((((((((int)threadIdx.x) >> 5) * 512) + (slab_2 * 256)) + ((word_6 >> 2) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + (((word_6 & 3) >> 1) * 2))];
      int v__4 = ((int*)S)[(((((((((int)threadIdx.x) >> 5) * 512) + (slab_2 * 256)) + ((word_6 >> 2) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + (((word_6 & 3) >> 1) * 2)) + 1)];
      int condval_14;
      if (((word_6 % 2) == 0)) {
        condval_14 = 21520;
      } else {
    ...
    for (int word_7 = 0; word_7 < 8; ++word_7) {
      ...
      ((int*)S)[((((((((int)threadIdx.x) >> 5) * 512) + (slab_2 * 256)) + ((word_7 >> 2) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + (word_7 & 3))] = (*(int *)(&(_reinterpret_tmp_3)));
    }
    __syncthreads();
    #pragma unroll
    ...
    for (int parity_1 = 0; parity_1 < 2; ++parity_1) {
      ...
      int condval_17;
      if (((((0 <= (((((((0 <= gx) && (0 <= rmod_12)) || ((gx < 0) && (rmod_12 <= 0))) ? rmod_12 : (rmod_12 + gx)) * 8) + (((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7)) + sx)) & ((((((((0 <= gx) && (0 <= rmod_13)) || ((gx < 0) && (rmod_13 <= 0))) ? rmod_13 : (rmod_13 + gx)) * 8) + (((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7)) + sx) < width)) & (0 <= ((((((((0 <= gx) && (0 <= rmod_14)) || ((gx < 0) && (rmod_14 <= 0))) ? rdiv_7 : (rdiv_7 - 1)) * 8) + ((((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) + sy))) & (((((((((0 <= gx) && (0 <= rmod_15)) || ((gx < 0) && (rmod_15 <= 0))) ? rdiv_8 : (rdiv_8 - 1)) * 8) + ((((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) + sy) < height))) {
        ...
        condval_17 = ((((((((((0 <= gx) && (0 <= rmod_16)) || ((gx < 0) && (rmod_16 <= 0))) ? rmod_16 : (rmod_16 + gx)) * 4096) + ((((((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7) + sx) >> 2) * 2048)) + (((width >> 2) * ((((((0 <= gx) && (0 <= rmod_17)) || ((gx < 0) && (rmod_17 <= 0))) ? rdiv_9 : (rdiv_9 - 1)) * 2) + ((((((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1) + sy) >> 1) + (((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3)) >> 1))) * 2048)) + ((((((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 2)) & 1) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 2)) & 6) << 3)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 2)) & 8) >> 2)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 2)) & 16) >> 1)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 2)) & 224) << 4))) + ((((((((((((((0 <= gx) && (0 <= rmod_18)) || ((gx < 0) && (rmod_18 <= 0))) ? rdiv_10 : (rdiv_10 - 1)) * 8) + ((((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) + sy) >> 1) & 1) | (((((((((0 <= gx) && (0 <= rmod_19)) || ((gx < 0) && (rmod_19 <= 0))) ? rmod_19 : (rmod_19 + gx)) * 8) + (((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7)) + sx) & 3) << 1)) | ((((((((((0 <= gx) && (0 <= rmod_20)) || ((gx < 0) && (rmod_20 <= 0))) ? rdiv_11 : (rdiv_11 - 1)) * 8) + ((((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) + sy) & 1) << 3)) & 1) << 2)) + ((((((((((((((0 <= gx) && (0 <= rmod_21)) || ((gx < 0) && (rmod_21 <= 0))) ? rdiv_12 : (rdiv_12 - 1)) * 8) + ((((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) + sy) >> 1) & 1) | (((((((((0 <= gx) && (0 <= rmod_22)) || ((gx < 0) && (rmod_22 <= 0))) ? rmod_22 : (rmod_22 + gx)) * 8) + (((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7)) + sx) & 3) << 1)) | ((((((((((0 <= gx) && (0 <= rmod_23)) || ((gx < 0) && (rmod_23 <= 0))) ? rdiv_13 : (rdiv_13 - 1)) * 8) + ((((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) + sy) & 1) << 3)) & 14) << 5));
      } else {
        condval_17 = -1;
      }
      v_28 = condval_17;
      ...
      for (int j_4 = 0; j_4 < 4; ++j_4) {
        ...
        temp[j_4] = wide_packet_prmt(P[(((j_4 & 1) * 4) + ((j_4 >> 1) * 2))], P[((((j_4 & 1) * 4) + ((j_4 >> 1) * 2)) + 1)], condval_18);
      }
    ...
    for (int m_19 = 0; m_19 < 2; ++m_19) {
      ...
      for (int n_19 = 0; n_19 < 4; ++n_19) {
        ...
        for (int j_5 = 0; j_5 < 2; ++j_5) {
          uint v__6 = C[(((m_19 * 8) + (n_19 * 2)) + j_5)];
          ((int*)D)[(((((((((int)threadIdx.x) >> 5) * 1024) + (slab_2 * 512)) + (m_19 * 256)) + (n_19 * 64)) + ((((int)threadIdx.x) & 31) * 2)) + j_5)] = (*(int *)(&(v__6)));
        }
      }
    }
    __syncthreads();
  ...
  for (int group_1 = 0; group_1 < 2; ++group_1) {
    for (int n_20 = 0; n_20 < 4; ++n_20) {
      ...
      for (int kp_5 = 0; kp_5 < 4; ++kp_5) {
        ...
        for (int word_8 = 0; word_8 < 4; ++word_8) {
          ...
          for (int b_8 = 0; b_8 < 4; ++b_8) {
            ...
            for (int t = 0; t < 4; ++t) {
              int condval_19;
              if (((((((((int)blockIdx.x) * 8192) + ((word_8 & 1) * 4096)) + (((((int)threadIdx.x) & 31) >> 2) * 512)) + (t * 128)) + ((((((((kp_5 * 32) + ((word_8 >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) + b_8) & -15) | ((((((kp_5 * 32) + ((word_8 >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) + b_8) & 2) << 2)) | ((((((kp_5 * 32) + ((word_8 >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) + b_8) & 4) >> 1)) | ((((((kp_5 * 32) + ((word_8 >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) + b_8) & 8) >> 1))) < pin)) {
                condval_19 = PI[(((((((int64_t)((int)blockIdx.x)) * (int64_t)8192) + ((((int64_t)word_8) & (int64_t)1) * (int64_t)4096)) + (((((int64_t)((int)threadIdx.x)) & (int64_t)31) >> (int64_t)2) * (int64_t)512)) + (((int64_t)t) * (int64_t)128)) + ((((((((((int64_t)kp_5) * (int64_t)32) + ((((int64_t)word_8) >> (int64_t)1) * (int64_t)16)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)3) * (int64_t)4)) + ((int64_t)b_8)) & (int64_t)-15) | ((((((((int64_t)kp_5) * (int64_t)32) + ((((int64_t)word_8) >> (int64_t)1) * (int64_t)16)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)3) * (int64_t)4)) + ((int64_t)b_8)) & (int64_t)2) << (int64_t)2)) | ((((((((int64_t)kp_5) * (int64_t)32) + ((((int64_t)word_8) >> (int64_t)1) * (int64_t)16)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)3) * (int64_t)4)) + ((int64_t)b_8)) & (int64_t)4) >> (int64_t)1)) | ((((((((int64_t)kp_5) * (int64_t)32) + ((((int64_t)word_8) >> (int64_t)1) * (int64_t)16)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)3) * (int64_t)4)) + ((int64_t)b_8)) & (int64_t)8) >> (int64_t)1)))];
              } else {
                condval_19 = 0;
              }
              int ix = condval_19;
              vals[t] = (uint)0;
              if (0 <= ix) {
                int v__7 = ((int*)D)[((((((((ix & 127) >> 5) * 1024) + ((ix >> 11) * 256)) + (((ix & 31) >> 3) * 64)) + (((ix & 1023) >> 7) * 8)) + (((ix & 7) >> 1) * 2)) + ((ix & 2047) >> 10))];
                vals[t] = ((((*(uint *)(&(v__7))) >> ((uint)((ix & 1) * 16))) & (uint)65535) | ((((*(uint *)(&(v__7))) >> ((uint)((ix & 1) * 16))) & (uint)65535) << (uint)16));
              }
            }
        ...
        int condval_20;
        if ((((((((kp_5 * 2048) + (group_1 * 1024)) + ((((int)threadIdx.x) >> 5) * 256)) + ((n_20 >> 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + ((n_20 & 1) * 2)) < mn)) {
          condval_20 = Matrix[((((((kp_5 * 2048) + (group_1 * 1024)) + ((((int)threadIdx.x) >> 5) * 256)) + ((n_20 >> 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + ((n_20 & 1) * 2))];
        } else {
          condval_20 = 0;
        }
        int condval_21;
        if (((((((((kp_5 * 2048) + (group_1 * 1024)) + ((((int)threadIdx.x) >> 5) * 256)) + ((n_20 >> 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + ((n_20 & 1) * 2)) + 1) < mn)) {
          condval_21 = Matrix[(((((((kp_5 * 2048) + (group_1 * 1024)) + ((((int)threadIdx.x) >> 5) * 256)) + ((n_20 >> 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + ((n_20 & 1) * 2)) + 1)];
        } else {
          condval_21 = 0;
        }
        uint64_t r_9 = wide_mma(temp[0], temp[1], temp[2], temp[3], condval_20, condval_21, acc[0], acc[1]);
        acc[0] = ((uint)r_9);
      ...
      for (int b_9 = 0; b_9 < 4; ++b_9) {
        int condval_22;
        if ((((((((((((int)blockIdx.x) * 4096) + ((b_9 >> 1) * 2048)) + (((((int)threadIdx.x) & 31) >> 2) * 256)) + (group_1 * 128)) + ((((int)threadIdx.x) >> 5) * 32)) + (n_20 * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (b_9 & 1)) < pon)) {
          condval_22 = PO[((((((((((int64_t)((int)blockIdx.x)) * (int64_t)4096) + ((((int64_t)b_9) >> (int64_t)1) * (int64_t)2048)) + (((((int64_t)((int)threadIdx.x)) & (int64_t)31) >> (int64_t)2) * (int64_t)256)) + (((int64_t)group_1) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)5) * (int64_t)32)) + (((int64_t)n_20) * (int64_t)8)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)3) * (int64_t)2)) + (((int64_t)b_9) & (int64_t)1))];
        } else {
          condval_22 = 0;
        }
        int dest_1 = condval_22;
        if (0 <= dest_1) {
          if (0 <= (poolout + dest_1)) {
            if ((poolout + dest_1) < rn) {
              R[(((int64_t)poolout) + ((int64_t)dest_1))] = ((uchar)(encoded >> ((uint)(b_9 * 8))));
            }
          }
        }
      }
