...
extern "C" __global__ void main_kernel(const uchar* __restrict__ A, int* __restrict__ C0, uchar* __restrict__ Raw, const uchar* __restrict__ Weight);
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(const uchar* __restrict__ A, int* __restrict__ C0, uchar* __restrict__ Raw, const uchar* __restrict__ Weight) {
  ...
  for (int g = 0; g < 8; ++g) {
    for (int z = 0; z < 4; ++z) {
      uint condval;
      if ((((((int)blockIdx.x) * 2) + ((((int)threadIdx.x) >> 6) & 1)) < 5)) {
        condval = nr_ld32((&(A[((((((((((int)blockIdx.y) * 81920) + ((((int)threadIdx.x) >> 7) * 40960)) + (((int)blockIdx.x) * 16384)) + (((((int)threadIdx.x) >> 6) & 1) * 8192)) + (g * 1024)) + (((((int)threadIdx.x) >> 5) & 1) * 512)) + ((((int)threadIdx.x) & 31) * 16)) + (z * 4))])));
      } else {
        condval = (uint)0;
      }
      ((uint*)sh)[((((int)threadIdx.x) * 4) + z)] = condval;
    }
    __syncthreads();
    for (int k = 0; k < 2; ++k) {
      for (int r_1 = 0; r_1 < 2; ++r_1) {
        for (int z_1 = 0; z_1 < 4; ++z_1) {
          av[z_1] = ((uint*)sh)[((((((((int)threadIdx.x) >> 7) * 512) + (r_1 * 256)) + (k * 128)) + ((((int)threadIdx.x) & 31) * 4)) + z_1)];
        }
        for (int n_1 = 0; n_1 < 8; ++n_1) {
          uint b0 = nr_ld32((&(Weight[(((((((g * 32768) + (k * 16384)) + (((int)blockIdx.z) * 8192)) + (((((int)threadIdx.x) >> 5) & 3) * 2048)) + ((n_1 >> 1) * 512)) + ((((int)threadIdx.x) & 31) * 16)) + ((n_1 & 1) * 8))])));
          uint b1 = nr_ld32((&(Weight[((((((((g * 32768) + (k * 16384)) + (((int)blockIdx.z) * 8192)) + (((((int)threadIdx.x) >> 5) & 3) * 2048)) + ((n_1 >> 1) * 512)) + ((((int)threadIdx.x) & 31) * 16)) + ((n_1 & 1) * 8)) + 4)])));
  ...
  for (int r_2 = 0; r_2 < 2; ++r_2) {
    for (int n_2 = 0; n_2 < 8; ++n_2) {
      for (int h_1 = 0; h_1 < 2; ++h_1) {
        ...
        uint q = nr_qpair(a);
        ((uchar*)route)[(((((((((((int)threadIdx.x) >> 5) * 3072) + (r_2 * 1024)) + ((((((((n_2 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & -15) | ((((n_2 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 8) >> 2)) | ((((n_2 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 2) << 1)) | ((((n_2 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 4) << 1)) >> 5) * 512)) + ((((h_1 * 8) + ((((int)threadIdx.x) & 31) >> 2)) & 7) * 64)) + (h_1 * 4)) + ((((((((n_2 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & -15) | ((((n_2 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 8) >> 2)) | ((((n_2 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 2) << 1)) | ((((n_2 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 4) << 1)) & 31) & 3)) + (((((((((n_2 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & -15) | ((((n_2 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 8) >> 2)) | ((((n_2 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 2) << 1)) | ((((n_2 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 4) << 1)) & 31) & 12) << 2)) + (((((((((n_2 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & -15) | ((((n_2 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 8) >> 2)) | ((((n_2 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 2) << 1)) | ((((n_2 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 4) << 1)) & 31) & 16) >> 1))] = ((uchar)q);
        ((uchar*)route)[((((((((((((int)threadIdx.x) >> 5) * 3072) + (r_2 * 1024)) + ((((((((n_2 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & -15) | ((((n_2 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 8) >> 2)) | ((((n_2 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 2) << 1)) | ((((n_2 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 4) << 1)) >> 5) * 512)) + ((((h_1 * 8) + ((((int)threadIdx.x) & 31) >> 2)) & 7) * 64)) + (h_1 * 4)) + ((((((((n_2 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & -15) | ((((n_2 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 8) >> 2)) | ((((n_2 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 2) << 1)) | ((((n_2 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 4) << 1)) & 31) & 3)) + (((((((((n_2 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & -15) | ((((n_2 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 8) >> 2)) | ((((n_2 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 2) << 1)) | ((((n_2 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 4) << 1)) & 31) & 12) << 2)) + (((((((((n_2 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & -15) | ((((n_2 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 8) >> 2)) | ((((n_2 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 2) << 1)) | ((((n_2 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 4) << 1)) & 31) & 16) >> 1)) + 1)] = ((uchar)(q >> (uint)8));
      }
    }
  }
  __syncthreads();
  ...
  for (int i = 0; i < 8; ++i) {
    ...
    for (int k_1 = 0; k_1 < 2; ++k_1) {
      for (int r_5 = 0; r_5 < 2; ++r_5) {
        for (int z_2 = 0; z_2 < 4; ++z_2) {
          av[z_2] = nr_ld32((&(((uchar*)route)[((((((((int)threadIdx.x) >> 5) * 3072) + (r_5 * 1024)) + (k_1 * 512)) + ((((int)threadIdx.x) & 31) * 16)) + (z_2 * 4))])));
        }
        for (int n_5 = 0; n_5 < 4; ++n_5) {
          uint b0_1 = nr_ld32((&(Weight[((((((((((int)blockIdx.z) * 65536) + (((((int)threadIdx.x) >> 5) & 3) * 16384)) + (k_1 * 8192)) + (i * 1024)) + ((n_5 >> 1) * 512)) + ((((int)threadIdx.x) & 31) * 16)) + ((n_5 & 1) * 8)) + 262144)])));
          uint b1_1 = nr_ld32((&(Weight[((((((((((int)blockIdx.z) * 65536) + (((((int)threadIdx.x) >> 5) & 3) * 16384)) + (k_1 * 8192)) + (i * 1024)) + ((n_5 >> 1) * 512)) + ((((int)threadIdx.x) & 31) * 16)) + ((n_5 & 1) * 8)) + 262148)])));
    ...
    for (int r_6 = 0; r_6 < 2; ++r_6) {
      for (int n_6 = 0; n_6 < 4; ++n_6) {
        for (int h_4 = 0; h_4 < 2; ++h_4) {
          ...
          ((uchar*)route)[(((((((((((int)threadIdx.x) >> 5) * 3072) + (r_6 * 512)) + ((((h_4 * 8) + ((((int)threadIdx.x) & 31) >> 2)) & 7) * 64)) + (h_4 * 4)) + (((((((n_6 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 1) + ((((n_6 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 6) << 1)) + ((((n_6 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 8) >> 2)) + (((n_6 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 16)) & 3)) + ((((((((n_6 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 1) + ((((n_6 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 6) << 1)) + ((((n_6 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 8) >> 2)) + (((n_6 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 16)) & 12) << 2)) + ((((((((n_6 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 1) + ((((n_6 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 6) << 1)) + ((((n_6 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 8) >> 2)) + (((n_6 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 16)) & 16) >> 1)) + 2048)] = ((uchar)q_1);
          ((uchar*)route)[(((((((((((int)threadIdx.x) >> 5) * 3072) + (r_6 * 512)) + ((((h_4 * 8) + ((((int)threadIdx.x) & 31) >> 2)) & 7) * 64)) + (h_4 * 4)) + (((((((n_6 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 1) + ((((n_6 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 6) << 1)) + ((((n_6 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 8) >> 2)) + (((n_6 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 16)) & 3)) + ((((((((n_6 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 1) + ((((n_6 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 6) << 1)) + ((((n_6 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 8) >> 2)) + (((n_6 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 16)) & 12) << 2)) + ((((((((n_6 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 1) + ((((n_6 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 6) << 1)) + ((((n_6 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 8) >> 2)) + (((n_6 * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 16)) & 16) >> 1)) + 2049)] = ((uchar)(q_1 >> (uint)8));
        }
      }
    }
    __syncthreads();
    for (int r_7 = 0; r_7 < 2; ++r_7) {
      for (int z_3 = 0; z_3 < 4; ++z_3) {
        av[z_3] = nr_ld32((&(((uchar*)route)[((((((((int)threadIdx.x) >> 5) * 3072) + (r_7 * 512)) + ((((int)threadIdx.x) & 31) * 16)) + (z_3 * 4)) + 2048)])));
      }
      for (int n_7 = 0; n_7 < 8; ++n_7) {
        uint b0_2 = nr_ld32((&(Weight[(((((((((int)blockIdx.z) * 65536) + (((((int)threadIdx.x) >> 5) & 3) * 16384)) + (i * 2048)) + ((n_7 >> 1) * 512)) + ((((int)threadIdx.x) & 31) * 16)) + ((n_7 & 1) * 8)) + 393216)])));
        uint b1_2 = nr_ld32((&(Weight[(((((((((int)blockIdx.z) * 65536) + (((((int)threadIdx.x) >> 5) & 3) * 16384)) + (i * 2048)) + ((n_7 >> 1) * 512)) + ((((int)threadIdx.x) & 31) * 16)) + ((n_7 & 1) * 8)) + 393220)])));
  ...
  __syncthreads();
  for (int r_10 = 0; r_10 < 2; ++r_10) {
    if (((((int)blockIdx.x) * 2) + ((((((int)threadIdx.x) >> 7) * 2) + r_10) & 1)) < 5) {
      for (int z_4 = 0; z_4 < 8; ++z_4) {
        uint v = nr_ld32((&(((uchar*)packed)[((((((((int)threadIdx.x) >> 5) * 4096) + (r_10 * 1024)) + ((z_4 >> 2) * 512)) + ((((int)threadIdx.x) & 31) * 16)) + ((z_4 & 3) * 4))])));
        nr_st32((&(Raw[(((((((((((int)blockIdx.y) * 81920) + ((((int)threadIdx.x) >> 7) * 40960)) + (((int)blockIdx.x) * 16384)) + (((((((int)threadIdx.x) >> 7) * 2) + r_10) & 1) * 8192)) + (((int)blockIdx.z) * 4096)) + (((((int)threadIdx.x) >> 5) & 3) * 1024)) + ((z_4 >> 2) * 512)) + ((((int)threadIdx.x) & 31) * 16)) + ((z_4 & 3) * 4))])), v);
      }
    }
  }
