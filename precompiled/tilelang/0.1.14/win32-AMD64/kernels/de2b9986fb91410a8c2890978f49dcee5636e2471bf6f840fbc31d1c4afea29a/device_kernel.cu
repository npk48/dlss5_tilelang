...
extern "C" __global__ void __launch_bounds__(128, 1) kernel_kernel(const int* __restrict__ AG, const int* __restrict__ FG, int* __restrict__ RW, const int* __restrict__ SW, const int* __restrict__ WB, const int* __restrict__ WP, const int* __restrict__ WQ, const int* __restrict__ WR, const int* __restrict__ WS, const int* __restrict__ WT, const int* __restrict__ WX) {
  ...
  for (int m = 0; m < 4; ++m) {
    ...
    for (int word = 0; word < 4; ++word) {
      ...
      if (((((bool)1 & (bool)1) & (bool)1) & (bool)1)) {
        condval = ((((((((((((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) & -15) | ((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) & 2) << 2)) | ((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) & 4) >> 1)) | ((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) & 8) >> 1)) >> 4) * 81920) + ((((int)blockIdx.x) / 10) * 10240)) + ((((((m * 16) + ((word & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2560)) + (((((m * 16) + ((word & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1) * 1280)) + ((((int)blockIdx.x) % 10) * 128)) + ((((((m * 16) + ((word & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7) * 16)) + (((((((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) & -15) | ((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) & 2) << 2)) | ((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) & 4) >> 1)) | ((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) & 8) >> 1)) & 1) | ((((((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) & -15) | ((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) & 2) << 2)) | ((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) & 4) >> 1)) | ((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) & 8) >> 1)) & 6) << 1)) | ((((((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) & -15) | ((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) & 2) << 2)) | ((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) & 4) >> 1)) | ((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) & 8) >> 1)) & 8) >> 2)));
      } else {
        condval = -1;
      }
      v = condval;
      ...
      if (comp == 0) {
        ...
        for (int j = 0; j < 2; ++j) {
          ...
          for (int n_8 = 0; n_8 < 4; ++n_8) {
            ...
            int v__2 = WS[((((int)threadIdx.x) >> 5) + 45128)];
            Z[(((dest * 24) + (n_8 * 2)) + j)] = wide_mul(Z[(((dest * 24) + (n_8 * 2)) + j)], wide_splat((*(float *)(&(v__2)))));
          }
        }
        #pragma unroll
  ...
  for (int slab_1 = 0; slab_1 < 2; ++slab_1) {
    ...
    for (int word_7 = 0; word_7 < 8; ++word_7) {
      ...
      Residual[word_7] = wide_packet_prmt((*(uint *)(&(v__3))), (*(uint *)(&(v__4))), condval_3);
    }
    __syncthreads();
    #pragma unroll
    for (int word_8 = 0; word_8 < 8; ++word_8) {
      ...
      S[((((((((int)threadIdx.x) >> 5) * 512) + (slab_1 * 256)) + ((word_8 >> 2) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + (word_8 & 3))] = (*(int *)(&(_reinterpret_tmp_2)));
    }
    __syncthreads();
    #pragma unroll
    ...
    for (int parity = 0; parity < 2; ++parity) {
      int condval_4;
      if (((((bool)1 & (bool)1) & (bool)1) & (bool)1)) {
        condval_4 = ((((((((((int)blockIdx.x) / 10) * 81920) + (((((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) >> 1) * 40960)) + ((((int)blockIdx.x) % 10) * 4096)) + (((((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7) >> 2) * 2048)) + ((((((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 2)) & 1) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 2)) & 6) << 3)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 2)) & 8) >> 2)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 2)) & 16) >> 1)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 2)) & 224) << 4))) + ((((((((((((int)blockIdx.x) / 10) * 8) + ((((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) >> 1) & 1) | (((((((int)blockIdx.x) % 10) * 8) + (((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7)) & 3) << 1)) | ((((((((int)blockIdx.x) / 10) * 8) + ((((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) & 1) << 3)) & 1) << 2)) + ((((((((((((int)blockIdx.x) / 10) * 8) + ((((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) >> 1) & 1) | (((((((int)blockIdx.x) % 10) * 8) + (((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7)) & 3) << 1)) | ((((((((int)blockIdx.x) / 10) * 8) + ((((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) & 1) << 3)) & 14) << 5));
      } else {
        condval_4 = -1;
      }
      v_28 = condval_4;
      ...
      for (int j_3 = 0; j_3 < 4; ++j_3) {
        ...
        temp[j_3] = wide_packet_prmt(P[(((j_3 & 1) * 4) + ((j_3 >> 1) * 2))], P[((((j_3 & 1) * 4) + ((j_3 >> 1) * 2)) + 1)], condval_5);
      }
      if ((0 <= raw_1) & (raw_1 <= 29556112)) {
        {
          int RW_local_cast[4];
          int4 __1;
          ...
          *(int4*)(RW + (((raw_1 >> 4) * 4) + 7700480)) = *(int4*)(RW_local_cast + 0);
        }
      }
    }
    __syncthreads();
