...
extern "C" __global__ void __launch_bounds__(128, 1) kernel_kernel(const int* __restrict__ AG, const int* __restrict__ FG, const int* __restrict__ Matrix, const int* __restrict__ PI, const int* __restrict__ PO, uchar* __restrict__ R, int* __restrict__ RW, const int* __restrict__ SW, const int* __restrict__ WB, const int* __restrict__ WP, const int* __restrict__ WQ, const int* __restrict__ WR, const int* __restrict__ WS, const int* __restrict__ WT, const int* __restrict__ WX) {
  extern __shared__ __align__(1024) uchar buf_dyn_shmem[];
  void* S = ((void*)((char*)buf_dyn_shmem + 0));
  void* D = ((void*)((char*)buf_dyn_shmem + 8192));
  uint temp[4];
  int v = 0;
  uint Residual[16];
  uint C[32];
  ...
  for (int slab = 0; slab < 2; ++slab) {
    ...
    for (int parity = 0; parity < 2; ++parity) {
      int condval;
      if (((((1 <= (((((int)blockIdx.x) % 11) * 2) + ((((((slab * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7) >> 2))) & ((((((int)blockIdx.x) % 11) * 2) + ((((((slab * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7) >> 2)) < 21)) & (1 <= (((((int)blockIdx.x) / 11) * 2) + ((((((slab * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) >> 1)))) & ((((((int)blockIdx.x) / 11) * 2) + ((((((slab * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) >> 1)) < 17))) {
        condval = (((((((((((int)blockIdx.x) / 11) * 81920) + (((((((slab * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) >> 1) * 40960)) + ((((int)blockIdx.x) % 11) * 4096)) + (((((((slab * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7) >> 2) * 2048)) + ((((((((((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & -15) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & 2) << 2)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & 4) >> 1)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & 8) >> 1)) & 1) | (((((((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & -15) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & 2) << 2)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & 4) >> 1)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & 8) >> 1)) & 6) << 3)) | (((((((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & -15) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & 2) << 2)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & 4) >> 1)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & 8) >> 1)) & 8) >> 2)) | (((((((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & -15) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & 2) << 2)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & 4) >> 1)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & 8) >> 1)) & 16) >> 1)) | (((((((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & -15) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & 2) << 2)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & 4) >> 1)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & 8) >> 1)) & 224) << 4))) + (((((((((((((int)blockIdx.x) / 11) * 8) + ((((((slab * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) - 4) >> 1) & 1) | ((((((((int)blockIdx.x) % 11) * 8) + (((((slab * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7)) - 4) & 3) << 1)) | (((((((((int)blockIdx.x) / 11) * 8) + ((((((slab * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) - 4) & 1) << 3)) & 1) << 2)) + (((((((((((((int)blockIdx.x) / 11) * 8) + ((((((slab * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) - 4) >> 1) & 1) | ((((((((int)blockIdx.x) % 11) * 8) + (((((slab * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7)) - 4) & 3) << 1)) | (((((((((int)blockIdx.x) / 11) * 8) + ((((((slab * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) - 4) & 1) << 3)) & 14) << 5)) - 43008);
      } else {
        condval = -1;
      }
      v = condval;
      ...
      *(uint4*)(temp + 0) = make_uint4(broadcast_var, broadcast_var, broadcast_var, broadcast_var);
      if ((0 <= raw) & (raw <= 26934672)) {
        {
          int SW_local_cast[4];
          *(int4*)(SW_local_cast + 0) = *(int4*)(SW + (((raw >> 4) * 4) + 8355840));
          uint4 __1;
      ...
      #pragma unroll
      for (int j = 0; j < 4; ++j) {
        ((int*)S)[(((((((((int)threadIdx.x) >> 5) * 512) + (slab * 256)) + ((j & 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + ((j >> 1) * 2)) + parity)] = ((int)temp[j]);
      }
    }
  }
  __syncthreads();
  ...
  for (int word = 0; word < 16; ++word) {
    int v__1 = ((int*)S)[(((((((int)threadIdx.x) >> 5) * 512) + ((word >> 2) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + (((word & 3) >> 1) * 2))];
    int v__2 = ((int*)S)[((((((((int)threadIdx.x) >> 5) * 512) + ((word >> 2) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + (((word & 3) >> 1) * 2)) + 1)];
    int condval_1;
    if (((word % 2) == 0)) {
      condval_1 = 21520;
    } else {
  ...
  for (int slab_1 = 0; slab_1 < 4; ++slab_1) {
    ...
    for (int kp = 0; kp < 3; ++kp) {
      ...
      for (int m_2 = 0; m_2 < 4; ++m_2) {
        *(int4*)(a + (m_2 * 4)) = *(int4*)(((int*)S) + (((kp * 512) + (m_2 * 128)) + ((((int)threadIdx.x) & 31) * 4)));
      }
      #pragma unroll
    ...
    for (int m_4 = 0; m_4 < 4; ++m_4) {
      *(int4*)(a_1 + 0) = *(int4*)(((int*)S) + (((m_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1536));
      #pragma unroll
  ...
  for (int word_2 = 0; word_2 < 16; ++word_2) {
    ...
    ((int*)S)[(((((((int)threadIdx.x) >> 5) * 512) + ((word_2 >> 2) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + (word_2 & 3))] = (*(int *)(&(_reinterpret_tmp)));
  }
  __syncthreads();
  #pragma unroll
  ...
  for (int kp_1 = 0; kp_1 < 4; ++kp_1) {
    ...
    for (int m_7 = 0; m_7 < 4; ++m_7) {
      *(int4*)(a_2 + (m_7 * 4)) = *(int4*)(((int*)S) + (((kp_1 * 512) + (m_7 * 128)) + ((((int)threadIdx.x) & 31) * 4)));
    }
    #pragma unroll
  ...
  for (int word_3 = 0; word_3 < 16; ++word_3) {
    ...
    ((int*)S)[(((((((int)threadIdx.x) >> 5) * 512) + ((word_3 >> 2) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + (word_3 & 3))] = (*(int *)(&(_reinterpret_tmp_1)));
  }
  __syncthreads();
  #pragma unroll
  ...
  for (int kp_2 = 0; kp_2 < 3; ++kp_2) {
    ...
    for (int m_11 = 0; m_11 < 4; ++m_11) {
      *(int4*)(a_3 + (m_11 * 4)) = *(int4*)(((int*)S) + (((kp_2 * 512) + (m_11 * 128)) + ((((int)threadIdx.x) & 31) * 4)));
    }
    #pragma unroll
  ...
  for (int comp = 0; comp < 3; ++comp) {
    ...
    for (int dest = 0; dest < 4; ++dest) {
      *(int4*)(a_4 + 0) = *(int4*)(((int*)S) + (((dest * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1536));
      #pragma unroll
  ...
  for (int slab_2 = 0; slab_2 < 2; ++slab_2) {
    ...
    for (int word_6 = 0; word_6 < 8; ++word_6) {
      int v__4 = ((int*)S)[((((((((int)threadIdx.x) >> 5) * 512) + (slab_2 * 256)) + ((word_6 >> 2) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + (((word_6 & 3) >> 1) * 2))];
      int v__5 = ((int*)S)[(((((((((int)threadIdx.x) >> 5) * 512) + (slab_2 * 256)) + ((word_6 >> 2) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + (((word_6 & 3) >> 1) * 2)) + 1)];
      int condval_2;
      if (((word_6 % 2) == 0)) {
        condval_2 = 21520;
      } else {
    ...
    for (int word_7 = 0; word_7 < 8; ++word_7) {
      ...
      ((int*)S)[((((((((int)threadIdx.x) >> 5) * 512) + (slab_2 * 256)) + ((word_7 >> 2) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + (word_7 & 3))] = (*(int *)(&(_reinterpret_tmp_2)));
    }
    __syncthreads();
    #pragma unroll
    ...
    for (int kp_4 = 0; kp_4 < 4; ++kp_4) {
      ...
      for (int m_16 = 0; m_16 < 2; ++m_16) {
        *(int4*)(a_5 + (m_16 * 4)) = *(int4*)(((int*)S) + ((((kp_4 * 512) + (slab_2 * 256)) + (m_16 * 128)) + ((((int)threadIdx.x) & 31) * 4)));
      }
      #pragma unroll
    ...
    for (int parity_1 = 0; parity_1 < 2; ++parity_1) {
      int condval_3;
      if (((((1 <= (((((int)blockIdx.x) % 11) * 2) + ((((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7) >> 2))) & ((((((int)blockIdx.x) % 11) * 2) + ((((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7) >> 2)) < 21)) & (1 <= (((((int)blockIdx.x) / 11) * 2) + ((((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) >> 1)))) & ((((((int)blockIdx.x) / 11) * 2) + ((((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) >> 1)) < 17))) {
        condval_3 = (((((((((((int)blockIdx.x) / 11) * 81920) + (((((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) >> 1) * 40960)) + ((((int)blockIdx.x) % 11) * 4096)) + (((((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7) >> 2) * 2048)) + ((((((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 2)) & 1) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 2)) & 6) << 3)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 2)) & 8) >> 2)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 2)) & 16) >> 1)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 2)) & 224) << 4))) + (((((((((((((int)blockIdx.x) / 11) * 8) + ((((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) - 4) >> 1) & 1) | ((((((((int)blockIdx.x) % 11) * 8) + (((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7)) - 4) & 3) << 1)) | (((((((((int)blockIdx.x) / 11) * 8) + ((((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) - 4) & 1) << 3)) & 1) << 2)) + (((((((((((((int)blockIdx.x) / 11) * 8) + ((((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) - 4) >> 1) & 1) | ((((((((int)blockIdx.x) % 11) * 8) + (((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7)) - 4) & 3) << 1)) | (((((((((int)blockIdx.x) / 11) * 8) + ((((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) - 4) & 1) << 3)) & 14) << 5)) - 43008);
      } else {
        condval_3 = -1;
      }
      v_28 = condval_3;
      ...
      if ((0 <= raw_1) & (raw_1 <= 26279312)) {
        {
          ...
          *(int4*)(RW + (((raw_1 >> 4) * 4) + 8519680)) = *(int4*)(RW_local_cast_1 + 0);
        }
      }
    }
    #pragma unroll
    for (int m_19 = 0; m_19 < 2; ++m_19) {
      ...
      for (int n_19 = 0; n_19 < 4; ++n_19) {
        ...
        for (int j_5 = 0; j_5 < 2; ++j_5) {
          uint v__7 = C[(((m_19 * 8) + (n_19 * 2)) + j_5)];
          ((int*)D)[(((((((((int)threadIdx.x) >> 5) * 1024) + (slab_2 * 512)) + (m_19 * 256)) + (n_19 * 64)) + ((((int)threadIdx.x) & 31) * 2)) + j_5)] = (*(int *)(&(v__7)));
        }
      }
    }
    __syncthreads();
  ...
  for (int group_1 = 0; group_1 < 2; ++group_1) {
    for (int n_20 = 0; n_20 < 4; ++n_20) {
      acc[0] = (uint)0;
      acc[1] = (uint)0;
      for (int kp_5 = 0; kp_5 < 4; ++kp_5) {
        #pragma unroll
        for (int word_8 = 0; word_8 < 4; ++word_8) {
          ...
          for (int b_8 = 0; b_8 < 4; ++b_8) {
            #pragma unroll
            for (int t = 0; t < 4; ++t) {
              int ix = PI[(((((((int)blockIdx.x) * 8192) + ((word_8 & 1) * 4096)) + (((((int)threadIdx.x) & 31) >> 2) * 512)) + (t * 128)) + ((((((((kp_5 * 32) + ((word_8 >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) + b_8) & -15) | ((((((kp_5 * 32) + ((word_8 >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) + b_8) & 2) << 2)) | ((((((kp_5 * 32) + ((word_8 >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) + b_8) & 4) >> 1)) | ((((((kp_5 * 32) + ((word_8 >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) + b_8) & 8) >> 1)))];
              vals[t] = (uint)0;
              if (0 <= ix) {
                int v__8 = ((int*)D)[((((((((ix & 127) >> 5) * 1024) + ((ix >> 11) * 256)) + (((ix & 31) >> 3) * 64)) + (((ix & 1023) >> 7) * 8)) + (((ix & 7) >> 1) * 2)) + ((ix & 2047) >> 10))];
                vals[t] = ((((*(uint *)(&(v__8))) >> ((uint)((ix & 1) * 16))) & (uint)65535) | ((((*(uint *)(&(v__8))) >> ((uint)((ix & 1) * 16))) & (uint)65535) << (uint)16));
              }
            }
            uint avg = wide_mul(wide_add(wide_add(vals[0], vals[1]), wide_add(vals[2], vals[3])), wide_splat(0x1p-2f/*2.500000e-01*/));
            temp[word_8] = (temp[word_8] | ((wide_encode(avg, avg) & (uint)255) << ((uint)(b_8 * 8))));
          }
        }
        uint64_t r_9 = wide_mma(temp[0], temp[1], temp[2], temp[3], Matrix[((((((kp_5 * 2048) + (group_1 * 1024)) + ((((int)threadIdx.x) >> 5) * 256)) + ((n_20 >> 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + ((n_20 & 1) * 2))], Matrix[(((((((kp_5 * 2048) + (group_1 * 1024)) + ((((int)threadIdx.x) >> 5) * 256)) + ((n_20 >> 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + ((n_20 & 1) * 2)) + 1)], acc[0], acc[1]);
        acc[0] = ((uint)r_9);
        acc[1] = ((uint)(r_9 >> (uint64_t)32));
      }
      uint encoded = wide_encode(acc[0], acc[1]);
      #pragma unroll
      for (int b_9 = 0; b_9 < 4; ++b_9) {
        int dest_1 = PO[((((((((((int)blockIdx.x) * 4096) + ((b_9 >> 1) * 2048)) + (((((int)threadIdx.x) & 31) >> 2) * 256)) + (group_1 * 128)) + ((((int)threadIdx.x) >> 5) * 32)) + (n_20 * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (b_9 & 1))];
        if (0 <= dest_1) {
          if (dest_1 < 25623968) {
            R[(dest_1 + 34734080)] = ((uchar)(encoded >> ((uint)(b_9 * 8))));
          }
        }
      }
    }
