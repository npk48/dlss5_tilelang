...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(const uchar* __restrict__ A, int* __restrict__ C0, int* __restrict__ C1, uchar* __restrict__ Raw, const uchar* __restrict__ Weight, int H, int W, int n0, int n1, int sizes_3, int v0, int v1) {
  ...
  for (int g = 0; g < 8; ++g) {
    for (int z = 0; z < 4; ++z) {
      int i = max((((((((((int)blockIdx.x) * 16384) + (((H >> 2) * ((((int)blockIdx.y) * 2) + (((int)threadIdx.x) >> 7))) * 8192)) + (((((int)threadIdx.x) >> 6) & 1) * 8192)) + (g * 1024)) + (((((int)threadIdx.x) >> 5) & 1) * 512)) + ((((int)threadIdx.x) & 31) * 16)) + (z * 4)), (((((((((int)blockIdx.x) * 16384) + (((H >> 2) * ((((int)blockIdx.y) * 2) + (((int)threadIdx.x) >> 7))) * 8192)) + (((((int)threadIdx.x) >> 6) & 1) * 8192)) + (g * 1024)) + (((((int)threadIdx.x) >> 5) & 1) * 512)) + ((((int)threadIdx.x) & 31) * 16)) + (z * 4)));
      uint condval;
      if (((((((int)blockIdx.y) * 2) + (((int)threadIdx.x) >> 7)) < (W >> 2)) && (((((int)blockIdx.x) * 2) + ((((int)threadIdx.x) >> 6) & 1)) < (H >> 2)))) {
  ...
  for (int r_10 = 0; r_10 < 2; ++r_10) {
    if ((((((int)blockIdx.y) * 2) + (((int)threadIdx.x) >> 7)) < (W >> 2)) && (((((int)blockIdx.x) * 2) + ((((((int)threadIdx.x) >> 7) * 2) + r_10) & 1)) < (H >> 2))) {
      for (int z_4 = 0; z_4 < 8; ++z_4) {
        int i_2 = max(((((((((((int)blockIdx.x) * 16384) + (((H >> 2) * ((((int)blockIdx.y) * 2) + (((int)threadIdx.x) >> 7))) * 8192)) + (((((((int)threadIdx.x) >> 7) * 2) + r_10) & 1) * 8192)) + (((int)blockIdx.z) * 4096)) + (((((int)threadIdx.x) >> 5) & 3) * 1024)) + ((z_4 >> 2) * 512)) + ((((int)threadIdx.x) & 31) * 16)) + ((z_4 & 3) * 4)), ((((((((((int)blockIdx.x) * 16384) + (((H >> 2) * ((((int)blockIdx.y) * 2) + (((int)threadIdx.x) >> 7))) * 8192)) + (((((((int)threadIdx.x) >> 7) * 2) + r_10) & 1) * 8192)) + (((int)blockIdx.z) * 4096)) + (((((int)threadIdx.x) >> 5) & 3) * 1024)) + ((z_4 >> 2) * 512)) + ((((int)threadIdx.x) & 31) * 16)) + ((z_4 & 3) * 4)));
