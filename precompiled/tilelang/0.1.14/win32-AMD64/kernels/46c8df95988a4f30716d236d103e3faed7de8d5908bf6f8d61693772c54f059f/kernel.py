...
def call(kernels, Current, Previous, Residual, Sigmoid, Gate, Out, stream=0):
    ...
    arg_values = Current.data_ptr(), Gate.data_ptr(), Out.data_ptr(), Previous.data_ptr(), Residual.data_ptr(), Sigmoid.data_ptr()
