...
def call(kernels, A, W, Raw, Q, K, V, Scale, C0, C1, stream=0):
    ...
    arg_values = A.data_ptr(), C0.data_ptr(), C1.data_ptr(), K.data_ptr(), Q.data_ptr(), Raw.data_ptr(), Scale.data_ptr(), V.data_ptr(), W.data_ptr()
