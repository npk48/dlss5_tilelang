...
def call(kernels, A, B, M, O, P, G, AH, BH, OH, C0, C1, sizes_0, sizes_1, sizes_2, sizes_3, sizes_4, sizes_5, count, width, poolwidth, n0, v0, n1, v1, stream=0):
    ...
    arg_values = AH.data_ptr(), C0.data_ptr(), C1.data_ptr(), M.data_ptr(), OH.data_ptr(), count, n0, n1, sizes_0, sizes_2, sizes_3, v0, v1
    arg_types = ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32
