  ...
  for (int n = 0; n < 4; ++n) {
    ...
    for (int kp = 0; kp < 4; ++kp) {
      ...
      for (int word = 0; word < 4; ++word) {
        ...
        if ((((((int)blockIdx.x) * 16) + ((word & 1) * 8)) + (((int)threadIdx.x) >> 2)) < rows) {
          int condval;
          if (((((((((int)blockIdx.x) * 2048) + ((word & 1) * 1024)) + ((((int)threadIdx.x) >> 2) * 128)) + (kp * 32)) + ((word >> 1) * 16)) < imn)) {
            condval = IM[(((((((int64_t)((int)blockIdx.x)) * (int64_t)2048) + ((((int64_t)word) & (int64_t)1) * (int64_t)1024)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)2) * (int64_t)128)) + (((int64_t)kp) * (int64_t)32)) + ((((int64_t)word) >> (int64_t)1) * (int64_t)16))];
          } else {
            condval = 0;
          }
          if (0 <= condval) {
            int condval_2;
            if (((((((((int)blockIdx.x) * 2048) + ((word & 1) * 1024)) + ((((int)threadIdx.x) >> 2) * 128)) + (kp * 32)) + ((word >> 1) * 16)) < imn)) {
              condval_2 = IM[(((((((int64_t)((int)blockIdx.x)) * (int64_t)2048) + ((((int64_t)word) & (int64_t)1) * (int64_t)1024)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)2) * (int64_t)128)) + (((int64_t)kp) * (int64_t)32)) + ((((int64_t)word) >> (int64_t)1) * (int64_t)16))];
            } else {
              condval_2 = 0;
            }
            int condval_3;
            if (((((((((int)blockIdx.x) * 2048) + ((word & 1) * 1024)) + ((((int)threadIdx.x) >> 2) * 128)) + (kp * 32)) + ((word >> 1) * 16)) < imn)) {
              condval_3 = IM[(((((((int64_t)((int)blockIdx.x)) * (int64_t)2048) + ((((int64_t)word) & (int64_t)1) * (int64_t)1024)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)2) * (int64_t)128)) + (((int64_t)kp) * (int64_t)32)) + ((((int64_t)word) >> (int64_t)1) * (int64_t)16))];
            } else {
              condval_3 = 0;
            }
            int condval_1;
            if (((0 <= (((inp + condval_2) >> 2) + (((int)threadIdx.x) & 3))) && ((((inp + condval_3) >> 2) + (((int)threadIdx.x) & 3)) < (rn >> 2)))) {
              int condval_4;
              if (((((((((int)blockIdx.x) * 2048) + ((word & 1) * 1024)) + ((((int)threadIdx.x) >> 2) * 128)) + (kp * 32)) + ((word >> 1) * 16)) < imn)) {
                condval_4 = IM[(((((((int64_t)((int)blockIdx.x)) * (int64_t)2048) + ((((int64_t)word) & (int64_t)1) * (int64_t)1024)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)2) * (int64_t)128)) + (((int64_t)kp) * (int64_t)32)) + ((((int64_t)word) >> (int64_t)1) * (int64_t)16))];
              } else {
                condval_4 = 0;
              }
              int condval_5;
              if (((((((((int)blockIdx.x) * 2048) + ((word & 1) * 1024)) + ((((int)threadIdx.x) >> 2) * 128)) + (kp * 32)) + ((word >> 1) * 16)) < imn)) {
                condval_5 = IM[(((((((int64_t)((int)blockIdx.x)) * (int64_t)2048) + ((((int64_t)word) & (int64_t)1) * (int64_t)1024)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)2) * (int64_t)128)) + (((int64_t)kp) * (int64_t)32)) + ((((int64_t)word) >> (int64_t)1) * (int64_t)16))];
              } else {
                condval_5 = 0;
              }
              condval_1 = R[(((inp + condval_5) >> 2) + (((int)threadIdx.x) & 3))];
            } else {
              condval_1 = 0;
            }
      ...
      int condval_6;
      if (((((((kp * 512) + (((int)blockIdx.y) * 256)) + ((n >> 1) * 128)) + (((int)threadIdx.x) * 4)) + ((n & 1) * 2)) < wn)) {
        condval_6 = W[(((((kp * 512) + (((int)blockIdx.y) * 256)) + ((n >> 1) * 128)) + (((int)threadIdx.x) * 4)) + ((n & 1) * 2))];
      } else {
        condval_6 = 0;
      }
      int condval_7;
      if ((((((((kp * 512) + (((int)blockIdx.y) * 256)) + ((n >> 1) * 128)) + (((int)threadIdx.x) * 4)) + ((n & 1) * 2)) + 1) < wn)) {
        condval_7 = W[((((((kp * 512) + (((int)blockIdx.y) * 256)) + ((n >> 1) * 128)) + (((int)threadIdx.x) * 4)) + ((n & 1) * 2)) + 1)];
      } else {
        condval_7 = 0;
      }
    ...
    for (int j = 0; j < 2; ++j) {
      if ((((((int)blockIdx.x) * 16) + (j * 8)) + (((int)threadIdx.x) >> 2)) < rows) {
        if (((((((((int)blockIdx.x) * 512) + (j * 256)) + ((((int)threadIdx.x) >> 2) * 32)) + (((int)blockIdx.y) * 16)) + (n * 4)) + (((int)threadIdx.x) & 3)) < pn) {
          uint v_ = acc[j];
          Proj[((((((((int64_t)((int)blockIdx.x)) * (int64_t)512) + (((int64_t)j) * (int64_t)256)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)2) * (int64_t)32)) + (((int64_t)((int)blockIdx.y)) * (int64_t)16)) + (((int64_t)n) * (int64_t)4)) + (((int64_t)((int)threadIdx.x)) & (int64_t)3))] = (*(int *)(&(v_)));
        }
      }
    }
  }
