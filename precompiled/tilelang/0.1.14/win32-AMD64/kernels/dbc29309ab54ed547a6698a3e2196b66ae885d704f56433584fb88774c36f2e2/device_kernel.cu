...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(const uchar* __restrict__ A, int* __restrict__ C0, int* __restrict__ C1, uchar* __restrict__ Raw, const uchar* __restrict__ Skip, const uchar* __restrict__ Weight, int H, int W, int n0, int n1, int sizes_3, int v0, int v1) {
  ...
  for (int t = 0; t < 4; ++t) {
    for (int n = 0; n < 8; ++n) {
      for (int h = 0; h < 2; ++h) {
        c[(((t * 16) + (n * 2)) + h)] = (uint)0;
        int y = max(((((sx * 8) + ((t & 1) * 4)) + (h * 2)) + ((((int)threadIdx.x) & 31) >> 4)), ((((sx * 8) + ((t & 1) * 4)) + (h * 2)) + ((((int)threadIdx.x) & 31) >> 4)));
        v = (uint)0;
        if ((y < H) && ((((((int)blockIdx.y) * 8) + ((t >> 1) * 4)) + ((((int)threadIdx.x) & 15) >> 2)) < W)) {
          int off = max((((((((((((sx * 16384) + (((H >> 2) * ((((int)blockIdx.y) * 2) + (t >> 1))) * 8192)) + ((t & 1) * 8192)) + (g * 1024)) + (((n * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 1)) + ((((n * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 6) << 3)) + ((((n * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 8) >> 2)) + ((((n * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 16) >> 1)) + ((((n * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 32) << 4)) + (((((((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) >> 2) & 1) * 8) + ((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) & 3) * 2)) + ((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) >> 3) & 1)) & 1) << 2)) + (((((((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) >> 2) & 1) * 8) + ((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) & 3) * 2)) + ((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) >> 3) & 1)) & 14) << 5)), (((((((((((sx * 16384) + (((H >> 2) * ((((int)blockIdx.y) * 2) + (t >> 1))) * 8192)) + ((t & 1) * 8192)) + (g * 1024)) + (((n * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 1)) + ((((n * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 6) << 3)) + ((((n * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 8) >> 2)) + ((((n * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 16) >> 1)) + ((((n * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 32) << 4)) + (((((((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) >> 2) & 1) * 8) + ((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) & 3) * 2)) + ((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) >> 3) & 1)) & 1) << 2)) + (((((((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) >> 2) & 1) * 8) + ((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) & 3) * 2)) + ((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) >> 3) & 1)) & 14) << 5)));
  ...
  for (int r_1 = 0; r_1 < 4; ++r_1) {
    for (int n_2 = 0; n_2 < 8; ++n_2) {
      for (int h_1 = 0; h_1 < 2; ++h_1) {
        ...
        int y_1 = max(((((sx * 8) + ((r_1 & 1) * 4)) + (h_1 * 2)) + ((((int)threadIdx.x) & 31) >> 4)), ((((sx * 8) + ((r_1 & 1) * 4)) + (h_1 * 2)) + ((((int)threadIdx.x) & 31) >> 4)));
      }
    }
  }
  __syncthreads();
  for (int aa = 0; aa < 4; ++aa) {
    for (int h_2 = 0; h_2 < 4; ++h_2) {
      for (int rowhalf = 0; rowhalf < 2; ++rowhalf) {
        int yp = max((((sx * 8) + (rowhalf * 4)) + ((((int)threadIdx.x) & 15) >> 2)), (((sx * 8) + (rowhalf * 4)) + ((((int)threadIdx.x) & 15) >> 2)));
        int r_2 = max(((((h_2 & 1) * 8) + (((((int)threadIdx.x) & 31) >> 4) * 4)) + (yp & 3)), ((((h_2 & 1) * 8) + (((((int)threadIdx.x) & 31) >> 4) * 4)) + (yp & 3)));
        uint lo = (((uint)((uchar*)packed)[(((((((((((((int)threadIdx.x) >> 5) * 4096) + ((h_2 >> 1) * 2048)) + (rowhalf * 1024)) + (((aa * 16) + ((((int)threadIdx.x) & 3) * 2)) & 1)) + ((((aa * 16) + ((((int)threadIdx.x) & 3) * 2)) & 6) << 3)) + ((((aa * 16) + ((((int)threadIdx.x) & 3) * 2)) & 8) >> 2)) + ((((aa * 16) + ((((int)threadIdx.x) & 3) * 2)) & 16) >> 1)) + ((((aa * 16) + ((((int)threadIdx.x) & 3) * 2)) & 32) << 4)) + (((((((r_2 >> 2) & 1) * 8) + ((r_2 & 3) * 2)) + ((r_2 >> 3) & 1)) & 1) << 2)) + (((((((r_2 >> 2) & 1) * 8) + ((r_2 & 3) * 2)) + ((r_2 >> 3) & 1)) & 14) << 5))]) | (((uint)((uchar*)packed)[((((((((((((((int)threadIdx.x) >> 5) * 4096) + ((h_2 >> 1) * 2048)) + (rowhalf * 1024)) + (((aa * 16) + ((((int)threadIdx.x) & 3) * 2)) & 1)) + ((((aa * 16) + ((((int)threadIdx.x) & 3) * 2)) & 6) << 3)) + ((((aa * 16) + ((((int)threadIdx.x) & 3) * 2)) & 8) >> 2)) + ((((aa * 16) + ((((int)threadIdx.x) & 3) * 2)) & 16) >> 1)) + ((((aa * 16) + ((((int)threadIdx.x) & 3) * 2)) & 32) << 4)) + (((((((r_2 >> 2) & 1) * 8) + ((r_2 & 3) * 2)) + ((r_2 >> 3) & 1)) & 1) << 2)) + (((((((r_2 >> 2) & 1) * 8) + ((r_2 & 3) * 2)) + ((r_2 >> 3) & 1)) & 14) << 5)) + 1)]) << (uint)8));
        uint hi = (((uint)((uchar*)packed)[(((((((((((((int)threadIdx.x) >> 5) * 4096) + ((h_2 >> 1) * 2048)) + (rowhalf * 1024)) + ((((aa * 16) + ((((int)threadIdx.x) & 3) * 2)) + 8) & 1)) + (((((aa * 16) + ((((int)threadIdx.x) & 3) * 2)) + 8) & 6) << 3)) + (((((aa * 16) + ((((int)threadIdx.x) & 3) * 2)) + 8) & 8) >> 2)) + (((((aa * 16) + ((((int)threadIdx.x) & 3) * 2)) + 8) & 16) >> 1)) + (((((aa * 16) + ((((int)threadIdx.x) & 3) * 2)) + 8) & 32) << 4)) + (((((((r_2 >> 2) & 1) * 8) + ((r_2 & 3) * 2)) + ((r_2 >> 3) & 1)) & 1) << 2)) + (((((((r_2 >> 2) & 1) * 8) + ((r_2 & 3) * 2)) + ((r_2 >> 3) & 1)) & 14) << 5))]) | (((uint)((uchar*)packed)[((((((((((((((int)threadIdx.x) >> 5) * 4096) + ((h_2 >> 1) * 2048)) + (rowhalf * 1024)) + ((((aa * 16) + ((((int)threadIdx.x) & 3) * 2)) + 8) & 1)) + (((((aa * 16) + ((((int)threadIdx.x) & 3) * 2)) + 8) & 6) << 3)) + (((((aa * 16) + ((((int)threadIdx.x) & 3) * 2)) + 8) & 8) >> 2)) + (((((aa * 16) + ((((int)threadIdx.x) & 3) * 2)) + 8) & 16) >> 1)) + (((((aa * 16) + ((((int)threadIdx.x) & 3) * 2)) + 8) & 32) << 4)) + (((((((r_2 >> 2) & 1) * 8) + ((r_2 & 3) * 2)) + ((r_2 >> 3) & 1)) & 1) << 2)) + (((((((r_2 >> 2) & 1) * 8) + ((r_2 & 3) * 2)) + ((r_2 >> 3) & 1)) & 14) << 5)) + 1)]) << (uint)8));
        if (((((((int)blockIdx.y) * 8) + (h_2 * 2)) + ((((int)threadIdx.x) & 31) >> 4)) < W) && (yp < H)) {
          int i_5 = max(((((((((((int)blockIdx.y) * 8) + (h_2 * 2)) + ((((int)threadIdx.x) & 31) >> 4)) + (W * ((g * 4) + aa))) * H) * 16) + (yp * 16)) + ((((int)threadIdx.x) & 3) * 4)), ((((((((((int)blockIdx.y) * 8) + (h_2 * 2)) + ((((int)threadIdx.x) & 31) >> 4)) + (W * ((g * 4) + aa))) * H) * 16) + (yp * 16)) + ((((int)threadIdx.x) & 3) * 4)));
          uint v_1 = (lo | (hi << (uint)16));
          if (0 <= i_5) {
            if (i_5 < sizes_3) {
              nr_st32((&(Raw[((int64_t)i_5)])), (lo | (hi << (uint)16)));
            }
          }
        }
      }
