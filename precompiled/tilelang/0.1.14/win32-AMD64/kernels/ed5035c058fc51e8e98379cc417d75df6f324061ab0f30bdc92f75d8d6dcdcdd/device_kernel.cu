...
extern "C" __global__ void main_kernel(uchar* __restrict__ A, int* __restrict__ C0, int* __restrict__ C1, uint* __restrict__ P, const int* __restrict__ Pack, const ushort* __restrict__ Route, uchar* __restrict__ W, int n0, int n1, int rows, int sizes_3, int sizes_6, int sizes_7, int v0, int v1);
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(uchar* __restrict__ A, int* __restrict__ C0, int* __restrict__ C1, uint* __restrict__ P, const int* __restrict__ Pack, const ushort* __restrict__ Route, uchar* __restrict__ W, int n0, int n1, int rows, int sizes_3, int sizes_6, int sizes_7, int v0, int v1) {
  uint c[64];
  ...
  for (int j = 0; j < 8; ++j) {
    int condval;
    if ((((((((int)blockIdx.x) * 16384) + (((int)blockIdx.z) * 4096)) + (j * 128)) + ((int)threadIdx.x)) < sizes_6)) {
      condval = Pack[((((((int64_t)((int)blockIdx.x)) * (int64_t)16384) + (((int64_t)((int)blockIdx.z)) * (int64_t)4096)) + (((int64_t)j) * (int64_t)128)) + ((int64_t)((int)threadIdx.x)))];
    } else {
      condval = 0;
    }
    int off = condval;
  ...
  for (int phase = 0; phase < 4; ++phase) {
    ...
    if (phase < 3) {
      ...
      for (int j_2 = 0; j_2 < 8; ++j_2) {
        int condval_1;
        if ((((((((((int)blockIdx.x) * 16384) + (((int)blockIdx.z) * 4096)) + (phase * 1024)) + (j_2 * 128)) + ((int)threadIdx.x)) + 1024) < sizes_6)) {
          condval_1 = Pack[((((((((int64_t)((int)blockIdx.x)) * (int64_t)16384) + (((int64_t)((int)blockIdx.z)) * (int64_t)4096)) + (((int64_t)phase) * (int64_t)1024)) + (((int64_t)j_2) * (int64_t)128)) + ((int64_t)((int)threadIdx.x))) + (int64_t)1024)];
        } else {
          condval_1 = 0;
        }
        int off_1 = condval_1;
    ...
    for (int n_3 = 0; n_3 < 8; ++n_3) {
      ...
      for (int h_1 = 0; h_1 < 2; ++h_1) {
        if ((((((((int)blockIdx.x) * 128) + ((((int)threadIdx.x) >> 6) * 64)) + (r_2 * 16)) + (h_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) < rows) {
          if (0 <= ((((((((int)blockIdx.x) * 128) + ((((int)threadIdx.x) >> 6) * 64)) + (r_2 * 16)) + (h_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) + (((int)blockIdx.z) * rows))) {
            if (((((((((((((int)blockIdx.x) * 32768) + ((((int)threadIdx.x) >> 6) * 16384)) + (r_2 * 4096)) + (h_1 * 2048)) + (((((int)threadIdx.x) & 31) >> 2) * 256)) + ((((int)blockIdx.z) * rows) * 256)) + (((int)blockIdx.y) * 64)) + (((((int)threadIdx.x) & 63) >> 5) * 32)) + (n_3 * 4)) + ((((int)threadIdx.x) & 31) & 3)) < sizes_3) {
              P[((((((((((((int64_t)((int)blockIdx.x)) * (int64_t)32768) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)6) * (int64_t)16384)) + (((int64_t)r_2) * (int64_t)4096)) + (((int64_t)h_1) * (int64_t)2048)) + (((((int64_t)((int)threadIdx.x)) & (int64_t)31) >> (int64_t)2) * (int64_t)256)) + ((((int64_t)((int)blockIdx.z)) * ((int64_t)rows)) * (int64_t)256)) + (((int64_t)((int)blockIdx.y)) * (int64_t)64)) + (((((int64_t)((int)threadIdx.x)) & (int64_t)63) >> (int64_t)5) * (int64_t)32)) + (((int64_t)n_3) * (int64_t)4)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)31) & (int64_t)3))] = c[(((r_2 * 16) + (n_3 * 2)) + h_1)];
            }
          }
        }
      }
