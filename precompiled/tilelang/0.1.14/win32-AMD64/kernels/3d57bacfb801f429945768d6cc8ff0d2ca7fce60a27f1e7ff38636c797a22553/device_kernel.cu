...
extern "C" __global__ void __launch_bounds__(64, 1) kernel_kernel(const int* __restrict__ AG, const int* __restrict__ FG, int* __restrict__ RW, const int* __restrict__ SW, const int* __restrict__ WB, const int* __restrict__ WP, const int* __restrict__ WQ, const int* __restrict__ WR, const int* __restrict__ WS, const int* __restrict__ WT, const int* __restrict__ WX, int counter, int gx, int height, int inp, int out, int rn, int sn, int sx, int sy, int tiles, int width, int wns_0, int wns_1, int wns_2, int wns_3, int wns_4, int wns_6, int wns_7, int wns_8) {
  ...
  for (int part = 0; part < 4; ++part) {
    ...
    v_50 = (((((((0 <= gx) && (0 <= rmod_2)) || ((gx < 0) && (rmod_2 <= 0))) ? rdiv_1 : (rdiv_1 - 1)) * 2) + (v_49 >> 11)) + (sy >> 2));
    int rmod_3 = (((int)blockIdx.x) % gx);
    v_51 = (((((((0 <= gx) && (0 <= rmod_3)) || ((gx < 0) && (rmod_3 <= 0))) ? rmod_3 : (rmod_3 + gx)) * 2) + ((v_49 & 2047) >> 10)) + (sx >> 2));
    int condval_21;
    if (((((0 <= v_50) & (0 <= v_51)) & (v_50 < (height >> 2))) & (v_51 < (width >> 2)))) {
      condval_21 = (((((v_50 * (width >> 2)) * 1024) + (v_51 * 1024)) + (((v_49 >> 9) & 1) * 512)) + (v_49 & 511));
    } else {
      condval_21 = -1;
    }
    v_52 = condval_21;
    ...
    v_54 = (v_53 >> 9);
    v_55 = (v_53 & 511);
    int rmod_4 = (v_54 % ((height >> 3) * (width >> 2)));
    int rdiv_2 = (v_54 / ((height >> 3) * (width >> 2)));
    v_56 = ((((((0 <= ((height >> 3) * (width >> 2))) && (0 <= rmod_4)) || ((((height >> 3) * (width >> 2)) < 0) && (rmod_4 <= 0))) ? rdiv_2 : (rdiv_2 - 1)) * 16) + (v_55 & 15));
    int rmod_5 = (v_54 % ((height >> 3) * (width >> 2)));
    v_57 = ((((0 <= ((height >> 3) * (width >> 2))) && (0 <= rmod_5)) || ((((height >> 3) * (width >> 2)) < 0) && (rmod_5 <= 0))) ? rmod_5 : (rmod_5 + ((height >> 3) * (width >> 2))));
    int rmod_6 = (v_57 % (width >> 2));
    int rdiv_3 = (v_57 / (width >> 2));
    v_58 = (((((((0 <= (width >> 2)) && (0 <= rmod_6)) || (((width >> 2) < 0) && (rmod_6 <= 0))) ? rdiv_3 : (rdiv_3 - 1)) * 8) + ((v_57 & 1) * 4)) + (v_55 >> 7));
    int rmod_7 = (v_57 % (width >> 2));
    v_59 = (((((((0 <= (width >> 2)) && (0 <= rmod_7)) || (((width >> 2) < 0) && (rmod_7 <= 0))) ? rmod_7 : (rmod_7 + (width >> 2))) >> 1) * 8) + ((v_55 & 127) >> 4));
    v_60 = ((((((v_56 & 1) | ((v_59 & 1) << 1)) | (((v_59 >> 1) & 1) << 2)) | (((v_56 >> 1) & 1) << 3)) | (((v_56 >> 3) & 1) << 4)) | (((v_58 >> 2) & 1) << 5));
    v_61 = ((((((v_56 >> 2) & 1) | (((v_59 >> 2) & 1) << 1)) | ((v_58 & 1) << 2)) | (((v_58 >> 1) & 1) << 3)) | (((v_59 >> 3) & 1) << 4));
    v_62 = ((((v_59 >> 4) * 32) + (((width >> 4) * ((v_58 >> 3) + ((height >> 3) * (v_56 >> 4)))) * 32)) + v_61);
    v_63 = (v_62 & 63);
    v_64 = (v_62 >> 6);
    int rmod_8 = (v_64 % (width >> 4));
    int rdiv_4 = (v_64 / (width >> 4));
    v_65 = (((((((0 <= (width >> 4)) && (0 <= rmod_8)) || (((width >> 4) < 0) && (rmod_8 <= 0))) ? rdiv_4 : (rdiv_4 - 1)) * 4) + ((v_63 & 1) * 2)) + ((v_63 >> 3) & 1));
    int rmod_9 = (v_64 % (width >> 4));
    v_66 = (((((((((0 <= (width >> 4)) && (0 <= rmod_9)) || (((width >> 4) < 0) && (rmod_9 <= 0))) ? rmod_9 : (rmod_9 + (width >> 4))) * 16) + (((v_63 >> 5) & 1) * 8)) + (((v_63 >> 4) & 1) * 4)) + (((v_63 >> 2) & 1) * 2)) + ((v_63 >> 1) & 1));
    int condval_22;
    if ((0 <= v_53)) {
      condval_22 = (((((((v_65 * width) * 16) + (v_66 * 16)) + ((((v_60 >> 4) * height) * width) * 16)) + (v_60 & 1)) + ((v_60 & 6) << 1)) + ((v_60 & 8) >> 2));
    } else {
      condval_22 = -1;
    }
    v_67 = condval_22;
