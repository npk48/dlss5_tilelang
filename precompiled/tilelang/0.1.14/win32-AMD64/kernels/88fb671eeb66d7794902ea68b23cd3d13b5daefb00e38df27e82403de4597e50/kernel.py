...
def call(kernels, Wt0, Wt1, Wq, Wp, G0, G1, X, Y, Features, Adapter, Status, Mixed, Pre, Gate, Readout, Head, stream=0):
    ...
    arg_values = G0.data_ptr(), G1.data_ptr(), Pre.data_ptr(), Wp.data_ptr(), Wq.data_ptr(), Wt0.data_ptr(), Wt1.data_ptr(), X.data_ptr()
    arg_types = ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p
