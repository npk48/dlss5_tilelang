...
def call(kernels, R, Source, W, Proj, Gate, Rows, PO, Matrix, UG, UL, tiles, height, width, gx, sx, sy, rn, sn, wn, inp, out, counter, prn, gn, skip, drn, pon, mn, poolout, ugn, uln, planar_rows, stream=0):
    ...
    arg_values = Gate.data_ptr(), Proj.data_ptr(), R.data_ptr(), UG.data_ptr(), UL.data_ptr(), W.data_ptr(), counter, gn, gx, height, inp, out, planar_rows, prn, rn, skip, sx, sy, tiles, ugn, uln, width, wn
    arg_types = ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32
