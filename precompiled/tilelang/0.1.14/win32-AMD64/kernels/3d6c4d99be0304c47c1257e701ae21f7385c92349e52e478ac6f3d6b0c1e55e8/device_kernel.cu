...
extern "C" __global__ void __launch_bounds__(64, 1) kernel_kernel(const int* __restrict__ AG, const int* __restrict__ FG, int* __restrict__ RW, const int* __restrict__ SW, const int* __restrict__ WB, const int* __restrict__ WP, const int* __restrict__ WQ, const int* __restrict__ WR, const int* __restrict__ WS, const int* __restrict__ WT, const int* __restrict__ WX, int counter, int gx, int height, int inp, int out, int rn, int sn, int tiles, int width, int wns_0, int wns_1, int wns_2, int wns_3, int wns_4, int wns_6, int wns_7, int wns_8) {
  ...
  #pragma unroll
  for (int m = 0; m < 4; ++m) {
    v = ((((((((m * 16) + ((((int)threadIdx.x) & 31) >> 1)) & 1) | ((((m * 16) + ((((int)threadIdx.x) & 31) >> 1)) & 2) << 3)) | ((((m * 16) + ((((int)threadIdx.x) & 31) >> 1)) & 4) >> 1)) | ((((m * 16) + ((((int)threadIdx.x) & 31) >> 1)) & 8) >> 1)) | ((((m * 16) + ((((int)threadIdx.x) & 31) >> 1)) & 16) << 1)) | ((((m * 16) + ((((int)threadIdx.x) & 31) >> 1)) & 32) >> 2));
    v_1 = (((v & 1) | ((v & 14) << 2)) | ((v >> 3) & 6));
    int rmod = (((int)blockIdx.x) % gx);
    int rmod_1 = (((int)blockIdx.x) % gx);
    int rdiv = (((int)blockIdx.x) / gx);
    v_2 = (((((((0 <= gx) && (0 <= rmod)) || ((gx < 0) && (rmod <= 0))) ? rmod : (rmod + gx)) * 8) + (((((((0 <= gx) && (0 <= rmod_1)) || ((gx < 0) && (rmod_1 <= 0))) ? rdiv : (rdiv - 1)) * 8) + (v_1 >> 3)) * width)) + (v_1 & 7));
    v_3 = ((v_2 * 16) + ((((((((int)threadIdx.x) >> 5) * 2) + (((int)threadIdx.x) & 1)) * height) * width) * 16));
    int raw = v_3;
    ...
    *(uint4*)(temp + 0) = make_uint4(broadcast_var, broadcast_var, broadcast_var, broadcast_var);
    if ((0 <= raw) & ((raw + 16) <= (sn - inp))) {
      {
        ...
        int4 condval;
        if ((0 <= (inp + raw))) {
          condval = *(int4*)(SW + (((inp + raw) >> 4) * 4));
        } else {
          condval = make_int4(broadcast_var_1, broadcast_var_1, broadcast_var_1, broadcast_var_1);
        }
        *(int4*)(SW_local_cast + 0) = condval;
        uint4 __1;
    ...
    #pragma unroll
    for (int j = 0; j < 4; ++j) {
      S[(((((((((int)threadIdx.x) >> 5) * 512) + (m * 128)) + (((((int)threadIdx.x) & 15) >> 1) * 16)) + (j * 4)) + ((((int)threadIdx.x) & 1) * 2)) + ((((int)threadIdx.x) & 31) >> 4))] = ((int)temp[j]);
    }
  }
  __syncthreads();
  #pragma unroll
  for (int channel = 0; channel < 2; ++channel) {
    ...
    for (int m_1 = 0; m_1 < 2; ++m_1) {
      ...
      for (int n = 0; n < 4; ++n) {
        ...
        uint bits = wide_packet_prmt((*(uint *)(&(v__1))), (*(uint *)(&(v__2))), condval_1);
        int condval_2;
        if (((((channel * 16) + (n * 4)) + (((int)threadIdx.x) & 3)) < wns_7)) {
          condval_2 = FG[(((channel * 16) + (n * 4)) + (((int)threadIdx.x) & 3))];
        } else {
          condval_2 = 0;
        }
        int g = condval_2;
        ...
        for (int pair = 0; pair < 2; ++pair) {
          for (int j_s = 0; j_s < 4; ++j_s) {
            ...
            if ((((((((stream * 2048) + (kp * 1024)) + (slab * 256)) + (pair * 128)) + ((((int)threadIdx.x) & 31) * 4)) + j_s) < wns_0)) {
              condval_3 = WX[((((((stream * 2048) + (kp * 1024)) + (slab * 256)) + (pair * 128)) + ((((int)threadIdx.x) & 31) * 4)) + j_s)];
            } else {
              condval_3 = 0;
            }
            b[j_s] = condval_3;
      ...
      for (int pair_1 = 0; pair_1 < 2; ++pair_1) {
        for (int j_s_1 = 0; j_s_1 < 4; ++j_s_1) {
          ...
          if (((((((stream * 1024) + (slab * 256)) + (pair_1 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + j_s_1) < wns_1)) {
            condval_4 = WR[(((((stream * 1024) + (slab * 256)) + (pair_1 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + j_s_1)];
          } else {
            condval_4 = 0;
          }
          b_1[j_s_1] = condval_4;
    ...
    for (int pair_2 = 0; pair_2 < 4; ++pair_2) {
      for (int j_s_2 = 0; j_s_2 < 4; ++j_s_2) {
        ...
        if ((((((stream * 512) + (pair_2 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + j_s_2) < wns_2)) {
          condval_5 = WT[((((stream * 512) + (pair_2 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + j_s_2)];
        } else {
          condval_5 = 0;
        }
        b_2[j_s_2] = condval_5;
      ...
      for (int pair_3 = 0; pair_3 < 6; ++pair_3) {
        for (int j_s_3 = 0; j_s_3 < 4; ++j_s_3) {
          ...
          if (((((((kp_1 * 1536) + ((((int)threadIdx.x) >> 5) * 768)) + (pair_3 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + j_s_3) < wns_3)) {
            condval_6 = WQ[(((((kp_1 * 1536) + ((((int)threadIdx.x) >> 5) * 768)) + (pair_3 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + j_s_3)];
          } else {
            condval_6 = 0;
          }
          b_3[j_s_3] = condval_6;
      ...
      if (comp == 0) {
        ...
        for (int m_14 = 0; m_14 < 2; ++m_14) {
          ...
          for (int j_1 = 0; j_1 < 2; ++j_1) {
            uint a_3 = Z[(((m_14 * 24) + (comp * 8)) + j_1)];
            uint b_5 = Z[((((m_14 * 24) + (comp * 8)) + j_1) + 2)];
            uint c = Z[((((m_14 * 24) + (comp * 8)) + j_1) + 4)];
            uint d = Z[((((m_14 * 24) + (comp * 8)) + j_1) + 6)];
            ...
            for (int n_7 = 0; n_7 < 4; ++n_7) {
              Z[((((m_14 * 24) + (comp * 8)) + (n_7 * 2)) + j_1)] = wide_mul(Z[((((m_14 * 24) + (comp * 8)) + (n_7 * 2)) + j_1)], inv);
              int v__3 = WS[0];
              uint sraw = (*(uint *)(&(v__3)));
              uint sbits = ((sraw >> ((uint)((((int)threadIdx.x) >> 5) * 16))) & (uint)65535);
              Z[(((m_14 * 24) + (n_7 * 2)) + j_1)] = wide_mul(Z[(((m_14 * 24) + (n_7 * 2)) + j_1)], (((sraw >> ((uint)((((int)threadIdx.x) >> 5) * 16))) & (uint)65535) | (((sraw >> ((uint)((((int)threadIdx.x) >> 5) * 16))) & (uint)65535) << (uint)16)));
            }
          }
          #pragma unroll
        ...
        for (int m_15 = 0; m_15 < 2; ++m_15) {
          if (comp == 1) {
            ...
            for (int j_2 = 0; j_2 < 2; ++j_2) {
              uint a_4 = Z[(((m_15 * 24) + (comp * 8)) + j_2)];
              uint b_6 = Z[((((m_15 * 24) + (comp * 8)) + j_2) + 2)];
              uint c_1 = Z[((((m_15 * 24) + (comp * 8)) + j_2) + 4)];
              uint d_1 = Z[((((m_15 * 24) + (comp * 8)) + j_2) + 6)];
              ...
              for (int n_9 = 0; n_9 < 4; ++n_9) {
                Z[((((m_15 * 24) + (comp * 8)) + (n_9 * 2)) + j_2)] = wide_mul(Z[((((m_15 * 24) + (comp * 8)) + (n_9 * 2)) + j_2)], inv_1);
              }
            }
            #pragma unroll
  ...
  for (int slab_2 = 0; slab_2 < 2; ++slab_2) {
    ...
    for (int m_16 = 0; m_16 < 2; ++m_16) {
      ...
      for (int n_12 = 0; n_12 < 8; ++n_12) {
        ...
        if (((((((((((int)threadIdx.x) >> 5) * 2048) + (slab_2 * 1024)) + (m_16 * 512)) + ((n_12 >> 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + ((n_12 & 1) * 2)) < wns_4)) {
          condval_7 = WB[(((((((((int)threadIdx.x) >> 5) * 2048) + (slab_2 * 1024)) + (m_16 * 512)) + ((n_12 >> 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + ((n_12 & 1) * 2))];
        } else {
          condval_7 = 0;
        }
        int condval_8;
        if ((((((((((((int)threadIdx.x) >> 5) * 2048) + (slab_2 * 1024)) + (m_16 * 512)) + ((n_12 >> 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + ((n_12 & 1) * 2)) + 1) < wns_4)) {
          condval_8 = WB[((((((((((int)threadIdx.x) >> 5) * 2048) + (slab_2 * 1024)) + (m_16 * 512)) + ((n_12 >> 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + ((n_12 & 1) * 2)) + 1)];
        } else {
          condval_8 = 0;
        }
        uint64_t r_4 = wide_mma(Q[((slab_2 * 8) + (m_16 * 4))], Q[(((slab_2 * 8) + (m_16 * 4)) + 1)], Q[(((slab_2 * 8) + (m_16 * 4)) + 2)], Q[(((slab_2 * 8) + (m_16 * 4)) + 3)], K[(n_12 * 2)], K[((n_12 * 2) + 1)], condval_7, condval_8);
      ...
      for (int j_3 = 0; j_3 < 2; ++j_3) {
        uint g0 = wide_add(L[((m_16 * 16) + j_3)], L[(((m_16 * 16) + j_3) + 2)]);
        uint g1 = wide_add(g0, wide_add(L[(((m_16 * 16) + j_3) + 4)], L[(((m_16 * 16) + j_3) + 6)]));
        uint g2 = wide_add(g1, wide_add(L[(((m_16 * 16) + j_3) + 8)], L[(((m_16 * 16) + j_3) + 10)]));
        uint group = wide_add(g2, wide_add(L[(((m_16 * 16) + j_3) + 12)], L[(((m_16 * 16) + j_3) + 14)]));
        ...
        for (int n_13 = 0; n_13 < 8; ++n_13) {
          L[(((m_16 * 16) + (n_13 * 2)) + j_3)] = wide_mul(L[(((m_16 * 16) + (n_13 * 2)) + j_3)], inv_2);
        }
      }
      #pragma unroll
    ...
    for (int word_5 = 0; word_5 < 8; ++word_5) {
      int v__4 = S[((((((((int)threadIdx.x) >> 5) * 512) + (slab_2 * 256)) + ((word_5 >> 2) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + (((word_5 & 3) >> 1) * 2))];
      int v__5 = S[(((((((((int)threadIdx.x) >> 5) * 512) + (slab_2 * 256)) + ((word_5 >> 2) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + (((word_5 & 3) >> 1) * 2)) + 1)];
      int condval_9;
      if (((word_5 % 2) == 0)) {
        condval_9 = 21520;
      } else {
      ...
      Residual[word_5] = wide_packet_prmt((*(uint *)(&(v__4))), (*(uint *)(&(v__5))), condval_9);
    }
    __syncthreads();
    #pragma unroll
    ...
    for (int m_18 = 0; m_18 < 2; ++m_18) {
      ...
      for (int n_16 = 0; n_16 < 4; ++n_16) {
        ...
        if ((((((((int)threadIdx.x) >> 5) * 16) + (n_16 * 4)) + (((int)threadIdx.x) & 3)) < wns_8)) {
          condval_10 = AG[((((((int)threadIdx.x) >> 5) * 16) + (n_16 * 4)) + (((int)threadIdx.x) & 3))];
        } else {
          condval_10 = 0;
        }
        int g_1 = condval_10;
      ...
      for (int pair_4 = 0; pair_4 < 2; ++pair_4) {
        for (int j_s_4 = 0; j_s_4 < 4; ++j_s_4) {
          ...
          if (((((((kp_3 * 512) + ((((int)threadIdx.x) >> 5) * 256)) + (pair_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + j_s_4) < wns_6)) {
            condval_11 = WP[(((((kp_3 * 512) + ((((int)threadIdx.x) >> 5) * 256)) + (pair_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + j_s_4)];
          } else {
            condval_11 = 0;
          }
          b_4[j_s_4] = condval_11;
        }
        #pragma unroll
  ...
  for (int part = 0; part < 4; ++part) {
    ...
    for (int j_4 = 0; j_4 < 4; ++j_4) {
      v_28 = (((((((((((0 | ((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) & 1)) | ((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) >> 1) & 1) << 7)) | ((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) >> 2) & 1) << 2)) | ((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) >> 3) & 1) << 3)) | ((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) >> 4) & 1) << 4)) | ((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) >> 5) & 1) << 5)) | ((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) >> 6) & 1) << 6)) | ((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) >> 7) & 1) << 1)) | ((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) >> 8) & 1) << 8)) | ((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) >> 9) & 1) << 9)) | ((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) >> 10) & 1) << 10));
      v_29 = wide_shfl(QP[(((((((((((((0 | (((part * 512) + (j_4 * 128)) & 1)) | (((((part * 512) + (j_4 * 128)) >> 1) & 1) << 7)) | (((((part * 512) + (j_4 * 128)) >> 2) & 1) << 2)) | (((((part * 512) + (j_4 * 128)) >> 3) & 1) << 3)) | (((((part * 512) + (j_4 * 128)) >> 4) & 1) << 4)) | (((((part * 512) + (j_4 * 128)) >> 5) & 1) << 5)) | (((((part * 512) + (j_4 * 128)) >> 6) & 1) << 6)) | (((((part * 512) + (j_4 * 128)) >> 7) & 1) << 1)) | (((((part * 512) + (j_4 * 128)) >> 8) & 1) << 8)) | (((((part * 512) + (j_4 * 128)) >> 9) & 1) << 9)) | (((((part * 512) + (j_4 * 128)) >> 10) & 1) << 10)) >> 7) | 0)], ((v_28 & 127) >> 2));
      uint condval_12;
      if (((v_28 >> 7) == (((((((((((((0 | (((part * 512) + (j_4 * 128)) & 1)) | (((((part * 512) + (j_4 * 128)) >> 1) & 1) << 7)) | (((((part * 512) + (j_4 * 128)) >> 2) & 1) << 2)) | (((((part * 512) + (j_4 * 128)) >> 3) & 1) << 3)) | (((((part * 512) + (j_4 * 128)) >> 4) & 1) << 4)) | (((((part * 512) + (j_4 * 128)) >> 5) & 1) << 5)) | (((((part * 512) + (j_4 * 128)) >> 6) & 1) << 6)) | (((((part * 512) + (j_4 * 128)) >> 7) & 1) << 1)) | (((((part * 512) + (j_4 * 128)) >> 8) & 1) << 8)) | (((((part * 512) + (j_4 * 128)) >> 9) & 1) << 9)) | (((((part * 512) + (j_4 * 128)) >> 10) & 1) << 10)) >> 7) | 0))) {
        condval_12 = v_29;
      } else {
        condval_12 = (uint)0;
      }
      v_30 = condval_12;
      v_31 = (((((((((((0 | (((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 1) & 1)) | (((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 1) & 1) << 7)) | (((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 2) & 1) << 2)) | (((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 3) & 1) << 3)) | (((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 4) & 1) << 4)) | (((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 5) & 1) << 5)) | (((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 6) & 1) << 6)) | (((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 7) & 1) << 1)) | (((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 8) & 1) << 8)) | (((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 9) & 1) << 9)) | (((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 10) & 1) << 10));
      v_32 = wide_shfl(QP[(((((((((((((0 | ((((part * 512) + (j_4 * 128)) + 1) & 1)) | ((((((part * 512) + (j_4 * 128)) + 1) >> 1) & 1) << 7)) | ((((((part * 512) + (j_4 * 128)) + 1) >> 2) & 1) << 2)) | ((((((part * 512) + (j_4 * 128)) + 1) >> 3) & 1) << 3)) | ((((((part * 512) + (j_4 * 128)) + 1) >> 4) & 1) << 4)) | ((((((part * 512) + (j_4 * 128)) + 1) >> 5) & 1) << 5)) | ((((((part * 512) + (j_4 * 128)) + 1) >> 6) & 1) << 6)) | ((((((part * 512) + (j_4 * 128)) + 1) >> 7) & 1) << 1)) | ((((((part * 512) + (j_4 * 128)) + 1) >> 8) & 1) << 8)) | ((((((part * 512) + (j_4 * 128)) + 1) >> 9) & 1) << 9)) | ((((((part * 512) + (j_4 * 128)) + 1) >> 10) & 1) << 10)) >> 7) | 0)], ((v_31 & 127) >> 2));
      uint condval_13;
      if (((v_31 >> 7) == (((((((((((((0 | ((((part * 512) + (j_4 * 128)) + 1) & 1)) | ((((((part * 512) + (j_4 * 128)) + 1) >> 1) & 1) << 7)) | ((((((part * 512) + (j_4 * 128)) + 1) >> 2) & 1) << 2)) | ((((((part * 512) + (j_4 * 128)) + 1) >> 3) & 1) << 3)) | ((((((part * 512) + (j_4 * 128)) + 1) >> 4) & 1) << 4)) | ((((((part * 512) + (j_4 * 128)) + 1) >> 5) & 1) << 5)) | ((((((part * 512) + (j_4 * 128)) + 1) >> 6) & 1) << 6)) | ((((((part * 512) + (j_4 * 128)) + 1) >> 7) & 1) << 1)) | ((((((part * 512) + (j_4 * 128)) + 1) >> 8) & 1) << 8)) | ((((((part * 512) + (j_4 * 128)) + 1) >> 9) & 1) << 9)) | ((((((part * 512) + (j_4 * 128)) + 1) >> 10) & 1) << 10)) >> 7) | 0))) {
        condval_13 = v_32;
      } else {
        condval_13 = (uint)0;
      }
      v_33 = condval_13;
      v_34 = (((((((((((0 | (((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 2) & 1)) | (((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 1) & 1) << 7)) | (((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 2) & 1) << 2)) | (((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 3) & 1) << 3)) | (((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 4) & 1) << 4)) | (((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 5) & 1) << 5)) | (((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 6) & 1) << 6)) | (((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 7) & 1) << 1)) | (((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 8) & 1) << 8)) | (((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 9) & 1) << 9)) | (((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 10) & 1) << 10));
      v_35 = wide_shfl(QP[(((((((((((((0 | ((((part * 512) + (j_4 * 128)) + 2) & 1)) | ((((((part * 512) + (j_4 * 128)) + 2) >> 1) & 1) << 7)) | ((((((part * 512) + (j_4 * 128)) + 2) >> 2) & 1) << 2)) | ((((((part * 512) + (j_4 * 128)) + 2) >> 3) & 1) << 3)) | ((((((part * 512) + (j_4 * 128)) + 2) >> 4) & 1) << 4)) | ((((((part * 512) + (j_4 * 128)) + 2) >> 5) & 1) << 5)) | ((((((part * 512) + (j_4 * 128)) + 2) >> 6) & 1) << 6)) | ((((((part * 512) + (j_4 * 128)) + 2) >> 7) & 1) << 1)) | ((((((part * 512) + (j_4 * 128)) + 2) >> 8) & 1) << 8)) | ((((((part * 512) + (j_4 * 128)) + 2) >> 9) & 1) << 9)) | ((((((part * 512) + (j_4 * 128)) + 2) >> 10) & 1) << 10)) >> 7) | 0)], ((v_34 & 127) >> 2));
      uint condval_14;
      if (((v_34 >> 7) == (((((((((((((0 | ((((part * 512) + (j_4 * 128)) + 2) & 1)) | ((((((part * 512) + (j_4 * 128)) + 2) >> 1) & 1) << 7)) | ((((((part * 512) + (j_4 * 128)) + 2) >> 2) & 1) << 2)) | ((((((part * 512) + (j_4 * 128)) + 2) >> 3) & 1) << 3)) | ((((((part * 512) + (j_4 * 128)) + 2) >> 4) & 1) << 4)) | ((((((part * 512) + (j_4 * 128)) + 2) >> 5) & 1) << 5)) | ((((((part * 512) + (j_4 * 128)) + 2) >> 6) & 1) << 6)) | ((((((part * 512) + (j_4 * 128)) + 2) >> 7) & 1) << 1)) | ((((((part * 512) + (j_4 * 128)) + 2) >> 8) & 1) << 8)) | ((((((part * 512) + (j_4 * 128)) + 2) >> 9) & 1) << 9)) | ((((((part * 512) + (j_4 * 128)) + 2) >> 10) & 1) << 10)) >> 7) | 0))) {
        condval_14 = v_35;
      } else {
        condval_14 = (uint)0;
      }
      v_36 = condval_14;
      v_37 = (((((((((((0 | (((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 3) & 1)) | (((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 1) & 1) << 7)) | (((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 2) & 1) << 2)) | (((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 3) & 1) << 3)) | (((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 4) & 1) << 4)) | (((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 5) & 1) << 5)) | (((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 6) & 1) << 6)) | (((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 7) & 1) << 1)) | (((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 8) & 1) << 8)) | (((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 9) & 1) << 9)) | (((((((part * 512) + (j_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 10) & 1) << 10));
      v_38 = wide_shfl(QP[(((((((((((((0 | ((((part * 512) + (j_4 * 128)) + 3) & 1)) | ((((((part * 512) + (j_4 * 128)) + 3) >> 1) & 1) << 7)) | ((((((part * 512) + (j_4 * 128)) + 3) >> 2) & 1) << 2)) | ((((((part * 512) + (j_4 * 128)) + 3) >> 3) & 1) << 3)) | ((((((part * 512) + (j_4 * 128)) + 3) >> 4) & 1) << 4)) | ((((((part * 512) + (j_4 * 128)) + 3) >> 5) & 1) << 5)) | ((((((part * 512) + (j_4 * 128)) + 3) >> 6) & 1) << 6)) | ((((((part * 512) + (j_4 * 128)) + 3) >> 7) & 1) << 1)) | ((((((part * 512) + (j_4 * 128)) + 3) >> 8) & 1) << 8)) | ((((((part * 512) + (j_4 * 128)) + 3) >> 9) & 1) << 9)) | ((((((part * 512) + (j_4 * 128)) + 3) >> 10) & 1) << 10)) >> 7) | 0)], ((v_37 & 127) >> 2));
      uint condval_15;
      if (((v_37 >> 7) == (((((((((((((0 | ((((part * 512) + (j_4 * 128)) + 3) & 1)) | ((((((part * 512) + (j_4 * 128)) + 3) >> 1) & 1) << 7)) | ((((((part * 512) + (j_4 * 128)) + 3) >> 2) & 1) << 2)) | ((((((part * 512) + (j_4 * 128)) + 3) >> 3) & 1) << 3)) | ((((((part * 512) + (j_4 * 128)) + 3) >> 4) & 1) << 4)) | ((((((part * 512) + (j_4 * 128)) + 3) >> 5) & 1) << 5)) | ((((((part * 512) + (j_4 * 128)) + 3) >> 6) & 1) << 6)) | ((((((part * 512) + (j_4 * 128)) + 3) >> 7) & 1) << 1)) | ((((((part * 512) + (j_4 * 128)) + 3) >> 8) & 1) << 8)) | ((((((part * 512) + (j_4 * 128)) + 3) >> 9) & 1) << 9)) | ((((((part * 512) + (j_4 * 128)) + 3) >> 10) & 1) << 10)) >> 7) | 0))) {
        condval_15 = v_38;
      } else {
        condval_15 = (uint)0;
      }
      v_39 = condval_15;
      A[((part * 4) + j_4)] = (((((uint)0 | (((v_30 >> ((uint)((v_28 & 3) * 8))) & (uint)255) << (uint)0)) | (((v_33 >> ((uint)((v_31 & 3) * 8))) & (uint)255) << (uint)8)) | (((v_36 >> ((uint)((v_34 & 3) * 8))) & (uint)255) << (uint)16)) | (((v_39 >> ((uint)((v_37 & 3) * 8))) & (uint)255) << (uint)24));
    }
    ...
    int ix = v_40;
    v_41 = ((((((((((ix >> 9) * 16) + (((ix & 3) >> 1) * 8)) + ((ix & 127) >> 4)) & 1) | ((((((ix >> 9) * 16) + (((ix & 3) >> 1) * 8)) + ((ix & 127) >> 4)) & 2) << 3)) | ((((((ix >> 9) * 16) + (((ix & 3) >> 1) * 8)) + ((ix & 127) >> 4)) & 4) >> 1)) | ((((((ix >> 9) * 16) + (((ix & 3) >> 1) * 8)) + ((ix & 127) >> 4)) & 8) >> 1)) | ((((((ix >> 9) * 16) + (((ix & 3) >> 1) * 8)) + ((ix & 127) >> 4)) & 16) << 1)) | ((((((ix >> 9) * 16) + (((ix & 3) >> 1) * 8)) + ((ix & 127) >> 4)) & 32) >> 2));
    v_42 = (((v_41 & 1) | ((v_41 & 14) << 2)) | ((v_41 >> 3) & 6));
    int rmod_2 = (((int)blockIdx.x) % gx);
    int rmod_3 = (((int)blockIdx.x) % gx);
    int rdiv_1 = (((int)blockIdx.x) / gx);
    v_43 = (((((((0 <= gx) && (0 <= rmod_2)) || ((gx < 0) && (rmod_2 <= 0))) ? rmod_2 : (rmod_2 + gx)) * 8) + (((((((0 <= gx) && (0 <= rmod_3)) || ((gx < 0) && (rmod_3 <= 0))) ? rdiv_1 : (rdiv_1 - 1)) * 8) + (v_42 >> 3)) * width)) + (v_42 & 7));
    v_44 = (((v_43 * 16) + ((((((((((((((int)threadIdx.x) >> 5) * 32) + (((ix & 511) >> 7) * 8)) + (((ix & 15) >> 2) * 2)) + (ix & 1)) & 49) | (((((((((int)threadIdx.x) >> 5) * 32) + (((ix & 511) >> 7) * 8)) + (((ix & 15) >> 2) * 2)) + (ix & 1)) & 6) << 1)) | (((((((((int)threadIdx.x) >> 5) * 32) + (((ix & 511) >> 7) * 8)) + (((ix & 15) >> 2) * 2)) + (ix & 1)) & 8) >> 2)) >> 4) * height) * width) * 16)) + (((((((((((int)threadIdx.x) >> 5) * 32) + (((ix & 511) >> 7) * 8)) + (((ix & 15) >> 2) * 2)) + (ix & 1)) & 49) | (((((((((int)threadIdx.x) >> 5) * 32) + (((ix & 511) >> 7) * 8)) + (((ix & 15) >> 2) * 2)) + (ix & 1)) & 6) << 1)) | (((((((((int)threadIdx.x) >> 5) * 32) + (((ix & 511) >> 7) * 8)) + (((ix & 15) >> 2) * 2)) + (ix & 1)) & 8) >> 2)) & 15));
    int rmod_4 = (v_44 % ((height * width) * 16));
    int rdiv_2 = (v_44 / ((height * width) * 16));
    v_45 = ((((0 <= (height * width)) && (0 <= rmod_4)) || (((height * width) < 0) && (rmod_4 <= 0))) ? rdiv_2 : (rdiv_2 - 1));
    int rmod_5 = (v_44 % ((height * width) * 16));
    v_46 = ((((0 <= (height * width)) && (0 <= rmod_5)) || (((height * width) < 0) && (rmod_5 <= 0))) ? rmod_5 : (((height * width) * 16) + rmod_5));
    int rmod_6 = (v_46 % (width * 16));
    int rdiv_3 = (v_46 / (width * 16));
    v_47 = ((((0 <= width) && (0 <= rmod_6)) || ((width < 0) && (rmod_6 <= 0))) ? rdiv_3 : (rdiv_3 - 1));
    int rmod_7 = ((v_46 >> 4) % width);
    v_48 = ((((0 <= width) && (0 <= rmod_7)) || ((width < 0) && (rmod_7 <= 0))) ? rmod_7 : (rmod_7 + width));
    v_49 = (v_46 & 15);
    v_50 = (((((((((v_48 >> 2) * 1024) + (((v_47 >> 2) * (width >> 2)) * 1024)) + (v_49 & 3)) + ((((v_48 & 3) * 4) + (v_49 >> 2)) << 4)) + (((v_47 >> 1) & 1) << 2)) + ((v_45 & 1) << 3)) + ((v_47 & 1) << 8)) + ((v_45 >> 1) << 9));
    int raw_1 = v_50;
