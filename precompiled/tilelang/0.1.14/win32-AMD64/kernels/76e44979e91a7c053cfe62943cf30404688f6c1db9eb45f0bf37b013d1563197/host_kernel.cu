...
extern "C" __global__ void main_kernel(uchar* __restrict__ A, const half_t* __restrict__ G, uint* __restrict__ P, uchar* __restrict__ S, uchar* __restrict__ W);
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(uchar* __restrict__ A, const half_t* __restrict__ G, uint* __restrict__ P, uchar* __restrict__ S, uchar* __restrict__ W) {
  uint c[64];
  uint res[4];
  ...
  if (((int)blockIdx.z) == 0) {
    ...
    for (int r_1 = 0; r_1 < 4; ++r_1) {
      #pragma unroll
      for (int g = 0; g < 2; ++g) {
        nr_tl_vit_joint::global4((&(res[0])), (&(S[((((((((((((int)threadIdx.x) >> 6) * 65536) + (r_1 * 16384)) + ((((((((int)blockIdx.y) * 128) + (((((int)threadIdx.x) & 63) >> 5) * 64)) + (g * 32)) + (((((int)threadIdx.x) & 31) & 3) * 2)) >> 5) * 512)) + ((((((((int)threadIdx.x) >> 6) * 64) + (r_1 * 16)) + ((((int)threadIdx.x) & 31) >> 2)) & 7) * 64)) + (((((((((int)threadIdx.x) >> 6) * 64) + (r_1 * 16)) + ((((int)threadIdx.x) & 31) >> 2)) >> 3) & 1) * 4)) + (((((((int)blockIdx.y) * 128) + (((((int)threadIdx.x) & 63) >> 5) * 64)) + (g * 32)) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 1)) + ((((((((int)blockIdx.y) * 128) + (((((int)threadIdx.x) & 63) >> 5) * 64)) + (g * 32)) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 6) << 3)) + ((((((((int)blockIdx.y) * 128) + (((((int)threadIdx.x) & 63) >> 5) * 64)) + (g * 32)) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 8) >> 2)) + ((((((((int)blockIdx.y) * 128) + (((((int)threadIdx.x) & 63) >> 5) * 64)) + (g * 32)) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 16) >> 1))])));
        #pragma unroll
        for (int j = 0; j < 4; ++j) {
          half_t a = G[((((((((int)blockIdx.y) * 128) + (((((int)threadIdx.x) & 63) >> 5) * 64)) + (g * 32)) + (j * 8)) + (((((int)threadIdx.x) & 31) & 3) * 2)) + 2097152)];
          half_t a_1 = G[((((((((int)blockIdx.y) * 128) + (((((int)threadIdx.x) & 63) >> 5) * 64)) + (g * 32)) + (j * 8)) + (((((int)threadIdx.x) & 31) & 3) * 2)) + 2097153)];
  ...
  for (int h_2 = 0; h_2 < 2; ++h_2) {
    ...
    for (int st = 0; st < 2; ++st) {
      nr_tl_vit_joint::cp((&(sh[((((h_2 * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (st * 512)) + ((((int)threadIdx.x) & 31) * 16))])), (&(A[0])), (((((h_2 * 262144) + ((((int)threadIdx.x) >> 5) * 65536)) + (((int)blockIdx.z) * 16384)) + (st * 512)) + ((((int)threadIdx.x) & 31) * 16)), ((int)(((h_2 * 2) + (((int)threadIdx.x) >> 6)) < 3)));
    }
  }
  #pragma unroll
  for (int j_1 = 0; j_1 < 4; ++j_1) {
    nr_tl_vit_joint::cp((&(sh[(((j_1 * 2048) + (((int)threadIdx.x) * 16)) + 8192)])), (&(W[0])), (((((((int)blockIdx.z) * 1048576) + ((j_1 >> 1) * 32768)) + (((int)blockIdx.y) * 4096)) + ((j_1 & 1) * 2048)) + (((int)threadIdx.x) * 16)), 1);
  }
  ...
  for (int phase = 0; phase < 16; ++phase) {
    ...
    if (phase < 15) {
      ...
      for (int h_3 = 0; h_3 < 2; ++h_3) {
        ...
        for (int st_1 = 0; st_1 < 2; ++st_1) {
          nr_tl_vit_joint::cp((&(sh[(((((((phase + 1) & 1) * 16384) + (h_3 * 4096)) + ((((int)threadIdx.x) >> 5) * 1024)) + (st_1 * 512)) + ((((int)threadIdx.x) & 31) * 16))])), (&(A[0])), (((((((h_3 * 262144) + ((((int)threadIdx.x) >> 5) * 65536)) + (((int)blockIdx.z) * 16384)) + (phase * 1024)) + (st_1 * 512)) + ((((int)threadIdx.x) & 31) * 16)) + 1024), ((int)(((h_3 * 2) + (((int)threadIdx.x) >> 6)) < 3)));
        }
      }
      #pragma unroll
      for (int j_2 = 0; j_2 < 4; ++j_2) {
        nr_tl_vit_joint::cp((&(sh[((((((phase + 1) & 1) * 16384) + (j_2 * 2048)) + (((int)threadIdx.x) * 16)) + 8192)])), (&(W[0])), (((((((((int)blockIdx.z) * 1048576) + (phase * 65536)) + ((j_2 >> 1) * 32768)) + (((int)blockIdx.y) * 4096)) + ((j_2 & 1) * 2048)) + (((int)threadIdx.x) * 16)) + 65536), 1);
      }
      nr_tl_vit_joint::commit();
    }
    #pragma unroll
    for (int st_2 = 0; st_2 < 2; ++st_2) {
      ...
      for (int n_1 = 0; n_1 < 4; ++n_1) {
        nr_tl_vit_joint::shared4((&(bv[(n_1 * 4)])), (&(sh[(((((((phase & 1) * 16384) + (st_2 * 4096)) + (((((int)threadIdx.x) & 63) >> 5) * 2048)) + (n_1 * 512)) + ((((int)threadIdx.x) & 31) * 16)) + 8192)])));
      }
      #pragma unroll
      for (int r_2 = 0; r_2 < 4; ++r_2) {
        nr_tl_vit_joint::shared4((&(av[0])), (&(sh[((((((phase & 1) * 16384) + ((((int)threadIdx.x) >> 6) * 4096)) + (r_2 * 1024)) + (st_2 * 512)) + ((((int)threadIdx.x) & 31) * 16))])));
        #pragma unroll
  ...
  for (int r_3 = 0; r_3 < 4; ++r_3) {
    ...
    for (int n_3 = 0; n_3 < 8; ++n_3) {
      ...
      for (int h_4 = 0; h_4 < 2; ++h_4) {
        if ((((((int)threadIdx.x) >> 6) * 2) + (r_3 >> 1)) < 3) {
          if (((((((((((((((int)threadIdx.x) >> 6) * 64) + (r_3 * 16)) + (h_4 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) / 12) & -2) | (((((((((int)threadIdx.x) >> 6) * 64) + (r_3 * 16)) + (h_4 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) % 12) & 1)) >> 3) + ((((((((((int)threadIdx.x) >> 6) * 64) + (r_3 * 16)) + (h_4 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) % 12) & -2) | (((((((((int)threadIdx.x) >> 6) * 64) + (r_3 * 16)) + (h_4 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) / 12) & 1))) / 12) + ((int)blockIdx.z)) < 4) {
            P[(((((((((int)blockIdx.z) * 49152) + (((((((((((int)threadIdx.x) >> 6) * 64) + (r_3 * 16)) + (h_4 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) % 12) & -2) | (((((((((int)threadIdx.x) >> 6) * 64) + (r_3 * 16)) + (h_4 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) / 12) & 1)) * 4096)) + (((((((((((int)threadIdx.x) >> 6) * 64) + (r_3 * 16)) + (h_4 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) / 12) & -2) | (((((((((int)threadIdx.x) >> 6) * 64) + (r_3 * 16)) + (h_4 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) % 12) & 1)) * 512)) + (((int)blockIdx.y) * 64)) + (((((int)threadIdx.x) & 63) >> 5) * 32)) + (n_3 * 4)) + ((((int)threadIdx.x) & 31) & 3))] = c[(((r_3 * 16) + (n_3 * 2)) + h_4)];
          }
        }
      }
    }
