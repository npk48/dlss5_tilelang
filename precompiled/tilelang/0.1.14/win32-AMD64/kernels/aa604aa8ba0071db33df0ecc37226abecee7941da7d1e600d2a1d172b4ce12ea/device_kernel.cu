...
extern "C" __global__ void __launch_bounds__(128, 1) kernel_kernel(const int* __restrict__ AG, const int* __restrict__ FG, int* __restrict__ RW, const int* __restrict__ SW, const int* __restrict__ WB, const int* __restrict__ WP, const int* __restrict__ WQ, const int* __restrict__ WR, const int* __restrict__ WS, const int* __restrict__ WT, const int* __restrict__ WX) {
  ...
  for (int slab = 0; slab < 2; ++slab) {
    ...
    for (int parity = 0; parity < 2; ++parity) {
      ...
      *(uint4*)(temp + 0) = make_uint4(broadcast_var, broadcast_var, broadcast_var, broadcast_var);
      if ((0 <= raw) & (raw <= 17268112)) {
        {
          int SW_local_cast[4];
          *(int4*)(SW_local_cast + 0) = *(int4*)(SW + (((raw >> 4) * 4) + 10772480));
          uint4 __1;
  ...
  for (int slab_2 = 0; slab_2 < 2; ++slab_2) {
    ...
    for (int part = 0; part < 2; ++part) {
      int condval_11;
      if (((((bool)1 & (bool)1) & (1 <= (((((int)blockIdx.x) / 10) * 2) + (((((((slab_2 * 32) + (((((int)threadIdx.x) & 31) & 1) * 16)) + ((((((int)threadIdx.x) & 31) >> 1) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) >> 1)))) & ((((((int)blockIdx.x) / 10) * 2) + (((((((slab_2 * 32) + (((((int)threadIdx.x) & 31) & 1) * 16)) + ((((((int)threadIdx.x) & 31) >> 1) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) >> 1)) < 17))) {
        condval_11 = ((((((((((((int)threadIdx.x) >> 5) * 163840) + (part * 81920)) + ((((int)blockIdx.x) / 10) * 10240)) + (((((((slab_2 * 32) + (((((int)threadIdx.x) & 31) & 1) * 16)) + ((((((int)threadIdx.x) & 31) >> 1) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2560)) + ((((((slab_2 * 32) + (((((int)threadIdx.x) & 31) & 1) * 16)) + ((((((int)threadIdx.x) & 31) >> 1) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1) * 1280)) + ((((int)blockIdx.x) % 10) * 128)) + (((((((slab_2 * 32) + (((((int)threadIdx.x) & 31) & 1) * 16)) + ((((((int)threadIdx.x) & 31) >> 1) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7) * 16)) + ((((((((int)threadIdx.x) >> 5) * 32) + (part * 16)) & 1) | (((((((int)threadIdx.x) >> 5) * 32) + (part * 16)) & 6) << 1)) | (((((((int)threadIdx.x) >> 5) * 32) + (part * 16)) & 8) >> 2))) - 5120);
      } else {
        condval_11 = -1;
      }
      v_48 = condval_11;
      int raw_1 = v_48;
      if ((0 <= raw_1) & (raw_1 <= 16612752)) {
        {
          ...
          *(int4*)(RW + (((raw_1 >> 4) * 4) + 10936320)) = *(int4*)(RW_local_cast_1 + 0);
        }
      }
    }
    __syncthreads();
