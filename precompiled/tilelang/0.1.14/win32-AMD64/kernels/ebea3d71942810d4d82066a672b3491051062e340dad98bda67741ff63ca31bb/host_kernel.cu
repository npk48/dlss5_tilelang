...
extern "C" __global__ void main_kernel(const uchar* __restrict__ A, int* __restrict__ C0, int* __restrict__ C1, uchar* __restrict__ PoolRaw, uchar* __restrict__ Raw, const uchar* __restrict__ Skip, const uchar* __restrict__ Weight, int H, int W, int n0, int n1, int sizes_3, int sizes_7, int v0, int v1);
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(const uchar* __restrict__ A, int* __restrict__ C0, int* __restrict__ C1, uchar* __restrict__ PoolRaw, uchar* __restrict__ Raw, const uchar* __restrict__ Skip, const uchar* __restrict__ Weight, int H, int W, int n0, int n1, int sizes_3, int sizes_7, int v0, int v1) {
  ...
  for (int t_1 = 0; t_1 < 4; ++t_1) {
    if ((((((int)blockIdx.y) * 2) + (t_1 >> 1)) < (W >> 2)) && (((sx * 2) + (t_1 & 1)) < (H >> 2))) {
      for (int z_2 = 0; z_2 < 8; ++z_2) {
        int i_5 = max((((((((sx * 16384) + (((H >> 2) * ((((int)blockIdx.y) * 2) + (t_1 >> 1))) * 8192)) + ((t_1 & 1) * 8192)) + (g * 1024)) + ((z_2 >> 2) * 512)) + ((((int)threadIdx.x) & 31) * 16)) + ((z_2 & 3) * 4)), (((((((sx * 16384) + (((H >> 2) * ((((int)blockIdx.y) * 2) + (t_1 >> 1))) * 8192)) + ((t_1 & 1) * 8192)) + (g * 1024)) + ((z_2 >> 2) * 512)) + ((((int)threadIdx.x) & 31) * 16)) + ((z_2 & 3) * 4)));
  ...
  for (int z_3 = 0; z_3 < 8; ++z_3) {
    int i_6 = max((((((((((H + 7) >> 3) * ((int)blockIdx.y)) * 8192) + (sx * 8192)) + (g * 1024)) + ((z_3 >> 2) * 512)) + ((((int)threadIdx.x) & 31) * 16)) + ((z_3 & 3) * 4)), (((((((((H + 7) >> 3) * ((int)blockIdx.y)) * 8192) + (sx * 8192)) + (g * 1024)) + ((z_3 >> 2) * 512)) + ((((int)threadIdx.x) & 31) * 16)) + ((z_3 & 3) * 4)));
    uint v_2 = nr_ld32((&(((uchar*)packed)[(((((((int)threadIdx.x) >> 5) * 4096) + ((z_3 >> 2) * 512)) + ((((int)threadIdx.x) & 31) * 16)) + ((z_3 & 3) * 4))])));
    if (0 <= i_6) {
      if (i_6 < sizes_7) {
        nr_st32((&(PoolRaw[((int64_t)i_6)])), v_2);
      }
    }
  }
  bool first_block = ((((int)blockIdx.x) == 0) && (((int)blockIdx.y) == 0));
  if ((((int)blockIdx.x) == 0) && (((int)blockIdx.y) == 0)) {
    for (int j_1 = 0; j_1 < ((n0 + 127) >> 7); ++j_1) {
      if (((j_1 * 128) + ((int)threadIdx.x)) < n0) {
        C0[((((int64_t)j_1) * (int64_t)128) + ((int64_t)((int)threadIdx.x)))] = v0;
      }
    }
    for (int j_2 = 0; j_2 < ((n1 + 127) >> 7); ++j_2) {
      if (((j_2 * 128) + ((int)threadIdx.x)) < n1) {
        C1[((((int64_t)j_2) * (int64_t)128) + ((int64_t)((int)threadIdx.x)))] = v1;
      }
    }
  }
}
