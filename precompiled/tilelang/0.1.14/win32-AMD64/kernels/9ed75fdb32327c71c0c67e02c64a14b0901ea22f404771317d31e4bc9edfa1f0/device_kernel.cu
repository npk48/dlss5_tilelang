    ...
    for (int m_12 = 0; m_12 < 2; ++m_12) {
      ...
      if (0 <= condval_40) {
        ...
        if (condval_69 < 8093088) {
          ...
          nr_tl_shallow_joint::st128((&(X[(condval_127 + 52264960)])), (nr_tl_shallow::e4pair(out[(m_12 * 8)]) | (nr_tl_shallow::e4pair(out[((m_12 * 8) + 2)]) << (uint)16)), (nr_tl_shallow::e4pair(out[((m_12 * 8) + 1)]) | (nr_tl_shallow::e4pair(out[((m_12 * 8) + 3)]) << (uint)16)), (nr_tl_shallow::e4pair(out[((m_12 * 8) + 4)]) | (nr_tl_shallow::e4pair(out[((m_12 * 8) + 6)]) << (uint)16)), (nr_tl_shallow::e4pair(out[((m_12 * 8) + 5)]) | (nr_tl_shallow::e4pair(out[((m_12 * 8) + 7)]) << (uint)16)));
        }
      }
    }
  }
  if (((int)threadIdx.x) == 0) {
    nr_tl_shallow_joint::st32((&(X[((((int)blockIdx.x) * 4) + 60341760)])), (uint)0);
  }
}
