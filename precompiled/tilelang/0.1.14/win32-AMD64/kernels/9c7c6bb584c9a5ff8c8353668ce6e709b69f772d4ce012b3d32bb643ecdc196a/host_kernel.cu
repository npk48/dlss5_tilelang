...
extern "C" __global__ void __launch_bounds__(128, 1) kernel_kernel(const int* __restrict__ AG, const int* __restrict__ FG, int* __restrict__ RW, const int* __restrict__ SW, const int* __restrict__ WB, const int* __restrict__ WP, const int* __restrict__ WQ, const int* __restrict__ WR, const int* __restrict__ WS, const int* __restrict__ WT, const int* __restrict__ WX, int counter, int gx, int height, int inp, int out, int rn, int sn, int sx, int sy, int tiles, int width, int wns_0, int wns_1, int wns_2, int wns_3, int wns_4, int wns_5, int wns_6, int wns_7, int wns_8) {
  ...
  for (int m = 0; m < 4; ++m) {
    ...
    for (int word = 0; word < 4; ++word) {
      ...
      if (((((0 <= (((((((0 <= gx) && (0 <= rmod)) || ((gx < 0) && (rmod <= 0))) ? rmod : (rmod + gx)) * 8) + (((((m * 16) + ((word & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7)) + sx)) & ((((((((0 <= gx) && (0 <= rmod_1)) || ((gx < 0) && (rmod_1 <= 0))) ? rmod_1 : (rmod_1 + gx)) * 8) + (((((m * 16) + ((word & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7)) + sx) < width)) & (0 <= ((((((((0 <= gx) && (0 <= rmod_2)) || ((gx < 0) && (rmod_2 <= 0))) ? rdiv : (rdiv - 1)) * 8) + ((((((m * 16) + ((word & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((m * 16) + ((word & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) + sy))) & (((((((((0 <= gx) && (0 <= rmod_3)) || ((gx < 0) && (rmod_3 <= 0))) ? rdiv_1 : (rdiv_1 - 1)) * 8) + ((((((m * 16) + ((word & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((m * 16) + ((word & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) + sy) < height))) {
        ...
        condval = ((((((((((0 <= gx) && (0 <= rmod_4)) || ((gx < 0) && (rmod_4 <= 0))) ? rmod_4 : (rmod_4 + gx)) * 128) + ((((((((((0 <= gx) && (0 <= rmod_5)) || ((gx < 0) && (rmod_5 <= 0))) ? rdiv_2 : (rdiv_2 - 1)) * 8) + ((((((m * 16) + ((word & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((m * 16) + ((word & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) + sy) * width) * 16)) + ((((((m * 16) + ((word & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7) * 16)) + (sx * 16)) + ((((((((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) & -15) | ((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) & 2) << 2)) | ((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) & 4) >> 1)) | ((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) & 8) >> 1)) >> 4) * height) * width) * 16)) + (((((((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) & -15) | ((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) & 2) << 2)) | ((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) & 4) >> 1)) | ((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) & 8) >> 1)) & 1) | ((((((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) & -15) | ((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) & 2) << 2)) | ((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) & 4) >> 1)) | ((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) & 8) >> 1)) & 6) << 1)) | ((((((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) & -15) | ((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) & 2) << 2)) | ((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) & 4) >> 1)) | ((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) & 8) >> 1)) & 8) >> 2)));
      } else {
        condval = -1;
      }
      v = condval;
      int raw = v;
      S[(((((((int)threadIdx.x) >> 5) * 512) + (m * 128)) + ((((int)threadIdx.x) & 31) * 4)) + word)] = 0;
      __syncthreads();
      if (0 <= raw) {
        int condval_1;
        if (((0 <= (inp + raw)) && (((inp + raw) >> 2) < (sn >> 2)))) {
          condval_1 = SW[((inp + raw) >> 2)];
        } else {
          condval_1 = 0;
        }
        S[(((((((int)threadIdx.x) >> 5) * 512) + (m * 128)) + ((((int)threadIdx.x) & 31) * 4)) + word)] = condval_1;
      }
    }
  }
  __syncthreads();
  ...
  for (int word_1 = 0; word_1 < 16; ++word_1) {
    int v_ = S[(((((((int)threadIdx.x) >> 5) * 512) + ((word_1 >> 2) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + (((word_1 & 3) >> 1) * 2))];
    int v__1 = S[((((((((int)threadIdx.x) >> 5) * 512) + ((word_1 >> 2) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + (((word_1 & 3) >> 1) * 2)) + 1)];
    int condval_2;
    if (((word_1 % 2) == 0)) {
      condval_2 = 21520;
    } else {
    ...
    Residual[word_1] = wide_packet_prmt((*(uint *)(&(v_))), (*(uint *)(&(v__1))), condval_2);
  }
  #pragma unroll
      ...
      for (int pair = 0; pair < 2; ++pair) {
        for (int j_s = 0; j_s < 4; ++j_s) {
          ...
          if (((((((((((int)threadIdx.x) >> 5) * 4096) + (kp * 1024)) + (slab * 256)) + (pair * 128)) + ((((int)threadIdx.x) & 31) * 4)) + j_s) < wns_0)) {
            condval_3 = WX[(((((((((int)threadIdx.x) >> 5) * 4096) + (kp * 1024)) + (slab * 256)) + (pair * 128)) + ((((int)threadIdx.x) & 31) * 4)) + j_s)];
          } else {
            condval_3 = 0;
          }
          b[j_s] = condval_3;
      ...
      *(int4*)(a_1 + 0) = *(int4*)(S + (((m_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1536));
      ...
      for (int pair_1 = 0; pair_1 < 2; ++pair_1) {
        for (int j_s_1 = 0; j_s_1 < 4; ++j_s_1) {
          ...
          if (((((((((((int)threadIdx.x) >> 5) * 4096) + (slab * 256)) + (pair_1 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + j_s_1) + 3072) < wns_0)) {
            condval_4 = WX[(((((((((int)threadIdx.x) >> 5) * 4096) + (slab * 256)) + (pair_1 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + j_s_1) + 3072)];
          } else {
            condval_4 = 0;
          }
          b_1[j_s_1] = condval_4;
      ...
      for (int n_3 = 0; n_3 < 4; ++n_3) {
        ...
        if (((((((((((int)threadIdx.x) >> 5) * 1024) + (slab * 256)) + ((n_3 >> 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + ((n_3 & 1) * 2)) + 16384) < wns_1)) {
          condval_5 = WR[(((((((((int)threadIdx.x) >> 5) * 1024) + (slab * 256)) + ((n_3 >> 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + ((n_3 & 1) * 2)) + 16384)];
        } else {
          condval_5 = 0;
        }
        int condval_6;
        if (((((((((((int)threadIdx.x) >> 5) * 1024) + (slab * 256)) + ((n_3 >> 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + ((n_3 & 1) * 2)) + 16385) < wns_1)) {
          condval_6 = WR[(((((((((int)threadIdx.x) >> 5) * 1024) + (slab * 256)) + ((n_3 >> 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + ((n_3 & 1) * 2)) + 16385)];
        } else {
          condval_6 = 0;
        }
        uint64_t r_2 = wide_mma(A[0], A[1], A[2], A[3], condval_5, condval_6, C[((m_5 * 8) + (n_3 * 2))], C[(((m_5 * 8) + (n_3 * 2)) + 1)]);
  ...
  for (int word_3 = 0; word_3 < 16; ++word_3) {
    ...
    S[(((((((int)threadIdx.x) >> 5) * 512) + ((word_3 >> 2) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + (word_3 & 3))] = (*(int *)(&(_reinterpret_tmp)));
  }
  __syncthreads();
  #pragma unroll
  ...
  for (int word_4 = 0; word_4 < 16; ++word_4) {
    ...
    S[(((((((int)threadIdx.x) >> 5) * 512) + ((word_4 >> 2) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + (word_4 & 3))] = (*(int *)(&(_reinterpret_tmp_1)));
  }
  __syncthreads();
  #pragma unroll
      ...
      if (comp == 0) {
        ...
        for (int j = 0; j < 2; ++j) {
          ...
          for (int n_8 = 0; n_8 < 4; ++n_8) {
            ...
            Z[(((dest * 24) + (n_8 * 2)) + j)] = wide_mul(Z[(((dest * 24) + (n_8 * 2)) + j)], wide_splat((*(float *)(&(_reinterpret_tmp_2)))));
          }
        }
        #pragma unroll
        ...
        if (comp == 1) {
          ...
          for (int j_1 = 0; j_1 < 2; ++j_1) {
            ...
            uint b_7 = Z[((((dest * 24) + (comp * 8)) + j_1) + 2)];
  ...
  for (int slab_1 = 0; slab_1 < 2; ++slab_1) {
    ...
    for (int m_14 = 0; m_14 < 2; ++m_14) {
      ...
      for (int n_13 = 0; n_13 < 8; ++n_13) {
        int condval_12;
        if (((((((((((((int)threadIdx.x) >> 5) * 2048) + (slab_1 * 1024)) + (m_14 * 512)) + ((n_13 >> 2) * 256)) + ((n_13 & 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + (((n_13 & 3) >> 1) * 2)) + 36936) < wns_4)) {
          condval_12 = WB[(((((((((((int)threadIdx.x) >> 5) * 2048) + (slab_1 * 1024)) + (m_14 * 512)) + ((n_13 >> 2) * 256)) + ((n_13 & 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + (((n_13 & 3) >> 1) * 2)) + 36936)];
        } else {
          condval_12 = 0;
        }
        int condval_13;
        if (((((((((((((int)threadIdx.x) >> 5) * 2048) + (slab_1 * 1024)) + (m_14 * 512)) + ((n_13 >> 2) * 256)) + ((n_13 & 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + (((n_13 & 3) >> 1) * 2)) + 36937) < wns_4)) {
          condval_13 = WB[(((((((((((int)threadIdx.x) >> 5) * 2048) + (slab_1 * 1024)) + (m_14 * 512)) + ((n_13 >> 2) * 256)) + ((n_13 & 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + (((n_13 & 3) >> 1) * 2)) + 36937)];
        } else {
          condval_13 = 0;
        }
        uint64_t r_6 = wide_mma(Q[((slab_1 * 8) + (m_14 * 4))], Q[(((slab_1 * 8) + (m_14 * 4)) + 1)], Q[(((slab_1 * 8) + (m_14 * 4)) + 2)], Q[(((slab_1 * 8) + (m_14 * 4)) + 3)], K[(n_13 * 2)], K[((n_13 * 2) + 1)], condval_12, condval_13);
    ...
    for (int word_7 = 0; word_7 < 8; ++word_7) {
      int v__2 = S[((((((((int)threadIdx.x) >> 5) * 512) + (slab_1 * 256)) + ((word_7 >> 2) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + (((word_7 & 3) >> 1) * 2))];
      int v__3 = S[(((((((((int)threadIdx.x) >> 5) * 512) + (slab_1 * 256)) + ((word_7 >> 2) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + (((word_7 & 3) >> 1) * 2)) + 1)];
      int condval_14;
      if (((word_7 % 2) == 0)) {
        condval_14 = 21520;
      } else {
      ...
      Residual[word_7] = wide_packet_prmt((*(uint *)(&(v__2))), (*(uint *)(&(v__3))), condval_14);
    }
    __syncthreads();
    #pragma unroll
    for (int word_8 = 0; word_8 < 8; ++word_8) {
      ...
      S[((((((((int)threadIdx.x) >> 5) * 512) + (slab_1 * 256)) + ((word_8 >> 2) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + (word_8 & 3))] = (*(int *)(&(_reinterpret_tmp_3)));
    }
    __syncthreads();
    #pragma unroll
    ...
    for (int parity = 0; parity < 2; ++parity) {
      ...
      int condval_17;
      if (((((0 <= (((((((0 <= gx) && (0 <= rmod_6)) || ((gx < 0) && (rmod_6 <= 0))) ? rmod_6 : (rmod_6 + gx)) * 8) + (((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7)) + sx)) & ((((((((0 <= gx) && (0 <= rmod_7)) || ((gx < 0) && (rmod_7 <= 0))) ? rmod_7 : (rmod_7 + gx)) * 8) + (((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7)) + sx) < width)) & (0 <= ((((((((0 <= gx) && (0 <= rmod_8)) || ((gx < 0) && (rmod_8 <= 0))) ? rdiv_3 : (rdiv_3 - 1)) * 8) + ((((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) + sy))) & (((((((((0 <= gx) && (0 <= rmod_9)) || ((gx < 0) && (rmod_9 <= 0))) ? rdiv_4 : (rdiv_4 - 1)) * 8) + ((((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) + sy) < height))) {
        ...
        condval_17 = ((((((((((0 <= gx) && (0 <= rmod_10)) || ((gx < 0) && (rmod_10 <= 0))) ? rmod_10 : (rmod_10 + gx)) * 4096) + ((((((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7) + sx) >> 2) * 2048)) + (((width >> 2) * ((((((0 <= gx) && (0 <= rmod_11)) || ((gx < 0) && (rmod_11 <= 0))) ? rdiv_5 : (rdiv_5 - 1)) * 2) + ((((((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1) + sy) >> 1) + (((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3)) >> 1))) * 2048)) + ((((((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 2)) & 1) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 2)) & 6) << 3)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 2)) & 8) >> 2)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 2)) & 16) >> 1)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 2)) & 224) << 4))) + ((((((((((((((0 <= gx) && (0 <= rmod_12)) || ((gx < 0) && (rmod_12 <= 0))) ? rdiv_6 : (rdiv_6 - 1)) * 8) + ((((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) + sy) >> 1) & 1) | (((((((((0 <= gx) && (0 <= rmod_13)) || ((gx < 0) && (rmod_13 <= 0))) ? rmod_13 : (rmod_13 + gx)) * 8) + (((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7)) + sx) & 3) << 1)) | ((((((((((0 <= gx) && (0 <= rmod_14)) || ((gx < 0) && (rmod_14 <= 0))) ? rdiv_7 : (rdiv_7 - 1)) * 8) + ((((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) + sy) & 1) << 3)) & 1) << 2)) + ((((((((((((((0 <= gx) && (0 <= rmod_15)) || ((gx < 0) && (rmod_15 <= 0))) ? rdiv_8 : (rdiv_8 - 1)) * 8) + ((((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) + sy) >> 1) & 1) | (((((((((0 <= gx) && (0 <= rmod_16)) || ((gx < 0) && (rmod_16 <= 0))) ? rmod_16 : (rmod_16 + gx)) * 8) + (((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7)) + sx) & 3) << 1)) | ((((((((((0 <= gx) && (0 <= rmod_17)) || ((gx < 0) && (rmod_17 <= 0))) ? rdiv_9 : (rdiv_9 - 1)) * 8) + ((((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab_1 * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) + sy) & 1) << 3)) & 14) << 5));
      } else {
        condval_17 = -1;
      }
      v_28 = condval_17;
      ...
      for (int j_3 = 0; j_3 < 4; ++j_3) {
        ...
        temp[j_3] = wide_packet_prmt(P[(((j_3 & 1) * 4) + ((j_3 >> 1) * 2))], P[((((j_3 & 1) * 4) + ((j_3 >> 1) * 2)) + 1)], condval_18);
      }
      if ((0 <= raw_1) & ((raw_1 + 16) <= (rn - out))) {
        {
          int RW_local_cast[4];
          int4 __1;
          uint4 v__4 = *(uint4*)(temp + 0);
          __1.x = (int)(v__4.x);
          __1.y = (int)(v__4.y);
          __1.z = (int)(v__4.z);
          __1.w = (int)(v__4.w);
