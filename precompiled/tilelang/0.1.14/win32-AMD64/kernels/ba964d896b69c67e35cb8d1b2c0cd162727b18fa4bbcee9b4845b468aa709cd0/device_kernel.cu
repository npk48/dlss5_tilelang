...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(uchar* __restrict__ A, int* __restrict__ C0, int* __restrict__ C1, const half_t* __restrict__ G, uint* __restrict__ P, uchar* __restrict__ S, uchar* __restrict__ W, int PH, int PW, int n0, int n1, int rows, int sizes_2, int sizes_3, int sizes_8, int v0, int v1) {
  ...
  if (((int)blockIdx.z) == 0) {
    ...
    for (int r_1 = 0; r_1 < 4; ++r_1) {
      ...
      for (int g = 0; g < 2; ++g) {
        ...
        for (int j = 0; j < 4; ++j) {
          half_t condval;
          if ((((((((((int)blockIdx.y) * 128) + (((((int)threadIdx.x) & 63) >> 5) * 64)) + (g * 32)) + (j * 8)) + (((((int)threadIdx.x) & 31) & 3) * 2)) + 2097152) < sizes_8)) {
            condval = G[((((((((int)blockIdx.y) * 128) + (((((int)threadIdx.x) & 63) >> 5) * 64)) + (g * 32)) + (j * 8)) + (((((int)threadIdx.x) & 31) & 3) * 2)) + 2097152)];
          } else {
            condval = half_t(0x0p+0f/*0.000000e+00*/);
          }
          half_t a = condval;
          half_t condval_1;
          if ((((((((((int)blockIdx.y) * 128) + (((((int)threadIdx.x) & 63) >> 5) * 64)) + (g * 32)) + (j * 8)) + (((((int)threadIdx.x) & 31) & 3) * 2)) + 2097153) < sizes_8)) {
            condval_1 = G[((((((((int)blockIdx.y) * 128) + (((((int)threadIdx.x) & 63) >> 5) * 64)) + (g * 32)) + (j * 8)) + (((((int)threadIdx.x) & 31) & 3) * 2)) + 2097153)];
          } else {
  ...
  for (int h_2 = 0; h_2 < 2; ++h_2) {
    ...
    for (int st = 0; st < 2; ++st) {
      nr_tl_vit_joint::cp((&(sh[((((h_2 * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (st * 512)) + ((((int)threadIdx.x) & 31) * 16))])), (&(A[0])), ((((((((int)blockIdx.x) * 524288) + (h_2 * 262144)) + ((((int)threadIdx.x) >> 5) * 65536)) + (((int)blockIdx.z) * 16384)) + (st * 512)) + ((((int)threadIdx.x) & 31) * 16)), ((int)((((((int)blockIdx.x) * 128) + (h_2 * 64)) + ((((int)threadIdx.x) >> 5) * 16)) < rows)));
    }
  }
  #pragma unroll
    ...
    if (phase < 15) {
      ...
      for (int h_3 = 0; h_3 < 2; ++h_3) {
        ...
        for (int st_1 = 0; st_1 < 2; ++st_1) {
          nr_tl_vit_joint::cp((&(sh[(((((((phase + 1) & 1) * 16384) + (h_3 * 4096)) + ((((int)threadIdx.x) >> 5) * 1024)) + (st_1 * 512)) + ((((int)threadIdx.x) & 31) * 16))])), (&(A[0])), ((((((((((int)blockIdx.x) * 524288) + (h_3 * 262144)) + ((((int)threadIdx.x) >> 5) * 65536)) + (((int)blockIdx.z) * 16384)) + (phase * 1024)) + (st_1 * 512)) + ((((int)threadIdx.x) & 31) * 16)) + 1024), ((int)((((((int)blockIdx.x) * 128) + (h_3 * 64)) + ((((int)threadIdx.x) >> 5) * 16)) < rows)));
        }
      }
      #pragma unroll
