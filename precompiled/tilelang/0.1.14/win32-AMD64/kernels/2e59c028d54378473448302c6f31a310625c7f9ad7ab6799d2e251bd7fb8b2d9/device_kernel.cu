  ...
  for (int group_1 = 0; group_1 < 2; ++group_1) {
    for (int n_19 = 0; n_19 < 4; ++n_19) {
      ...
      for (int kp_4 = 0; kp_4 < 2; ++kp_4) {
        ...
        for (int word_8 = 0; word_8 < 4; ++word_8) {
          ...
          for (int b_7 = 0; b_7 < 4; ++b_7) {
            ...
            for (int t = 0; t < 4; ++t) {
              int condval_18;
              if ((((((((((((int)blockIdx.x) * 4096) + ((word_8 & 1) * 2048)) + (((((int)threadIdx.x) & 31) >> 2) * 256)) + (t * 64)) + (kp_4 * 32)) + ((word_8 >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) + b_7) < pin)) {
                condval_18 = PI[((((((((((int64_t)((int)blockIdx.x)) * (int64_t)4096) + ((((int64_t)word_8) & (int64_t)1) * (int64_t)2048)) + (((((int64_t)((int)threadIdx.x)) & (int64_t)31) >> (int64_t)2) * (int64_t)256)) + (((int64_t)t) * (int64_t)64)) + (((int64_t)kp_4) * (int64_t)32)) + ((((int64_t)word_8) >> (int64_t)1) * (int64_t)16)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)3) * (int64_t)4)) + ((int64_t)b_7))];
              } else {
                condval_18 = 0;
              }
              int ix_1 = condval_18;
        ...
        int condval_19;
        if ((((((((kp_4 * 1024) + (group_1 * 512)) + ((((int)threadIdx.x) >> 5) * 256)) + ((n_19 >> 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + ((n_19 & 1) * 2)) < mn)) {
          condval_19 = Matrix[((((((kp_4 * 1024) + (group_1 * 512)) + ((((int)threadIdx.x) >> 5) * 256)) + ((n_19 >> 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + ((n_19 & 1) * 2))];
        } else {
          condval_19 = 0;
        }
        int condval_20;
        if (((((((((kp_4 * 1024) + (group_1 * 512)) + ((((int)threadIdx.x) >> 5) * 256)) + ((n_19 >> 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + ((n_19 & 1) * 2)) + 1) < mn)) {
          condval_20 = Matrix[(((((((kp_4 * 1024) + (group_1 * 512)) + ((((int)threadIdx.x) >> 5) * 256)) + ((n_19 >> 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + ((n_19 & 1) * 2)) + 1)];
        } else {
          condval_20 = 0;
        }
        uint64_t r_7 = wide_mma(temp[0], temp[1], temp[2], temp[3], condval_19, condval_20, acc[0], acc[1]);
        acc[0] = ((uint)r_7);
      ...
      for (int b_8 = 0; b_8 < 4; ++b_8) {
        int condval_21;
        if ((((((((((((int)blockIdx.x) * 2048) + ((b_8 >> 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + (group_1 * 64)) + ((((int)threadIdx.x) >> 5) * 32)) + (n_19 * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (b_8 & 1)) < pon)) {
          condval_21 = PO[((((((((((int64_t)((int)blockIdx.x)) * (int64_t)2048) + ((((int64_t)b_8) >> (int64_t)1) * (int64_t)1024)) + (((((int64_t)((int)threadIdx.x)) & (int64_t)31) >> (int64_t)2) * (int64_t)128)) + (((int64_t)group_1) * (int64_t)64)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)5) * (int64_t)32)) + (((int64_t)n_19) * (int64_t)8)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)3) * (int64_t)2)) + (((int64_t)b_8) & (int64_t)1))];
        } else {
          condval_21 = 0;
        }
        int dest = condval_21;
        if (0 <= dest) {
          if (0 <= (poolout + dest)) {
            if ((poolout + dest) < rn) {
              R[(((int64_t)poolout) + ((int64_t)dest))] = ((uchar)(encoded >> ((uint)(b_8 * 8))));
            }
          }
        }
      }
