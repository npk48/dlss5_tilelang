...
extern "C" __global__ void main_kernel(const uchar* __restrict__ A, int* __restrict__ C0, int* __restrict__ C1, const int* __restrict__ Members, const int* __restrict__ Plan, uchar* __restrict__ Raw, const float* __restrict__ Scale, const uchar* __restrict__ Weight, int gx, int gy, int gz, int n0, int n1, int sizes_1, int sizes_2, int sizes_3, int sizes_4, int v0, int v1);
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(const uchar* __restrict__ A, int* __restrict__ C0, int* __restrict__ C1, const int* __restrict__ Members, const int* __restrict__ Plan, uchar* __restrict__ Raw, const float* __restrict__ Scale, const uchar* __restrict__ Weight, int gx, int gy, int gz, int n0, int n1, int sizes_1, int sizes_2, int sizes_3, int sizes_4, int v0, int v1) {
  ...
  uint s = (uint)0;
  uint total = (uint)0;
  int group = max(((((int)blockIdx.y) * gx) + ((int)blockIdx.x)), ((((int)blockIdx.y) * gx) + ((int)blockIdx.x)));
  for (int r = 0; r < 4; ++r) {
    for (int n = 0; n < 12; ++n) {
      for (int h = 0; h < 2; ++h) {
        c[(((r * 24) + (n * 2)) + h)] = (uint)0;
  ...
  for (int p = 0; p < 8; ++p) {
    for (int u = 0; u < 2; ++u) {
      int condval;
      if (((0 <= group) && (((((group * 2048) + (p * 256)) + (u * 128)) + ((int)threadIdx.x)) < sizes_1))) {
        condval = Plan[((((((int64_t)group) * (int64_t)2048) + (((int64_t)p) * (int64_t)256)) + (((int64_t)u) * (int64_t)128)) + ((int64_t)((int)threadIdx.x)))];
      } else {
        condval = 0;
      }
      int off = condval;
      for (int z_1 = 0; z_1 < 4; ++z_1) {
        int i = max(((z_1 * 4) + off), ((z_1 * 4) + off));
        uint condval_1;
        if ((0 <= off)) {
          condval_1 = nr_ld32((&(A[((int64_t)i)])));
        } else {
          condval_1 = (uint)0;
        }
        ((uint*)sh)[(((u * 512) + (((int)threadIdx.x) * 4)) + z_1)] = condval_1;
      }
    }
    __syncthreads();
    for (int k = 0; k < 2; ++k) {
      for (int r_1 = 0; r_1 < 4; ++r_1) {
        ...
        for (int n_1 = 0; n_1 < 12; ++n_1) {
          uint b0 = nr_ld32((&(Weight[(((((((((int64_t)p) * (int64_t)98304) + (((int64_t)k) * (int64_t)49152)) + (((int64_t)((int)blockIdx.z)) * (int64_t)12288)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)5) * (int64_t)3072)) + ((((int64_t)n_1) >> (int64_t)1) * (int64_t)512)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)31) * (int64_t)16)) + ((((int64_t)n_1) & (int64_t)1) * (int64_t)8))])));
          uint b1 = nr_ld32((&(Weight[((((((((((int64_t)p) * (int64_t)98304) + (((int64_t)k) * (int64_t)49152)) + (((int64_t)((int)blockIdx.z)) * (int64_t)12288)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)5) * (int64_t)3072)) + ((((int64_t)n_1) >> (int64_t)1) * (int64_t)512)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)31) * (int64_t)16)) + ((((int64_t)n_1) & (int64_t)1) * (int64_t)8)) + (int64_t)4)])));
      ...
      if (co < 2) {
        for (int h_1 = 0; h_1 < 2; ++h_1) {
          ...
          for (int n_2 = 0; n_2 < 4; ++n_2) {
            ...
            if (co == 0) {
              uint a_8 = v;
              float condval_2;
              if (((((((int)blockIdx.z) * 4) + (((int)threadIdx.x) >> 5)) + 229376) < (sizes_2 >> 2))) {
                condval_2 = Scale[(((((int64_t)((int)blockIdx.z)) * (int64_t)4) + (((int64_t)((int)threadIdx.x)) >> (int64_t)5)) + (int64_t)229376)];
              } else {
                condval_2 = 0x0p+0f/*0.000000e+00*/;
              }
              uint b_9 = nr_dup(((float)((half_t)condval_2)));
              v = nr_mul2(a_8, b_9);
            }
        ...
        for (int h_2 = 0; h_2 < 2; ++h_2) {
          for (int n_3 = 0; n_3 < 2; ++n_3) {
            ...
            int condval_4;
            if (((0 <= group) && ((((((group * 64) + (r_2 * 16)) + (((((h_2 * 8) + ((((int)threadIdx.x) & 31) >> 2)) >> 2) & 1) * 8)) + ((((h_2 * 8) + ((((int)threadIdx.x) & 31) >> 2)) & 3) * 2)) + ((((h_2 * 8) + ((((int)threadIdx.x) & 31) >> 2)) >> 3) & 1)) < sizes_4))) {
              condval_4 = Members[(((((((int64_t)group) * (int64_t)64) + (((int64_t)r_2) * (int64_t)16)) + (((((((int64_t)h_2) * (int64_t)8) + ((((int64_t)((int)threadIdx.x)) & (int64_t)31) >> (int64_t)2)) >> (int64_t)2) & (int64_t)1) * (int64_t)8)) + ((((((int64_t)h_2) * (int64_t)8) + ((((int64_t)((int)threadIdx.x)) & (int64_t)31) >> (int64_t)2)) & (int64_t)3) * (int64_t)2)) + ((((((int64_t)h_2) * (int64_t)8) + ((((int64_t)((int)threadIdx.x)) & (int64_t)31) >> (int64_t)2)) >> (int64_t)3) & (int64_t)1))];
            } else {
              condval_4 = 0;
            }
            uint condval_3;
            if ((0 <= condval_4)) {
              condval_3 = (nr_qpair(a_9) | (nr_qpair(a_10) << (uint)16));
            } else {
              condval_3 = (uint)0;
            }
            uint value = condval_3;
        ...
        int condval_5;
        if (((0 <= group) && ((((((group * 64) + (r_2 * 16)) + (((((((int)threadIdx.x) & 31) >> 2) >> 2) & 1) * 8)) + ((((((int)threadIdx.x) & 31) >> 2) & 3) * 2)) + ((((((int)threadIdx.x) & 31) >> 2) >> 3) & 1)) < sizes_4))) {
          condval_5 = Members[(((((((int64_t)group) * (int64_t)64) + (((int64_t)r_2) * (int64_t)16)) + (((((((int64_t)((int)threadIdx.x)) & (int64_t)31) >> (int64_t)2) >> (int64_t)2) & (int64_t)1) * (int64_t)8)) + ((((((int64_t)((int)threadIdx.x)) & (int64_t)31) >> (int64_t)2) & (int64_t)3) * (int64_t)2)) + ((((((int64_t)((int)threadIdx.x)) & (int64_t)31) >> (int64_t)2) >> (int64_t)3) & (int64_t)1))];
        } else {
          condval_5 = 0;
        }
        bool vx = (0 <= condval_5);
        int condval_6;
        if (((0 <= group) && ((((((group * 64) + (r_2 * 16)) + ((((((((int)threadIdx.x) & 31) >> 2) + 8) >> 2) & 1) * 8)) + (((((((int)threadIdx.x) & 31) >> 2) + 8) & 3) * 2)) + (((((((int)threadIdx.x) & 31) >> 2) + 8) >> 3) & 1)) < sizes_4))) {
          condval_6 = Members[(((((((int64_t)group) * (int64_t)64) + (((int64_t)r_2) * (int64_t)16)) + ((((((((int64_t)((int)threadIdx.x)) & (int64_t)31) >> (int64_t)2) + (int64_t)8) >> (int64_t)2) & (int64_t)1) * (int64_t)8)) + (((((((int64_t)((int)threadIdx.x)) & (int64_t)31) >> (int64_t)2) + (int64_t)8) & (int64_t)3) * (int64_t)2)) + (((((((int64_t)((int)threadIdx.x)) & (int64_t)31) >> (int64_t)2) + (int64_t)8) >> (int64_t)3) & (int64_t)1))];
        } else {
          condval_6 = 0;
        }
        bool vy = (0 <= condval_6);
        for (int n_4 = 0; n_4 < 4; ++n_4) {
          ...
          uint condval_7;
          if (vx) {
            condval_7 = nr_qpair(a_11);
          } else {
            condval_7 = (uint)0;
          }
          uint condval_8;
          if (vy) {
            condval_8 = nr_qpair(a_12);
          } else {
            condval_8 = (uint)0;
          }
          uint a_13 = (condval_7 | (condval_8 << (uint)16));
          word = (uint)0;
  ...
  for (int r_3 = 0; r_3 < 4; ++r_3) {
    ...
    for (int n_6 = 0; n_6 < 8; ++n_6) {
      for (int h_4 = 0; h_4 < 2; ++h_4) {
        score[((n_6 * 2) + h_4)] = nr_ld32((&(Weight[((((((((((int64_t)((int)blockIdx.z)) * (int64_t)32768) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)5) * (int64_t)8192)) + (((int64_t)r_3) * (int64_t)2048)) + ((((int64_t)n_6) >> (int64_t)1) * (int64_t)512)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)31) * (int64_t)16)) + ((((int64_t)n_6) & (int64_t)1) * (int64_t)8)) + (((int64_t)h_4) * (int64_t)4)) + (int64_t)786432)])));
      }
  ...
  for (int r_4 = 0; r_4 < 4; ++r_4) {
    int condval_9;
    if (((0 <= group) && ((((group * 2048) + (r_4 * 64)) + (((int)threadIdx.x) & 31)) < sizes_1))) {
      condval_9 = Plan[(((((int64_t)group) * (int64_t)2048) + (((int64_t)r_4) * (int64_t)64)) + (((int64_t)((int)threadIdx.x)) & (int64_t)31))];
    } else {
      condval_9 = 0;
    }
    int off_1 = condval_9;
    if (0 <= off_1) {
      for (int z_5 = 0; z_5 < 4; ++z_5) {
        int i_1 = max(((((((int)blockIdx.z) * 2048) + ((((int)threadIdx.x) >> 5) * 512)) + (z_5 * 4)) + off_1), ((((((int)blockIdx.z) * 2048) + ((((int)threadIdx.x) >> 5) * 512)) + (z_5 * 4)) + off_1));
        uint v_1 = nr_ld32((&(((uchar*)packed)[(((((((int)threadIdx.x) >> 5) * 2048) + (r_4 * 512)) + ((((int)threadIdx.x) & 31) * 16)) + (z_5 * 4))])));
        if (0 <= i_1) {
          if (i_1 < sizes_3) {
            nr_st32((&(Raw[((int64_t)i_1)])), v_1);
          }
        }
      }
    }
