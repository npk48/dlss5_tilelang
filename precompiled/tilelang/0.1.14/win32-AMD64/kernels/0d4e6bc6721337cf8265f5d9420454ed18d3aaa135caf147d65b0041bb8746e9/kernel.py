...
def call(kernels, Current, Previous, Gaussian, Gate, Settings, Out, stream=0):
    ...
    arg_values = Current.data_ptr(), Gate.data_ptr(), Gaussian.data_ptr(), Out.data_ptr(), Previous.data_ptr(), Settings.data_ptr()
