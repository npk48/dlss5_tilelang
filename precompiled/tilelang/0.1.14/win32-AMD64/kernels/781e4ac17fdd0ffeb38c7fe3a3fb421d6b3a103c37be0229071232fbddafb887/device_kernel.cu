...
extern "C" __global__ void __launch_bounds__(64, 1) kernel_kernel(const int* __restrict__ AG, const int* __restrict__ FG, const int* __restrict__ Gate, const int* __restrict__ Inv, const int* __restrict__ Proj, int* __restrict__ RW, const int* __restrict__ WB, const int* __restrict__ WP, const int* __restrict__ WQ, const int* __restrict__ WR, const int* __restrict__ WS, const int* __restrict__ WT, const int* __restrict__ WX, int counter, int gn, int gx, int height, int invn, int out, int prn, int rn, int skip, int sx, int sy, int tiles, int width, int wns_0, int wns_1, int wns_2, int wns_3, int wns_4, int wns_6, int wns_7, int wns_8) {
    ...
    for (int m_1 = 0; m_1 < 2; ++m_1) {
      ...
      for (int n = 0; n < 4; ++n) {
        ...
        if (((((channel * 16) + (n * 4)) + (((int)threadIdx.x) & 3)) < wns_7)) {
          condval_15 = FG[(((channel * 16) + (n * 4)) + (((int)threadIdx.x) & 3))];
        } else {
          condval_15 = 0;
        }
        int g = condval_15;
        ...
        for (int pair = 0; pair < 2; ++pair) {
          for (int j_s = 0; j_s < 4; ++j_s) {
            ...
            if ((((((((stream * 2048) + (kp * 1024)) + (slab * 256)) + (pair * 128)) + ((((int)threadIdx.x) & 31) * 4)) + j_s) < wns_0)) {
              condval_16 = WX[((((((stream * 2048) + (kp * 1024)) + (slab * 256)) + (pair * 128)) + ((((int)threadIdx.x) & 31) * 4)) + j_s)];
            } else {
              condval_16 = 0;
            }
            b[j_s] = condval_16;
      ...
      for (int pair_1 = 0; pair_1 < 2; ++pair_1) {
        for (int j_s_1 = 0; j_s_1 < 4; ++j_s_1) {
          ...
          if (((((((stream * 1024) + (slab * 256)) + (pair_1 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + j_s_1) < wns_1)) {
            condval_17 = WR[(((((stream * 1024) + (slab * 256)) + (pair_1 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + j_s_1)];
          } else {
            condval_17 = 0;
          }
          b_1[j_s_1] = condval_17;
        }
        #pragma unroll
    ...
    for (int pair_2 = 0; pair_2 < 4; ++pair_2) {
      for (int j_s_2 = 0; j_s_2 < 4; ++j_s_2) {
        ...
        if ((((((stream * 512) + (pair_2 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + j_s_2) < wns_2)) {
          condval_18 = WT[((((stream * 512) + (pair_2 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + j_s_2)];
        } else {
          condval_18 = 0;
        }
        b_2[j_s_2] = condval_18;
      }
      #pragma unroll
      ...
      for (int pair_3 = 0; pair_3 < 6; ++pair_3) {
        for (int j_s_3 = 0; j_s_3 < 4; ++j_s_3) {
          ...
          if (((((((kp_1 * 1536) + ((((int)threadIdx.x) >> 5) * 768)) + (pair_3 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + j_s_3) < wns_3)) {
            condval_19 = WQ[(((((kp_1 * 1536) + ((((int)threadIdx.x) >> 5) * 768)) + (pair_3 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + j_s_3)];
          } else {
            condval_19 = 0;
          }
          b_3[j_s_3] = condval_19;
        }
        #pragma unroll
  ...
  for (int slab_2 = 0; slab_2 < 2; ++slab_2) {
    ...
    for (int m_16 = 0; m_16 < 2; ++m_16) {
      ...
      for (int n_12 = 0; n_12 < 8; ++n_12) {
        ...
        if (((((((((((int)threadIdx.x) >> 5) * 2048) + (slab_2 * 1024)) + (m_16 * 512)) + ((n_12 >> 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + ((n_12 & 1) * 2)) < wns_4)) {
          condval_20 = WB[(((((((((int)threadIdx.x) >> 5) * 2048) + (slab_2 * 1024)) + (m_16 * 512)) + ((n_12 >> 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + ((n_12 & 1) * 2))];
        } else {
          condval_20 = 0;
        }
        int condval_21;
        if ((((((((((((int)threadIdx.x) >> 5) * 2048) + (slab_2 * 1024)) + (m_16 * 512)) + ((n_12 >> 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + ((n_12 & 1) * 2)) + 1) < wns_4)) {
          condval_21 = WB[((((((((((int)threadIdx.x) >> 5) * 2048) + (slab_2 * 1024)) + (m_16 * 512)) + ((n_12 >> 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + ((n_12 & 1) * 2)) + 1)];
        } else {
          condval_21 = 0;
        }
        uint64_t r_4 = wide_mma(Q[((slab_2 * 8) + (m_16 * 4))], Q[(((slab_2 * 8) + (m_16 * 4)) + 1)], Q[(((slab_2 * 8) + (m_16 * 4)) + 2)], Q[(((slab_2 * 8) + (m_16 * 4)) + 3)], K[(n_12 * 2)], K[((n_12 * 2) + 1)], condval_20, condval_21);
    ...
    for (int word_6 = 0; word_6 < 8; ++word_6) {
      ...
      Residual[word_6] = wide_packet_prmt((*(uint *)(&(v__4))), (*(uint *)(&(v__5))), condval_22);
    }
    __syncthreads();
    #pragma unroll
    ...
    for (int m_18 = 0; m_18 < 2; ++m_18) {
      ...
      for (int n_16 = 0; n_16 < 4; ++n_16) {
        ...
        if ((((((((int)threadIdx.x) >> 5) * 16) + (n_16 * 4)) + (((int)threadIdx.x) & 3)) < wns_8)) {
          condval_23 = AG[((((((int)threadIdx.x) >> 5) * 16) + (n_16 * 4)) + (((int)threadIdx.x) & 3))];
        } else {
          condval_23 = 0;
        }
        int g_1 = condval_23;
      ...
      for (int pair_4 = 0; pair_4 < 2; ++pair_4) {
        for (int j_s_4 = 0; j_s_4 < 4; ++j_s_4) {
          ...
          if (((((((kp_3 * 512) + ((((int)threadIdx.x) >> 5) * 256)) + (pair_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + j_s_4) < wns_6)) {
            condval_24 = WP[(((((kp_3 * 512) + ((((int)threadIdx.x) >> 5) * 256)) + (pair_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + j_s_4)];
          } else {
            condval_24 = 0;
          }
          b_4[j_s_4] = condval_24;
        }
        #pragma unroll
  ...
  for (int part = 0; part < 4; ++part) {
    ...
    if (((((0 <= v_42) & (0 <= v_43)) & (v_42 < (height >> 2))) & (v_43 < (width >> 2)))) {
      condval_29 = (((((v_42 * (width >> 2)) * 1024) + (v_43 * 1024)) + (((v_41 >> 9) & 1) * 512)) + (v_41 & 511));
    } else {
      condval_29 = -1;
    }
    v_44 = condval_29;
