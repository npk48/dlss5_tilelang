...
extern "C" __global__ void main_kernel(const uchar* __restrict__ A, int* __restrict__ C0, int* __restrict__ C1, const int* __restrict__ M, uchar* __restrict__ O, const int* __restrict__ P, int count, int n0, int n1, int sizes_0, int sizes_2, int sizes_3, int sizes_4, int v0, int v1);
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(const uchar* __restrict__ A, int* __restrict__ C0, int* __restrict__ C1, const int* __restrict__ M, uchar* __restrict__ O, const int* __restrict__ P, int count, int n0, int n1, int sizes_0, int sizes_2, int sizes_3, int sizes_4, int v0, int v1) {
  if (((((int)blockIdx.x) * 256) + ((int)threadIdx.x)) < count) {
    int condval;
    if ((((((int)blockIdx.x) * 256) + ((int)threadIdx.x)) < sizes_4)) {
      condval = P[((((int64_t)((int)blockIdx.x)) * (int64_t)256) + ((int64_t)((int)threadIdx.x)))];
    } else {
      condval = 0;
    }
    if (0 <= condval) {
      int condval_1;
      if ((((((int)blockIdx.x) * 256) + ((int)threadIdx.x)) < sizes_4)) {
        condval_1 = P[((((int64_t)((int)blockIdx.x)) * (int64_t)256) + ((int64_t)((int)threadIdx.x)))];
      } else {
        condval_1 = 0;
      }
      if (condval_1 < sizes_3) {
        int condval_3;
        if ((((((int)blockIdx.x) * 256) + ((int)threadIdx.x)) < sizes_2)) {
          condval_3 = M[((((int64_t)((int)blockIdx.x)) * (int64_t)256) + ((int64_t)((int)threadIdx.x)))];
        } else {
          condval_3 = 0;
        }
        int condval_4;
        if ((((((int)blockIdx.x) * 256) + ((int)threadIdx.x)) < sizes_2)) {
          condval_4 = M[((((int64_t)((int)blockIdx.x)) * (int64_t)256) + ((int64_t)((int)threadIdx.x)))];
        } else {
          condval_4 = 0;
        }
        uchar condval_2;
        if (((0 <= condval_3) && (condval_4 < sizes_0))) {
          int64_t condval_5;
          if ((((((int64_t)((int)blockIdx.x)) * (int64_t)256) + ((int64_t)((int)threadIdx.x))) < ((int64_t)sizes_2))) {
            condval_5 = ((int64_t)M[((((int64_t)((int)blockIdx.x)) * (int64_t)256) + ((int64_t)((int)threadIdx.x)))]);
          } else {
            condval_5 = (int64_t)0;
          }
          int64_t condval_6;
          if ((((((int64_t)((int)blockIdx.x)) * (int64_t)256) + ((int64_t)((int)threadIdx.x))) < ((int64_t)sizes_2))) {
            condval_6 = ((int64_t)M[((((int64_t)((int)blockIdx.x)) * (int64_t)256) + ((int64_t)((int)threadIdx.x)))]);
          } else {
            condval_6 = (int64_t)0;
          }
          condval_2 = A[condval_6];
        } else {
          condval_2 = (uchar)0;
        }
        int64_t condval_7;
        if ((((((int64_t)((int)blockIdx.x)) * (int64_t)256) + ((int64_t)((int)threadIdx.x))) < ((int64_t)sizes_4))) {
          condval_7 = ((int64_t)P[((((int64_t)((int)blockIdx.x)) * (int64_t)256) + ((int64_t)((int)threadIdx.x)))]);
        } else {
          condval_7 = (int64_t)0;
        }
        int64_t condval_8;
