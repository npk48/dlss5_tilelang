...
extern "C" __global__ void __launch_bounds__(64, 1) kernel_kernel(const int* __restrict__ AG, const int* __restrict__ FG, int* __restrict__ RW, const int* __restrict__ SW, const int* __restrict__ WB, const int* __restrict__ WP, const int* __restrict__ WQ, const int* __restrict__ WR, const int* __restrict__ WS, const int* __restrict__ WT, const int* __restrict__ WX) {
  ...
  for (int m = 0; m < 4; ++m) {
    ...
    v_2 = (((((((int)blockIdx.x) / 20) * 1280) + ((v_1 >> 3) * 160)) + ((((int)blockIdx.x) % 20) * 8)) + (v_1 & 7));
    v_3 = ((((((int)threadIdx.x) >> 5) * 655360) + ((((int)threadIdx.x) & 1) * 327680)) + (v_2 * 16));
    int raw = v_3;
    uint broadcast_var = (uint)0;
    *(uint4*)(temp + 0) = make_uint4(broadcast_var, broadcast_var, broadcast_var, broadcast_var);
    if ((0 <= raw) & (raw <= 36765072)) {
      {
        int SW_local_cast[4];
        *(int4*)(SW_local_cast + 0) = *(int4*)(SW + (((raw >> 4) * 4) + 5898240));
        uint4 __1;
  ...
  for (int channel = 0; channel < 2; ++channel) {
    ...
    for (int m_1 = 0; m_1 < 2; ++m_1) {
      ...
      for (int n = 0; n < 4; ++n) {
        ...
        uint bits = wide_packet_prmt((*(uint *)(&(v__1))), (*(uint *)(&(v__2))), condval);
  ...
  for (int slab_2 = 0; slab_2 < 2; ++slab_2) {
    ...
    for (int word_5 = 0; word_5 < 8; ++word_5) {
      ...
      Residual[word_5] = wide_packet_prmt((*(uint *)(&(v__4))), (*(uint *)(&(v__5))), condval_1);
    }
    __syncthreads();
    #pragma unroll
  ...
  for (int part = 0; part < 4; ++part) {
    ...
    v_43 = (((((((int)blockIdx.x) / 20) * 1280) + ((v_42 >> 3) * 160)) + ((((int)blockIdx.x) % 20) * 8)) + (v_42 & 7));
    v_44 = ((((((((((((((int)threadIdx.x) >> 5) * 32) + (((ix & 511) >> 7) * 8)) + (((ix & 15) >> 2) * 2)) + (ix & 1)) & 49) | (((((((((int)threadIdx.x) >> 5) * 32) + (((ix & 511) >> 7) * 8)) + (((ix & 15) >> 2) * 2)) + (ix & 1)) & 6) << 1)) | (((((((((int)threadIdx.x) >> 5) * 32) + (((ix & 511) >> 7) * 8)) + (((ix & 15) >> 2) * 2)) + (ix & 1)) & 8) >> 2)) >> 4) * 327680) + (v_43 * 16)) + (((((((((((int)threadIdx.x) >> 5) * 32) + (((ix & 511) >> 7) * 8)) + (((ix & 15) >> 2) * 2)) + (ix & 1)) & 49) | (((((((((int)threadIdx.x) >> 5) * 32) + (((ix & 511) >> 7) * 8)) + (((ix & 15) >> 2) * 2)) + (ix & 1)) & 6) << 1)) | (((((((((int)threadIdx.x) >> 5) * 32) + (((ix & 511) >> 7) * 8)) + (((ix & 15) >> 2) * 2)) + (ix & 1)) & 8) >> 2)) & 15));
    v_45 = ((v_44 / 327680) + ((v_44 % 327680) >> 31));
    v_46 = ((327680 & ((v_44 % 327680) >> 31)) + (v_44 % 327680));
    v_47 = ((v_46 / 2560) + ((v_46 % 2560) >> 31));
    v_48 = (((2560 & ((v_46 % 2560) >> 31)) + (v_46 % 2560)) >> 4);
    v_49 = (v_46 & 15);
    v_50 = (((((((((v_47 >> 2) * 40960) + ((v_48 >> 2) * 1024)) + (v_49 & 3)) + ((((v_48 & 3) * 4) + (v_49 >> 2)) << 4)) + (((v_47 >> 1) & 1) << 2)) + ((v_45 & 1) << 3)) + ((v_47 & 1) << 8)) + ((v_45 >> 1) << 9));
    int raw_1 = v_50;
    if ((0 <= raw_1) & (raw_1 <= 35454352)) {
      {
        ...
        *(int4*)(RW + (((raw_1 >> 4) * 4) + 6225920)) = *(int4*)(RW_local_cast_1 + 0);
      }
    }
  }
  __syncthreads();
