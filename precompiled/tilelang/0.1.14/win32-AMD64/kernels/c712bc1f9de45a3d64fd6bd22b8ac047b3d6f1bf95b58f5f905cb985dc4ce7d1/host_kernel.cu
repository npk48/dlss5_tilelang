...
extern "C" __global__ void kernel_kernel(const int* __restrict__ AG, const int* __restrict__ FG, const int* __restrict__ Matrix, const int* __restrict__ PI, const int* __restrict__ PO, uchar* __restrict__ R, int* __restrict__ RW, const int* __restrict__ SW, const int* __restrict__ WB, const int* __restrict__ WP, const int* __restrict__ WQ, const int* __restrict__ WR, const int* __restrict__ WS, const int* __restrict__ WT, const int* __restrict__ WX);
extern "C" __global__ void __launch_bounds__(64, 1) kernel_kernel(const int* __restrict__ AG, const int* __restrict__ FG, const int* __restrict__ Matrix, const int* __restrict__ PI, const int* __restrict__ PO, uchar* __restrict__ R, int* __restrict__ RW, const int* __restrict__ SW, const int* __restrict__ WB, const int* __restrict__ WP, const int* __restrict__ WQ, const int* __restrict__ WR, const int* __restrict__ WS, const int* __restrict__ WT, const int* __restrict__ WX) {
  extern __shared__ __align__(1024) uchar buf_dyn_shmem[];
  void* S = ((void*)((char*)buf_dyn_shmem + 0));
  void* D = ((void*)((char*)buf_dyn_shmem + 4096));
  uint temp[4];
  int v = 0;
  int v_1 = 0;
  int v_2 = 0;
  ...
  for (int m = 0; m < 4; ++m) {
    ...
    *(uint4*)(temp + 0) = make_uint4(broadcast_var, broadcast_var, broadcast_var, broadcast_var);
    if ((0 <= raw) & (raw <= 32832912)) {
      {
        int SW_local_cast[4];
        *(int4*)(SW_local_cast + 0) = *(int4*)(SW + (((raw >> 4) * 4) + 6881280));
        uint4 __1;
    ...
    }
    {
      ...
      *(int4*)(((int*)S) + ((((((int)threadIdx.x) >> 5) * 512) + (m * 128)) + ((((int)threadIdx.x) & 31) * 4))) = *(int4*)(S_local_cast_1 + 0);
    }
  }
  __syncthreads();
  #pragma unroll
  for (int channel = 0; channel < 2; ++channel) {
    ...
    for (int m_1 = 0; m_1 < 2; ++m_1) {
      #pragma unroll
      for (int n = 0; n < 4; ++n) {
        int v__2 = ((int*)S)[(((((channel * 512) + ((((int)threadIdx.x) >> 5) * 256)) + (m_1 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + ((n >> 1) * 2))];
        int v__3 = ((int*)S)[((((((channel * 512) + ((((int)threadIdx.x) >> 5) * 256)) + (m_1 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + ((n >> 1) * 2)) + 1)];
        int condval_1;
        if (((n % 2) == 0)) {
          condval_1 = 21520;
        } else {
    ...
    for (int slab = 0; slab < 4; ++slab) {
      ...
      for (int kp = 0; kp < 2; ++kp) {
        ...
        for (int m_4 = 0; m_4 < 2; ++m_4) {
          *(int4*)(a + (m_4 * 4)) = *(int4*)(((int*)S) + ((((kp * 512) + ((((int)threadIdx.x) >> 5) * 256)) + (m_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)));
        }
        #pragma unroll
  ...
  for (int channel_1 = 0; channel_1 < 2; ++channel_1) {
    ...
    for (int word_2 = 0; word_2 < 8; ++word_2) {
      ...
      ((int*)S)[(((((channel_1 * 512) + ((((int)threadIdx.x) >> 5) * 256)) + ((word_2 >> 2) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + (word_2 & 3))] = (*(int *)(&(_reinterpret_tmp)));
    }
  }
  __syncthreads();
  #pragma unroll
  for (int slab_1 = 0; slab_1 < 2; ++slab_1) {
    ...
    for (int kp_1 = 0; kp_1 < 2; ++kp_1) {
      ...
      for (int m_12 = 0; m_12 < 2; ++m_12) {
        *(int4*)(a_1 + (m_12 * 4)) = *(int4*)(((int*)S) + ((((kp_1 * 512) + (slab_1 * 256)) + (m_12 * 128)) + ((((int)threadIdx.x) & 31) * 4)));
      }
      #pragma unroll
  ...
  for (int slab_2 = 0; slab_2 < 2; ++slab_2) {
    ...
    for (int word_5 = 0; word_5 < 8; ++word_5) {
      int v__5 = ((int*)S)[((((((((int)threadIdx.x) >> 5) * 512) + (slab_2 * 256)) + ((word_5 >> 2) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + (((word_5 & 3) >> 1) * 2))];
      int v__6 = ((int*)S)[(((((((((int)threadIdx.x) >> 5) * 512) + (slab_2 * 256)) + ((word_5 >> 2) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + (((word_5 & 3) >> 1) * 2)) + 1)];
      int condval_2;
      if (((word_5 % 2) == 0)) {
        condval_2 = 21520;
      } else {
    ...
    for (int word_6 = 0; word_6 < 8; ++word_6) {
      ...
      ((int*)S)[((((((((int)threadIdx.x) >> 5) * 512) + (slab_2 * 256)) + ((word_6 >> 2) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + (word_6 & 3))] = (*(int *)(&(_reinterpret_tmp_1)));
    }
    __syncthreads();
    #pragma unroll
    ...
    for (int kp_3 = 0; kp_3 < 2; ++kp_3) {
      ...
      for (int m_19 = 0; m_19 < 2; ++m_19) {
        *(int4*)(a_2 + (m_19 * 4)) = *(int4*)(((int*)S) + ((((kp_3 * 512) + (slab_2 * 256)) + (m_19 * 128)) + ((((int)threadIdx.x) & 31) * 4)));
      }
      #pragma unroll
    ...
    for (int m_22 = 0; m_22 < 2; ++m_22) {
      ...
      for (int n_18 = 0; n_18 < 4; ++n_18) {
        ...
        for (int j_3 = 0; j_3 < 2; ++j_3) {
          uint v__7 = C[(((m_22 * 8) + (n_18 * 2)) + j_3)];
          ((int*)D)[(((((((((int)threadIdx.x) >> 5) * 1024) + (slab_2 * 512)) + (m_22 * 256)) + (n_18 * 64)) + ((((int)threadIdx.x) & 31) * 2)) + j_3)] = (*(int *)(&(v__7)));
        }
      }
    }
    __syncthreads();
  ...
  for (int part = 0; part < 4; ++part) {
    ...
    v_42 = ((((((int)blockIdx.x) / 20) * 2) + (v_41 >> 11)) - 1);
    v_43 = (((((int)blockIdx.x) % 20) * 2) + ((v_41 & 2047) >> 10));
    int condval_7;
    if (((((0 <= v_42) & (0 <= v_43)) & (v_42 < 32)) & (v_43 < 40))) {
      condval_7 = ((((v_42 * 40960) + (v_43 * 1024)) + (((v_41 >> 9) & 1) * 512)) + (v_41 & 511));
    } else {
      condval_7 = -1;
    }
    v_44 = condval_7;
    int raw_1 = v_44;
    if ((0 <= raw_1) & (raw_1 <= 31522192)) {
      {
        int RW_local_cast_2[4];
        int4 __3;
        uint4 v__8 = *(uint4*)(A + (part * 4));
        __3.x = (int)(v__8.x);
        __3.y = (int)(v__8.y);
        __3.z = (int)(v__8.z);
        __3.w = (int)(v__8.w);
        *(int4*)(RW_local_cast_2 + 0) = __3;
        *(int4*)(RW + (((raw_1 >> 4) * 4) + 7208960)) = *(int4*)(RW_local_cast_2 + 0);
      }
    }
  }
  for (int group_1 = 0; group_1 < 2; ++group_1) {
    for (int n_19 = 0; n_19 < 4; ++n_19) {
      acc[0] = (uint)0;
      acc[1] = (uint)0;
      for (int kp_4 = 0; kp_4 < 2; ++kp_4) {
        ...
        for (int word_8 = 0; word_8 < 4; ++word_8) {
          ...
          for (int b_7 = 0; b_7 < 4; ++b_7) {
            #pragma unroll
            for (int t = 0; t < 4; ++t) {
              int ix_1 = PI[((((((((((int)blockIdx.x) * 4096) + ((word_8 & 1) * 2048)) + (((((int)threadIdx.x) & 31) >> 2) * 256)) + (t * 64)) + (kp_4 * 32)) + ((word_8 >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) + b_7)];
              vals[t] = (uint)0;
              if (0 <= ix_1) {
                int v__9 = ((int*)D)[((((((((ix_1 & 63) >> 5) * 1024) + ((ix_1 >> 10) * 256)) + (((ix_1 & 31) >> 3) * 64)) + (((ix_1 & 511) >> 6) * 8)) + (((ix_1 & 7) >> 1) * 2)) + ((ix_1 & 1023) >> 9))];
                vals[t] = ((((*(uint *)(&(v__9))) >> ((uint)((ix_1 & 1) * 16))) & (uint)65535) | ((((*(uint *)(&(v__9))) >> ((uint)((ix_1 & 1) * 16))) & (uint)65535) << (uint)16));
              }
            }
            uint avg = wide_mul(wide_add(wide_add(vals[0], vals[1]), wide_add(vals[2], vals[3])), wide_splat(0x1p-2f/*2.500000e-01*/));
            temp[word_8] = (temp[word_8] | ((wide_encode(avg, avg) & (uint)255) << ((uint)(b_7 * 8))));
          }
        }
        uint64_t r_7 = wide_mma(temp[0], temp[1], temp[2], temp[3], Matrix[((((((kp_4 * 1024) + (group_1 * 512)) + ((((int)threadIdx.x) >> 5) * 256)) + ((n_19 >> 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + ((n_19 & 1) * 2))], Matrix[(((((((kp_4 * 1024) + (group_1 * 512)) + ((((int)threadIdx.x) >> 5) * 256)) + ((n_19 >> 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + ((n_19 & 1) * 2)) + 1)], acc[0], acc[1]);
        acc[0] = ((uint)r_7);
        acc[1] = ((uint)(r_7 >> (uint64_t)32));
      }
      uint encoded = wide_encode(acc[0], acc[1]);
      #pragma unroll
      for (int b_8 = 0; b_8 < 4; ++b_8) {
        int dest = PO[((((((((((int)blockIdx.x) * 2048) + ((b_8 >> 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + (group_1 * 64)) + ((((int)threadIdx.x) >> 5) * 32)) + (n_19 * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (b_8 & 1))];
        if (0 <= dest) {
          if (dest < 30211488) {
            R[(dest + 30146560)] = ((uchar)(encoded >> ((uint)(b_8 * 8))));
          }
        }
      }
    }
