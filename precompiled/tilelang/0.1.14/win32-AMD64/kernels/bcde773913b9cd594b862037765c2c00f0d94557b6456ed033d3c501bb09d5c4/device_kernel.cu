...
extern "C" __global__ void __launch_bounds__(32, 1) main_kernel(const half_t* __restrict__ Adapter, const half_t* __restrict__ G0, const half_t* __restrict__ G1, const half_t* __restrict__ Gate, float* __restrict__ Head, const half_t* __restrict__ Readout, int* __restrict__ Status, uint* __restrict__ Wp, uint* __restrict__ Wq, uint* __restrict__ Wt0, uint* __restrict__ Wt1, uchar* __restrict__ X, uchar* __restrict__ Y) {
  ...
  #pragma unroll
  for (int m = 0; m < 4; ++m) {
    bool valid = ((((1 <= ((((int)blockIdx.x) * 2) + ((int)((m == 2) | (m == 3))))) & (((((int)blockIdx.x) * 2) + ((int)((m == 2) | (m == 3)))) < 161)) & (1 <= ((((int)blockIdx.y) * 2) + ((int)((m == 1) | (m == 2)))))) & (((((int)blockIdx.y) * 2) + ((int)((m == 1) | (m == 2)))) < 129));
    #pragma unroll
    for (int j_2 = 0; j_2 < 4; ++j_2) {
      sk[j_2] = (uint)0;
    }
    int condval;
    if (((((1 <= ((((int)blockIdx.x) * 2) + ((int)((m == 2) | (m == 3))))) & (((((int)blockIdx.x) * 2) + ((int)((m == 2) | (m == 3)))) < 161)) & (1 <= ((((int)blockIdx.y) * 2) + ((int)((m == 1) | (m == 2)))))) & (((((int)blockIdx.y) * 2) + ((int)((m == 1) | (m == 2)))) < 129))) {
      condval = ((((((((((int)blockIdx.y) * 163840) + (((int)((m == 1) | (m == 2))) * 81920)) + (((int)blockIdx.x) * 1024)) + (((int)((m == 2) | (m == 3))) * 512)) + (((((int)threadIdx.x) >> 2) >> 2) * 256)) + (((((int)threadIdx.x) >> 2) & 3) * 64)) + ((((int)threadIdx.x) & 3) * 16)) - 82432);
    } else {
      condval = -1;
    }
    if (0 <= condval) {
      int condval_1;
      if (((((1 <= ((((int)blockIdx.x) * 2) + ((int)((m == 2) | (m == 3))))) & (((((int)blockIdx.x) * 2) + ((int)((m == 2) | (m == 3)))) < 161)) & (1 <= ((((int)blockIdx.y) * 2) + ((int)((m == 1) | (m == 2)))))) & (((((int)blockIdx.y) * 2) + ((int)((m == 1) | (m == 2)))) < 129))) {
        condval_1 = ((((((((((int)blockIdx.y) * 163840) + (((int)((m == 1) | (m == 2))) * 81920)) + (((int)blockIdx.x) * 1024)) + (((int)((m == 2) | (m == 3))) * 512)) + (((((int)threadIdx.x) >> 2) >> 2) * 256)) + (((((int)threadIdx.x) >> 2) & 3) * 64)) + ((((int)threadIdx.x) & 3) * 16)) - 82432);
      } else {
        condval_1 = -1;
      }
      if (condval_1 < 60358048) {
        int condval_2;
        if (((((1 <= ((((int)blockIdx.x) * 2) + ((int)((m == 2) | (m == 3))))) & (((((int)blockIdx.x) * 2) + ((int)((m == 2) | (m == 3)))) < 161)) & (1 <= ((((int)blockIdx.y) * 2) + ((int)((m == 1) | (m == 2)))))) & (((((int)blockIdx.y) * 2) + ((int)((m == 1) | (m == 2)))) < 129))) {
          condval_2 = ((((((((((int)blockIdx.y) * 163840) + (((int)((m == 1) | (m == 2))) * 81920)) + (((int)blockIdx.x) * 1024)) + (((int)((m == 2) | (m == 3))) * 512)) + (((((int)threadIdx.x) >> 2) >> 2) * 256)) + (((((int)threadIdx.x) >> 2) & 3) * 64)) + ((((int)threadIdx.x) & 3) * 16)) - 82432);
        } else {
          condval_2 = -1;
        }
        int condval_3;
        if (((((1 <= ((((int)blockIdx.x) * 2) + ((int)((m == 2) | (m == 3))))) & (((((int)blockIdx.x) * 2) + ((int)((m == 2) | (m == 3)))) < 161)) & (1 <= ((((int)blockIdx.y) * 2) + ((int)((m == 1) | (m == 2)))))) & (((((int)blockIdx.y) * 2) + ((int)((m == 1) | (m == 2)))) < 129))) {
          condval_3 = ((((((((((int)blockIdx.y) * 163840) + (((int)((m == 1) | (m == 2))) * 81920)) + (((int)blockIdx.x) * 1024)) + (((int)((m == 2) | (m == 3))) * 512)) + (((((int)threadIdx.x) >> 2) >> 2) * 256)) + (((((int)threadIdx.x) >> 2) & 3) * 64)) + ((((int)threadIdx.x) & 3) * 16)) - 82432);
        } else {
          condval_3 = -1;
        }
        nr_tl_shallow_joint::ld128((&(sk[0])), (&(Y[condval_3])));
      }
    }
    #pragma unroll
    ...
    if (((((1 <= ((((int)blockIdx.x) * 2) + ((int)((m == 2) | (m == 3))))) & (((((int)blockIdx.x) * 2) + ((int)((m == 2) | (m == 3)))) < 161)) & (1 <= ((((int)blockIdx.y) * 2) + ((int)((m == 1) | (m == 2)))))) & (((((int)blockIdx.y) * 2) + ((int)((m == 1) | (m == 2)))) < 129)) & ((((int)threadIdx.x) & 20) == 0)) {
      if (0 <= (((((((((((int)threadIdx.x) & 1) * 1024) + ((((((((int)blockIdx.y) * 4) + (((int)((m == 1) | (m == 2))) * 2)) + ((((int)threadIdx.x) >> 1) & 1)) - 2) & 7) * 128)) + ((((((((int)blockIdx.x) * 4) + (((int)((m == 2) | (m == 3))) * 2)) + ((((int)threadIdx.x) >> 3) & 1)) - 2) & 7) * 16)) >> 10) * 2560) + ((((((((int)blockIdx.y) * 4) + (((int)((m == 1) | (m == 2))) * 2)) + ((((int)threadIdx.x) >> 1) & 1)) - 2) >> 3) * 80)) + (((((((((int)threadIdx.x) & 1) * 1024) + ((((((((int)blockIdx.y) * 4) + (((int)((m == 1) | (m == 2))) * 2)) + ((((int)threadIdx.x) >> 1) & 1)) - 2) & 7) * 128)) + ((((((((int)blockIdx.x) * 4) + (((int)((m == 2) | (m == 3))) * 2)) + ((((int)threadIdx.x) >> 3) & 1)) - 2) & 7) * 16)) >> 7) & 7) * 10)) + (((((((int)blockIdx.x) * 4) + (((int)((m == 2) | (m == 3))) * 2)) + ((((int)threadIdx.x) >> 3) & 1)) - 2) >> 5))) {
        nr_tl_shallow_joint::ld128((&(mp[0])), (&(X[(((((((((((((int)threadIdx.x) & 1) * 1024) + ((((((((int)blockIdx.y) * 4) + (((int)((m == 1) | (m == 2))) * 2)) + ((((int)threadIdx.x) >> 1) & 1)) - 2) & 7) * 128)) + ((((((((int)blockIdx.x) * 4) + (((int)((m == 2) | (m == 3))) * 2)) + ((((int)threadIdx.x) >> 3) & 1)) - 2) & 7) * 16)) >> 10) * 1310720) + ((((((((int)blockIdx.y) * 4) + (((int)((m == 1) | (m == 2))) * 2)) + ((((int)threadIdx.x) >> 1) & 1)) - 2) >> 3) * 40960)) + (((((((((int)threadIdx.x) & 1) * 1024) + ((((((((int)blockIdx.y) * 4) + (((int)((m == 1) | (m == 2))) * 2)) + ((((int)threadIdx.x) >> 1) & 1)) - 2) & 7) * 128)) + ((((((((int)blockIdx.x) * 4) + (((int)((m == 2) | (m == 3))) * 2)) + ((((int)threadIdx.x) >> 3) & 1)) - 2) & 7) * 16)) >> 7) & 7) * 5120)) + ((((((((int)blockIdx.x) * 4) + (((int)((m == 2) | (m == 3))) * 2)) + ((((int)threadIdx.x) >> 3) & 1)) - 2) >> 5) * 512)) + (((((((((int)blockIdx.x) * 4) + (((int)((m == 2) | (m == 3))) * 2)) + ((((int)threadIdx.x) >> 3) & 1)) - 2) >> 3) & 3) * 128)) + (((((((int)threadIdx.x) & 1) * 1024) + ((((((((int)blockIdx.y) * 4) + (((int)((m == 1) | (m == 2))) * 2)) + ((((int)threadIdx.x) >> 1) & 1)) - 2) & 7) * 128)) + ((((((((int)blockIdx.x) * 4) + (((int)((m == 2) | (m == 3))) * 2)) + ((((int)threadIdx.x) >> 3) & 1)) - 2) & 7) * 16)) & 127))])));
      }
    }
    #pragma unroll
    for (int p = 0; p < 2; ++p) {
      ...
      for (int i = 0; i < 2; ++i) {
        ...
        if ((((1 <= ((((int)blockIdx.x) * 2) + ((int)((m == 2) | (m == 3))))) & (((((int)blockIdx.x) * 2) + ((int)((m == 2) | (m == 3)))) < 161)) & (1 <= ((((int)blockIdx.y) * 2) + ((int)((m == 1) | (m == 2)))))) & (((((int)blockIdx.y) * 2) + ((int)((m == 1) | (m == 2)))) < 129)) {
          ...
          for (int j_4 = 0; j_4 < 2; ++j_4) {
            ...
            raw[((((m * 8) + (p * 4)) + (j_4 * 2)) + i)] = nr_tl_shallow::pack(((half_t)nr_tl_shallow::hfma(((half_t)nr_tl_shallow::une4((sv >> ((uint)(j_4 * 16))))), Adapter[((((((int)threadIdx.x) & 3) * 8) + (p * 4)) + (j_4 * 2))], ((half_t)nr_tl_shallow::hmul(((half_t)nr_tl_shallow::une4((condval_7 >> ((uint)(j_4 * 16))))), Gate[((((((int)threadIdx.x) & 3) * 8) + (p * 4)) + (j_4 * 2))])))), ((half_t)nr_tl_shallow::hfma(((half_t)nr_tl_shallow::une4((sv >> ((uint)((j_4 * 16) + 8))))), Adapter[(((((((int)threadIdx.x) & 3) * 8) + (p * 4)) + (j_4 * 2)) + 1)], ((half_t)nr_tl_shallow::hmul(((half_t)nr_tl_shallow::une4((condval_10 >> ((uint)((j_4 * 16) + 8))))), Gate[(((((((int)threadIdx.x) & 3) * 8) + (p * 4)) + (j_4 * 2)) + 1)])))));
          }
        }
      }
    }
  ...
  for (int j_5 = 0; j_5 < 32; ++j_5) {
    ff[j_5] = nr_tl_shallow::mul(raw[j_5], nr_tl_shallow::pack(G0[((((j_5 & 7) >> 1) * 8) + ((((int)threadIdx.x) & 3) * 2))], G0[(((((j_5 & 7) >> 1) * 8) + ((((int)threadIdx.x) & 3) * 2)) + 1)]));
  }
      ...
      for (int p_5 = 0; p_5 < 2; ++p_5) {
        ...
        for (int i_4 = 0; i_4 < 2; ++i_4) {
          if (component == 0) {
            ...
            qa[(((m_7 * 4) + (p_5 * 2)) + i_4)] = (nr_tl_shallow::e4pair(z[(((condval_15 * (int64_t)8) + (((int64_t)p_5) * (int64_t)4)) + ((int64_t)i_4))]) | (nr_tl_shallow::e4pair(z[((((condval_19 * (int64_t)8) + (((int64_t)p_5) * (int64_t)4)) + ((int64_t)i_4)) + (int64_t)2)]) << (uint)16));
          }
          if (component == 1) {
            int64_t condval_21;
            if ((((int64_t)m_7) == (int64_t)0)) {
            ...
            kb[(((m_7 * 4) + (i_4 * 2)) + p_5)] = (nr_tl_shallow::e4pair(z[(((condval_23 * (int64_t)8) + (((int64_t)p_5) * (int64_t)4)) + ((int64_t)i_4))]) | (nr_tl_shallow::e4pair(z[((((condval_27 * (int64_t)8) + (((int64_t)p_5) * (int64_t)4)) + ((int64_t)i_4)) + (int64_t)2)]) << (uint)16));
          }
        }
      }
    }
    if (component == 2) {
      ...
      for (int part_1 = 0; part_1 < 2; ++part_1) {
        ...
        for (int n_3 = 0; n_3 < 4; ++n_3) {
          ...
          vb[((part_1 * 8) + (n_3 * 2))] = (nr_tl_shallow::e4pair(nr_tl_shallow::transpose(z[((condval_30 * (int64_t)8) + (((int64_t)n_3) * (int64_t)2))])) | (nr_tl_shallow::e4pair(nr_tl_shallow::transpose(z[(((condval_32 * (int64_t)8) + (((int64_t)n_3) * (int64_t)2)) + (int64_t)1)])) << (uint)16));
          int64_t condval_33;
          if ((((int64_t)part_1) == (int64_t)0)) {
          ...
          vb[(((part_1 * 8) + (n_3 * 2)) + 1)] = (nr_tl_shallow::e4pair(nr_tl_shallow::transpose(z[((condval_34 * (int64_t)8) + (((int64_t)n_3) * (int64_t)2))])) | (nr_tl_shallow::e4pair(nr_tl_shallow::transpose(z[(((condval_36 * (int64_t)8) + (((int64_t)n_3) * (int64_t)2)) + (int64_t)1)])) << (uint)16));
        }
      }
    }
  }
  ...
  for (int slab = 0; slab < 2; ++slab) {
    ...
    for (int j_12 = 0; j_12 < 16; ++j_12) {
      ...
      if ((((((int64_t)slab) * (int64_t)2) + (((int64_t)j_12) >> (int64_t)3)) == (int64_t)0)) {
        condval_37 = (int64_t)0;
      } else {
        int64_t condval_38;
        if ((((((int64_t)slab) * (int64_t)2) + (((int64_t)j_12) >> (int64_t)3)) == (int64_t)1)) {
          condval_38 = (int64_t)3;
        } else {
          condval_38 = (((((int64_t)slab) * (int64_t)2) + (((int64_t)j_12) >> (int64_t)3)) - (int64_t)1);
        }
        condval_37 = condval_38;
      }
      int64_t condval_39;
      if ((((((int64_t)slab) * (int64_t)2) + (((int64_t)j_12) >> (int64_t)3)) == (int64_t)0)) {
        condval_39 = (int64_t)0;
      } else {
        int64_t condval_40;
        if ((((((int64_t)slab) * (int64_t)2) + (((int64_t)j_12) >> (int64_t)3)) == (int64_t)1)) {
          condval_40 = (int64_t)3;
        } else {
          condval_40 = (((((int64_t)slab) * (int64_t)2) + (((int64_t)j_12) >> (int64_t)3)) - (int64_t)1);
        }
        condval_39 = condval_40;
      }
      out[j_12] = nr_tl_shallow::mul(ff[((condval_39 * (int64_t)8) + (((int64_t)j_12) & (int64_t)7))], nr_tl_shallow::pack(G1[((((j_12 & 7) >> 1) * 8) + ((((int)threadIdx.x) & 3) * 2))], G1[(((((j_12 & 7) >> 1) * 8) + ((((int)threadIdx.x) & 3) * 2)) + 1)]));
    }
    #pragma unroll
    ...
    for (int kp = 0; kp < 2; ++kp) {
      ...
      for (int i_7 = 0; i_7 < 2; ++i_7) {
        b_4[i_7] = nr_tl_shallow::pack(Readout[((((kp * 128) + (i_7 * 64)) + ((((int)threadIdx.x) & 3) * 16)) + (((int)threadIdx.x) >> 2))], Readout[(((((kp * 128) + (i_7 * 64)) + ((((int)threadIdx.x) & 3) * 16)) + (((int)threadIdx.x) >> 2)) + 8)]);
      }
      #pragma unroll
    ...
    if ((((slab * 2) + (((int)threadIdx.x) >> 4)) == 0)) {
      ...
      if ((((slab * 2) + (((int)threadIdx.x) >> 4)) == 1)) {
        ...
        condval_42 = (((slab * 2) + (((int)threadIdx.x) >> 4)) - 1);
      }
    ...
    if ((((slab * 2) + (((int)threadIdx.x) >> 4)) == 0)) {
      ...
      if ((((slab * 2) + (((int)threadIdx.x) >> 4)) == 1)) {
        ...
        condval_44 = (((slab * 2) + (((int)threadIdx.x) >> 4)) - 1);
      }
    ...
    if ((((slab * 2) + (((int)threadIdx.x) >> 4)) == 0)) {
      ...
      if ((((slab * 2) + (((int)threadIdx.x) >> 4)) == 1)) {
        ...
        condval_46 = (((slab * 2) + (((int)threadIdx.x) >> 4)) - 1);
      }
    ...
    if ((((slab * 2) + (((int)threadIdx.x) >> 4)) == 0)) {
      ...
      if ((((slab * 2) + (((int)threadIdx.x) >> 4)) == 1)) {
        ...
        condval_48 = (((slab * 2) + (((int)threadIdx.x) >> 4)) - 1);
      }
    ...
    if ((((1 <= ((((int)blockIdx.x) * 2) + ((int)((condval_41 == 2) | (condval_43 == 3))))) & (((((int)blockIdx.x) * 2) + ((int)((condval_45 == 2) | (condval_47 == 3)))) < 161)) & (1 <= ((((int)blockIdx.y) * 2) + ((int)((condval_49 == 1) | (condval_51 == 2)))))) & (((((int)blockIdx.y) * 2) + ((int)((condval_53 == 1) | (condval_55 == 2)))) < 129)) {
      #pragma unroll
      for (int j_15 = 0; j_15 < 4; ++j_15) {
        ...
        if (641 <= (((((((int)blockIdx.y) * 1280) + (((int)((condval_57 == 1) | (condval_59 == 2))) * 640)) + (((((int)threadIdx.x) & 15) >> 2) * 160)) + (((int)blockIdx.x) * 2)) + ((int)((condval_61 == 2) | (condval_63 == 3))))) {
          int condval_65;
          if ((((slab * 2) + (((int)threadIdx.x) >> 4)) == 0)) {
            condval_65 = 0;
          } else {
          ...
          if ((((((((int)blockIdx.y) * 1280) + (((int)((condval_65 == 1) | (condval_67 == 2))) * 640)) + (((((int)threadIdx.x) & 15) >> 2) * 160)) + (((int)blockIdx.x) * 2)) + ((int)((condval_69 == 2) | (condval_71 == 3)))) < 82561) {
            int condval_73;
            if ((((slab * 2) + (((int)threadIdx.x) >> 4)) == 0)) {
              condval_73 = 0;
            } else {
            ...
            Head[((((((((((int)blockIdx.y) * 20480) + (((int)((condval_81 == 1) | (condval_83 == 2))) * 10240)) + (((((int)threadIdx.x) & 15) >> 2) * 2560)) + (((int)blockIdx.x) * 32)) + (((int)((condval_85 == 2) | (condval_87 == 3))) * 16)) + (((((int)threadIdx.x) & 15) & 3) * 4)) + j_15) - 10256)] = v;
          }
        }
      }
    }
