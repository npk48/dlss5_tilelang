...
extern "C" __global__ void main_kernel(const uchar* __restrict__ A, int* __restrict__ C0, int* __restrict__ C1, const int* __restrict__ M, uchar* __restrict__ O, int count, int n0, int n1, int sizes_0, int sizes_2, int sizes_3, int v0, int v1);
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(const uchar* __restrict__ A, int* __restrict__ C0, int* __restrict__ C1, const int* __restrict__ M, uchar* __restrict__ O, int count, int n0, int n1, int sizes_0, int sizes_2, int sizes_3, int v0, int v1) {
  if (((((int)blockIdx.x) * 256) + ((int)threadIdx.x)) < count) {
    if (((((int)blockIdx.x) * 256) + ((int)threadIdx.x)) < sizes_3) {
      int condval_1;
      ...
      uchar condval;
      if (((0 <= condval_1) && (condval_2 < sizes_0))) {
        int64_t condval_3;
      ...
      O[((((int64_t)((int)blockIdx.x)) * (int64_t)256) + ((int64_t)((int)threadIdx.x)))] = condval;
    }
  }
  if (((int)blockIdx.x) == 0) {
