...
extern "C" __global__ void main_kernel(const half_t* __restrict__ AH, const half_t* __restrict__ BH, int* __restrict__ C0, const int* __restrict__ M, uchar* __restrict__ O, const int* __restrict__ P);
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(const half_t* __restrict__ AH, const half_t* __restrict__ BH, int* __restrict__ C0, const int* __restrict__ M, uchar* __restrict__ O, const int* __restrict__ P) {
  half_t condval;
