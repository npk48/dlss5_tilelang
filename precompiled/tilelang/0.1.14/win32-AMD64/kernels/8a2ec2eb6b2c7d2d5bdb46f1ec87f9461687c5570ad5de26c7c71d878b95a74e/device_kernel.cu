...
extern "C" __global__ void main_kernel(const uchar* __restrict__ A, int* __restrict__ C0, uchar* __restrict__ Raw, const uchar* __restrict__ Skip, const uchar* __restrict__ Weight);
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(const uchar* __restrict__ A, int* __restrict__ C0, uchar* __restrict__ Raw, const uchar* __restrict__ Skip, const uchar* __restrict__ Weight) {
  ...
  for (int r = 0; r < 2; ++r) {
    for (int n = 0; n < 8; ++n) {
      for (int h = 0; h < 2; ++h) {
        c[(((r * 16) + (n * 2)) + h)] = (uint)0;
        v = (uint)0;
        if ((((((int)blockIdx.x) % 3) * 2) + ((((((int)threadIdx.x) >> 7) * 2) + r) & 1)) < 5) {
          v = ((nr_ld32((&(Skip[((((((((((((((((int)blockIdx.y) * 81920) + ((((int)threadIdx.x) >> 7) * 40960)) + ((((int)blockIdx.x) % 3) * 16384)) + (((((((int)threadIdx.x) >> 7) * 2) + r) & 1) * 8192)) + ((((int)blockIdx.x) / 3) * 4096)) + (((((int)threadIdx.x) >> 5) & 3) * 1024)) + (((n * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 1)) + ((((n * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 6) << 3)) + ((((n * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 8) >> 2)) + ((((n * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 16) >> 1)) + ((((n * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 32) << 4)) + (((((((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) >> 2) & 1) * 8) + ((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) & 3) * 2)) + ((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) >> 3) & 1)) & 1) << 2)) + (((((((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) >> 2) & 1) * 8) + ((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) & 3) * 2)) + ((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) >> 3) & 1)) & 14) << 5)) & -4)]))) >> ((uint)(((((((((((((((((int)blockIdx.y) * 81920) + ((((int)threadIdx.x) >> 7) * 40960)) + ((((int)blockIdx.x) % 3) * 16384)) + (((((((int)threadIdx.x) >> 7) * 2) + r) & 1) * 8192)) + ((((int)blockIdx.x) / 3) * 4096)) + (((((int)threadIdx.x) >> 5) & 3) * 1024)) + (((n * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 1)) + ((((n * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 6) << 3)) + ((((n * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 8) >> 2)) + ((((n * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 16) >> 1)) + ((((n * 8) + (((((int)threadIdx.x) & 31) & 3) * 2)) & 32) << 4)) + (((((((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) >> 2) & 1) * 8) + ((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) & 3) * 2)) + ((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) >> 3) & 1)) & 1) << 2)) + (((((((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) >> 2) & 1) * 8) + ((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) & 3) * 2)) + ((((h * 8) + ((((int)threadIdx.x) & 31) >> 2)) >> 3) & 1)) & 14) << 5)) & 3) * 8))) & (uint)65535);
        }
        uint a = nr_decode2(v);
  ...
  for (int g = 0; g < 8; ++g) {
    for (int z = 0; z < 4; ++z) {
      uint condval;
      if (((((((int)blockIdx.x) % 3) * 2) + ((((int)threadIdx.x) >> 6) & 1)) < 5)) {
        condval = nr_ld32((&(A[((((((((((int)blockIdx.y) * 81920) + ((((int)threadIdx.x) >> 7) * 40960)) + ((((int)blockIdx.x) % 3) * 16384)) + (((((int)threadIdx.x) >> 6) & 1) * 8192)) + (g * 1024)) + (((((int)threadIdx.x) >> 5) & 1) * 512)) + ((((int)threadIdx.x) & 31) * 16)) + (z * 4))])));
      } else {
        condval = (uint)0;
      }
  ...
  for (int r_3 = 0; r_3 < 2; ++r_3) {
    if ((((((int)blockIdx.x) % 3) * 2) + ((((((int)threadIdx.x) >> 7) * 2) + r_3) & 1)) < 5) {
      for (int z_2 = 0; z_2 < 8; ++z_2) {
        ...
        nr_st32((&(Raw[(((((((((((int)blockIdx.y) * 81920) + ((((int)threadIdx.x) >> 7) * 40960)) + ((((int)blockIdx.x) % 3) * 16384)) + (((((((int)threadIdx.x) >> 7) * 2) + r_3) & 1) * 8192)) + ((((int)blockIdx.x) / 3) * 4096)) + (((((int)threadIdx.x) >> 5) & 3) * 1024)) + ((z_2 >> 2) * 512)) + ((((int)threadIdx.x) & 31) * 16)) + ((z_2 & 3) * 4))])), v_1);
      }
    }
  }
