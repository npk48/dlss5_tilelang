...
extern "C" __global__ void __launch_bounds__(128, 1) kernel_kernel(const int* __restrict__ AG, const int* __restrict__ FG, int* __restrict__ RW, const int* __restrict__ SW, const int* __restrict__ WB, const int* __restrict__ WP, const int* __restrict__ WQ, const int* __restrict__ WR, const int* __restrict__ WS, const int* __restrict__ WT, const int* __restrict__ WX) {
  ...
  for (int slab = 0; slab < 2; ++slab) {
    ...
    for (int parity = 0; parity < 2; ++parity) {
      int condval;
      if (((((bool)1 & (bool)1) & (1 <= (((((int)blockIdx.x) / 10) * 2) + ((((((slab * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) >> 1)))) & ((((((int)blockIdx.x) / 10) * 2) + ((((((slab * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) >> 1)) < 17))) {
        condval = (((((((((((int)blockIdx.x) / 10) * 81920) + (((((((slab * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) >> 1) * 40960)) + ((((int)blockIdx.x) % 10) * 4096)) + (((((((slab * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7) >> 2) * 2048)) + ((((((((((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & -15) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & 2) << 2)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & 4) >> 1)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & 8) >> 1)) & 1) | (((((((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & -15) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & 2) << 2)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & 4) >> 1)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & 8) >> 1)) & 6) << 3)) | (((((((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & -15) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & 2) << 2)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & 4) >> 1)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & 8) >> 1)) & 8) >> 2)) | (((((((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & -15) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & 2) << 2)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & 4) >> 1)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & 8) >> 1)) & 16) >> 1)) | (((((((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & -15) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & 2) << 2)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & 4) >> 1)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 4)) & 8) >> 1)) & 224) << 4))) + (((((((((((((int)blockIdx.x) / 10) * 8) + ((((((slab * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) - 4) >> 1) & 1) | (((((((int)blockIdx.x) % 10) * 8) + (((((slab * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7)) & 3) << 1)) | (((((((((int)blockIdx.x) / 10) * 8) + ((((((slab * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) - 4) & 1) << 3)) & 1) << 2)) + (((((((((((((int)blockIdx.x) / 10) * 8) + ((((((slab * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) - 4) >> 1) & 1) | (((((((int)blockIdx.x) % 10) * 8) + (((((slab * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7)) & 3) << 1)) | (((((((((int)blockIdx.x) / 10) * 8) + ((((((slab * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab * 32) + (parity * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) - 4) & 1) << 3)) & 14) << 5)) - 40960);
      } else {
        condval = -1;
      }
      v = condval;
      ...
      *(uint4*)(temp + 0) = make_uint4(broadcast_var, broadcast_var, broadcast_var, broadcast_var);
      if ((0 <= raw) & (raw <= 19889552)) {
        {
          int SW_local_cast[4];
          *(int4*)(SW_local_cast + 0) = *(int4*)(SW + (((raw >> 4) * 4) + 10117120));
          uint4 __1;
  ...
  for (int slab_2 = 0; slab_2 < 2; ++slab_2) {
    ...
    for (int parity_1 = 0; parity_1 < 2; ++parity_1) {
      int condval_3;
      if (((((bool)1 & (bool)1) & (1 <= (((((int)blockIdx.x) / 10) * 2) + ((((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) >> 1)))) & ((((((int)blockIdx.x) / 10) * 2) + ((((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) >> 1)) < 17))) {
        condval_3 = (((((((((((int)blockIdx.x) / 10) * 81920) + (((((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) >> 1) * 40960)) + ((((int)blockIdx.x) % 10) * 4096)) + (((((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7) >> 2) * 2048)) + ((((((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 2)) & 1) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 2)) & 6) << 3)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 2)) & 8) >> 2)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 2)) & 16) >> 1)) | (((((((int)threadIdx.x) >> 5) * 32) + ((((int)threadIdx.x) & 3) * 2)) & 224) << 4))) + (((((((((((((int)blockIdx.x) / 10) * 8) + ((((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) - 4) >> 1) & 1) | (((((((int)blockIdx.x) % 10) * 8) + (((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7)) & 3) << 1)) | (((((((((int)blockIdx.x) / 10) * 8) + ((((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) - 4) & 1) << 3)) & 1) << 2)) + (((((((((((((int)blockIdx.x) / 10) * 8) + ((((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) - 4) >> 1) & 1) | (((((((int)blockIdx.x) % 10) * 8) + (((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 1) & 7)) & 3) << 1)) | (((((((((int)blockIdx.x) / 10) * 8) + ((((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) >> 4) & 3) * 2)) + ((((slab_2 * 32) + (parity_1 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 1)) - 4) & 1) << 3)) & 14) << 5)) - 40960);
      } else {
        condval_3 = -1;
      }
      v_28 = condval_3;
      ...
      if ((0 <= raw_1) & (raw_1 <= 19234192)) {
        {
          ...
          *(int4*)(RW + (((raw_1 >> 4) * 4) + 10280960)) = *(int4*)(RW_local_cast_1 + 0);
        }
      }
    }
    __syncthreads();
