...
def call(kernels, R, Source, W, Proj, Gate, Rows, PO, Matrix, UG, UL, tiles, height, width, gx, sx, sy, rn, sn, wn, inp, out, counter, prn, gn, skip, drn, pon, mn, poolout, ugn, uln, planar_rows, stream=0):
    ...
    arg_values = Matrix.data_ptr(), PO.data_ptr(), R.data_ptr(), Rows.data_ptr(), Source.data_ptr(), W.data_ptr(), counter, drn, gx, height, inp, mn, out, pon, poolout, rn, sn, sx, sy, tiles, width, wn
    arg_types = ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32
