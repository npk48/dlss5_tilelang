...
extern "C" __global__ void main_kernel(const uchar* __restrict__ A, int* __restrict__ C0, const int* __restrict__ M, uchar* __restrict__ O);
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(const uchar* __restrict__ A, int* __restrict__ C0, const int* __restrict__ M, uchar* __restrict__ O) {
  uchar condval;
  if (((0 <= M[((((int)blockIdx.x) * 256) + ((int)threadIdx.x))]) && (M[((((int)blockIdx.x) * 256) + ((int)threadIdx.x))] < 163840))) {
