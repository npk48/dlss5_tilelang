...
def call(kernels, Wt0, Wt1, Wq, Wp, G0, G1, X, Y, Features, Adapter, Status, Mixed, Pre, Gate, Readout, Head, H0, W0, gx, gy, sizes_0, sizes_1, sizes_2, sizes_3, sizes_4, sizes_5, sizes_6, sizes_7, sizes_8, sizes_9, sizes_10, sizes_11, sizes_12, sizes_13, sizes_14, sizes_15, in_offset, out_offset, counter, pool_offset, skip_offset, stream=0):
    ...
    arg_values = G0.data_ptr(), G1.data_ptr(), Wp.data_ptr(), Wq.data_ptr(), Wt0.data_ptr(), Wt1.data_ptr(), X.data_ptr(), H0, W0, counter, gx, gy, in_offset, out_offset, sizes_0, sizes_1, sizes_2, sizes_3, sizes_4, sizes_5, sizes_6
    arg_types = ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32
