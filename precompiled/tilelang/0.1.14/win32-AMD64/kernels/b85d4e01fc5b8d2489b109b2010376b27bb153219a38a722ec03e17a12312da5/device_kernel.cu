...
extern "C" __global__ void __launch_bounds__(64, 1) kernel_kernel(const int* __restrict__ AG, const int* __restrict__ FG, const int* __restrict__ Gate, const int* __restrict__ Inv, const int* __restrict__ Proj, int* __restrict__ RW, const int* __restrict__ WB, const int* __restrict__ WP, const int* __restrict__ WQ, const int* __restrict__ WR, const int* __restrict__ WS, const int* __restrict__ WT, const int* __restrict__ WX) {
  ...
  for (int m = 0; m < 4; ++m) {
    ...
    for (int word = 0; word < 4; ++word) {
      temp[0] = (uint)0;
      #pragma unroll
      for (int b_5 = 0; b_5 < 4; ++b_5) {
        v = ((((((((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) + b_5) & 3) | (((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) + b_5) & 12) << 2)) | (((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) + b_5) & 16) >> 1)) | (((((((((int)threadIdx.x) >> 5) * 32) + ((word >> 1) * 16)) + ((((int)threadIdx.x) & 3) * 4)) + b_5) & 32) << 4)) | (((((m * 16) + ((word & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 7) << 6)) | (((((m * 16) + ((word & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 8) >> 1)) | (((((m * 16) + ((word & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) & 48) << 6));
        v_1 = (((((int)blockIdx.x) / 20) * 2) + (v >> 11));
        v_2 = (((((int)blockIdx.x) % 20) * 2) + ((v & 2047) >> 10));
        int condval;
        if (((((0 <= v_1) & (0 <= v_2)) & (v_1 < 32)) & (v_2 < 40))) {
          condval = ((((v_1 * 40960) + (v_2 * 1024)) + (((v >> 9) & 1) * 512)) + (v & 511));
        } else {
          condval = -1;
        }
        v_3 = condval;
        ...
        if (0 <= raw) {
          ...
          int condval_2;
          if (((0 <= condval_3) && (condval_4 < 16528))) {
            int condval_5;
            if ((raw < 1310720)) {
          ...
          int condval_8;
          if (((0 <= condval_9) && (condval_10 < 327680))) {
            int condval_11;
            if ((raw < 1310720)) {
          ...
          temp[0] = (temp[0] | (value << ((uint)(b_5 * 8))));
        }
      }
      uint v_ = temp[0];
  ...
  for (int channel = 0; channel < 2; ++channel) {
    ...
    for (int m_1 = 0; m_1 < 2; ++m_1) {
      #pragma unroll
      for (int n = 0; n < 4; ++n) {
        int v__1 = S[(((((channel * 512) + ((((int)threadIdx.x) >> 5) * 256)) + (m_1 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + ((n >> 1) * 2))];
        int v__2 = S[((((((channel * 512) + ((((int)threadIdx.x) >> 5) * 256)) + (m_1 * 128)) + ((((int)threadIdx.x) & 31) * 4)) + ((n >> 1) * 2)) + 1)];
        int condval_14;
        if (((n % 2) == 0)) {
          condval_14 = 21520;
        } else {
        ...
        uint bits = wide_packet_prmt((*(uint *)(&(v__1))), (*(uint *)(&(v__2))), condval_14);
        int g = FG[(((channel * 16) + (n * 4)) + (((int)threadIdx.x) & 3))];
    ...
    for (int slab = 0; slab < 4; ++slab) {
      ...
      for (int kp = 0; kp < 2; ++kp) {
        ...
        for (int pair = 0; pair < 2; ++pair) {
          *(int4*)(b + 0) = *(int4*)(WX + (((((stream * 2048) + (kp * 1024)) + (slab * 256)) + (pair * 128)) + ((((int)threadIdx.x) & 31) * 4)));
          #pragma unroll
  ...
  for (int slab_1 = 0; slab_1 < 2; ++slab_1) {
    ...
    for (int kp_1 = 0; kp_1 < 2; ++kp_1) {
      ...
      for (int pair_3 = 0; pair_3 < 6; ++pair_3) {
        *(int4*)(b_3 + 0) = *(int4*)(WQ + ((((kp_1 * 1536) + ((((int)threadIdx.x) >> 5) * 768)) + (pair_3 * 128)) + ((((int)threadIdx.x) & 31) * 4)));
        #pragma unroll
      ...
      if (comp == 0) {
        ...
        for (int m_14 = 0; m_14 < 2; ++m_14) {
          ...
          for (int j = 0; j < 2; ++j) {
            ...
            uint b_6 = Z[((((m_14 * 24) + (comp * 8)) + j) + 2)];
            uint c = Z[((((m_14 * 24) + (comp * 8)) + j) + 4)];
            uint d = Z[((((m_14 * 24) + (comp * 8)) + j) + 6)];
            uint s0 = wide_add(wide_fma(a_3, a_3, wide_mul(c, c)), wide_fma(b_6, b_6, wide_mul(d, d)));
        ...
        for (int m_15 = 0; m_15 < 2; ++m_15) {
          if (comp == 1) {
            ...
            for (int j_1 = 0; j_1 < 2; ++j_1) {
              ...
              uint b_7 = Z[((((m_15 * 24) + (comp * 8)) + j_1) + 2)];
              uint c_1 = Z[((((m_15 * 24) + (comp * 8)) + j_1) + 4)];
              uint d_1 = Z[((((m_15 * 24) + (comp * 8)) + j_1) + 6)];
              uint s0_1 = wide_add(wide_fma(a_4, a_4, wide_mul(c_1, c_1)), wide_fma(b_7, b_7, wide_mul(d_1, d_1)));
  ...
  for (int word_4 = 0; word_4 < 16; ++word_4) {
    v_13 = QP[((((((((((((0 | ((word_4 * 128) & 1)) | ((((word_4 * 128) >> 1) & 1) << 7)) | ((((word_4 * 128) >> 2) & 1) << 2)) | ((((word_4 * 128) >> 3) & 1) << 3)) | ((((word_4 * 128) >> 4) & 1) << 4)) | ((((word_4 * 128) >> 5) & 1) << 5)) | ((((word_4 * 128) >> 6) & 1) << 6)) | ((((word_4 * 128) >> 7) & 1) << 1)) | ((((word_4 * 128) >> 8) & 1) << 8)) | ((((word_4 * 128) >> 9) & 1) << 9)) | ((((word_4 * 128) >> 10) & 1) << 10)) >> 7)];
    v_14 = QP[((((((((((((0 | (((word_4 * 128) + 2) & 1)) | (((((word_4 * 128) + 2) >> 1) & 1) << 7)) | (((((word_4 * 128) + 2) >> 2) & 1) << 2)) | (((((word_4 * 128) + 2) >> 3) & 1) << 3)) | (((((word_4 * 128) + 2) >> 4) & 1) << 4)) | (((((word_4 * 128) + 2) >> 5) & 1) << 5)) | (((((word_4 * 128) + 2) >> 6) & 1) << 6)) | (((((word_4 * 128) + 2) >> 7) & 1) << 1)) | (((((word_4 * 128) + 2) >> 8) & 1) << 8)) | (((((word_4 * 128) + 2) >> 9) & 1) << 9)) | (((((word_4 * 128) + 2) >> 10) & 1) << 10)) >> 7)];
    ...
    Q[word_4] = v_15;
    v_16 = KP[((((((((((((0 | ((word_4 * 128) & 1)) | ((((word_4 * 128) >> 1) & 1) << 7)) | ((((word_4 * 128) >> 2) & 1) << 2)) | ((((word_4 * 128) >> 3) & 1) << 3)) | ((((word_4 * 128) >> 4) & 1) << 4)) | ((((word_4 * 128) >> 5) & 1) << 5)) | ((((word_4 * 128) >> 6) & 1) << 6)) | ((((word_4 * 128) >> 7) & 1) << 8)) | ((((word_4 * 128) >> 8) & 1) << 1)) | ((((word_4 * 128) >> 9) & 1) << 9)) | ((((word_4 * 128) >> 10) & 1) << 10)) >> 7)];
    v_17 = KP[((((((((((((0 | (((word_4 * 128) + 2) & 1)) | (((((word_4 * 128) + 2) >> 1) & 1) << 7)) | (((((word_4 * 128) + 2) >> 2) & 1) << 2)) | (((((word_4 * 128) + 2) >> 3) & 1) << 3)) | (((((word_4 * 128) + 2) >> 4) & 1) << 4)) | (((((word_4 * 128) + 2) >> 5) & 1) << 5)) | (((((word_4 * 128) + 2) >> 6) & 1) << 6)) | (((((word_4 * 128) + 2) >> 7) & 1) << 8)) | (((((word_4 * 128) + 2) >> 8) & 1) << 1)) | (((((word_4 * 128) + 2) >> 9) & 1) << 9)) | (((((word_4 * 128) + 2) >> 10) & 1) << 10)) >> 7)];
    v_18 = wide_packet_prmt(v_16, v_17, (((((uint)0 | (((uint)((((((((((((0 | (((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) & 1)) | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 1) & 1) << 7)) | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 2) & 1) << 2)) | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 3) & 1) << 3)) | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 4) & 1) << 4)) | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 5) & 1) << 5)) | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 6) & 1) << 6)) | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 7) & 1) << 8)) | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 8) & 1) << 1)) | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 9) & 1) << 9)) | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 10) & 1) << 10)) & 3)) << (uint)0)) | (((uint)((((((((((((0 | ((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) & 1)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 1) & 1) << 7)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 2) & 1) << 2)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 3) & 1) << 3)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 4) & 1) << 4)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 5) & 1) << 5)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 6) & 1) << 6)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 7) & 1) << 8)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 8) & 1) << 1)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 9) & 1) << 9)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 10) & 1) << 10)) & 3)) << (uint)4)) | (((uint)(((((((((((((0 | ((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 2) & 1)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 1) & 1) << 7)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 2) & 1) << 2)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 3) & 1) << 3)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 4) & 1) << 4)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 5) & 1) << 5)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 6) & 1) << 6)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 7) & 1) << 8)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 8) & 1) << 1)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 9) & 1) << 9)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 10) & 1) << 10)) & 3) + 4)) << (uint)8)) | (((uint)(((((((((((((0 | ((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 3) & 1)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 1) & 1) << 7)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 2) & 1) << 2)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 3) & 1) << 3)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 4) & 1) << 4)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 5) & 1) << 5)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 6) & 1) << 6)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 7) & 1) << 8)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 8) & 1) << 1)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 9) & 1) << 9)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 10) & 1) << 10)) & 3) + 4)) << (uint)12)));
    K[word_4] = v_18;
    v_19 = wide_shfl(VP[((((((((((((0 | (((word_4 * 128) & 1) << 4)) | ((((word_4 * 128) >> 1) & 1) << 1)) | ((((word_4 * 128) >> 2) & 1) << 5)) | ((((word_4 * 128) >> 3) & 1) << 6)) | (((word_4 * 128) >> 4) & 1)) | ((((word_4 * 128) >> 5) & 1) << 2)) | ((((word_4 * 128) >> 6) & 1) << 3)) | ((((word_4 * 128) >> 7) & 1) << 9)) | ((((word_4 * 128) >> 8) & 1) << 7)) | ((((word_4 * 128) >> 9) & 1) << 8)) | ((((word_4 * 128) >> 10) & 1) << 10)) >> 7)], (((((((((((((0 | ((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) & 1) << 4)) | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 1) & 1) << 1)) | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 2) & 1) << 5)) | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 3) & 1) << 6)) | ((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 4) & 1)) | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 5) & 1) << 2)) | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 6) & 1) << 3)) | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 7) & 1) << 9)) | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 8) & 1) << 7)) | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 9) & 1) << 8)) | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 10) & 1) << 10)) & 127) >> 2));
    v_20 = wide_shfl(VP[((((((((((((0 | ((((word_4 * 128) + 1) & 1) << 4)) | (((((word_4 * 128) + 1) >> 1) & 1) << 1)) | (((((word_4 * 128) + 1) >> 2) & 1) << 5)) | (((((word_4 * 128) + 1) >> 3) & 1) << 6)) | ((((word_4 * 128) + 1) >> 4) & 1)) | (((((word_4 * 128) + 1) >> 5) & 1) << 2)) | (((((word_4 * 128) + 1) >> 6) & 1) << 3)) | (((((word_4 * 128) + 1) >> 7) & 1) << 9)) | (((((word_4 * 128) + 1) >> 8) & 1) << 7)) | (((((word_4 * 128) + 1) >> 9) & 1) << 8)) | (((((word_4 * 128) + 1) >> 10) & 1) << 10)) >> 7)], (((((((((((((0 | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) & 1) << 4)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 1) & 1) << 1)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 2) & 1) << 5)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 3) & 1) << 6)) | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 4) & 1)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 5) & 1) << 2)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 6) & 1) << 3)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 7) & 1) << 9)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 8) & 1) << 7)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 9) & 1) << 8)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 10) & 1) << 10)) & 127) >> 2));
    v_21 = wide_packet_prmt(v_19, v_20, (((((uint)0 | (((uint)((((((((((((0 | ((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) & 1) << 4)) | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 1) & 1) << 1)) | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 2) & 1) << 5)) | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 3) & 1) << 6)) | ((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 4) & 1)) | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 5) & 1) << 2)) | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 6) & 1) << 3)) | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 7) & 1) << 9)) | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 8) & 1) << 7)) | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 9) & 1) << 8)) | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 10) & 1) << 10)) & 3)) << (uint)0)) | (((uint)(((((((((((((0 | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) & 1) << 4)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 1) & 1) << 1)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 2) & 1) << 5)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 3) & 1) << 6)) | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 4) & 1)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 5) & 1) << 2)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 6) & 1) << 3)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 7) & 1) << 9)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 8) & 1) << 7)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 9) & 1) << 8)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 10) & 1) << 10)) & 3) + 4)) << (uint)4)) | (((uint)((((((((((((0 | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 2) & 1) << 4)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 1) & 1) << 1)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 2) & 1) << 5)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 3) & 1) << 6)) | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 4) & 1)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 5) & 1) << 2)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 6) & 1) << 3)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 7) & 1) << 9)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 8) & 1) << 7)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 9) & 1) << 8)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 10) & 1) << 10)) & 3)) << (uint)8)) | (((uint)(((((((((((((0 | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 3) & 1) << 4)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 1) & 1) << 1)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 2) & 1) << 5)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 3) & 1) << 6)) | (((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 4) & 1)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 5) & 1) << 2)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 6) & 1) << 3)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 7) & 1) << 9)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 8) & 1) << 7)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 9) & 1) << 8)) | ((((((word_4 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 10) & 1) << 10)) & 3) + 4)) << (uint)12)));
    V[word_4] = v_21;
  }
  __syncthreads();
  for (int slab_2 = 0; slab_2 < 2; ++slab_2) {
    ...
    for (int m_16 = 0; m_16 < 2; ++m_16) {
      ...
      for (int n_12 = 0; n_12 < 8; ++n_12) {
        uint64_t r_4 = wide_mma(Q[((slab_2 * 8) + (m_16 * 4))], Q[(((slab_2 * 8) + (m_16 * 4)) + 1)], Q[(((slab_2 * 8) + (m_16 * 4)) + 2)], Q[(((slab_2 * 8) + (m_16 * 4)) + 3)], K[(n_12 * 2)], K[((n_12 * 2) + 1)], WB[(((((((((int)threadIdx.x) >> 5) * 2048) + (slab_2 * 1024)) + (m_16 * 512)) + ((n_12 >> 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + ((n_12 & 1) * 2))], WB[((((((((((int)threadIdx.x) >> 5) * 2048) + (slab_2 * 1024)) + (m_16 * 512)) + ((n_12 >> 1) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + ((n_12 & 1) * 2)) + 1)]);
    ...
    for (int word_5 = 0; word_5 < 16; ++word_5) {
      v_22 = P[((((((((((((0 | ((word_5 * 128) & 1)) | ((((word_5 * 128) >> 1) & 1) << 7)) | ((((word_5 * 128) >> 2) & 1) << 2)) | ((((word_5 * 128) >> 3) & 1) << 3)) | ((((word_5 * 128) >> 4) & 1) << 4)) | ((((word_5 * 128) >> 5) & 1) << 5)) | ((((word_5 * 128) >> 6) & 1) << 6)) | ((((word_5 * 128) >> 7) & 1) << 1)) | ((((word_5 * 128) >> 8) & 1) << 8)) | ((((word_5 * 128) >> 9) & 1) << 10)) | ((((word_5 * 128) >> 10) & 1) << 9)) >> 7)];
      v_23 = P[((((((((((((0 | (((word_5 * 128) + 2) & 1)) | (((((word_5 * 128) + 2) >> 1) & 1) << 7)) | (((((word_5 * 128) + 2) >> 2) & 1) << 2)) | (((((word_5 * 128) + 2) >> 3) & 1) << 3)) | (((((word_5 * 128) + 2) >> 4) & 1) << 4)) | (((((word_5 * 128) + 2) >> 5) & 1) << 5)) | (((((word_5 * 128) + 2) >> 6) & 1) << 6)) | (((((word_5 * 128) + 2) >> 7) & 1) << 1)) | (((((word_5 * 128) + 2) >> 8) & 1) << 8)) | (((((word_5 * 128) + 2) >> 9) & 1) << 10)) | (((((word_5 * 128) + 2) >> 10) & 1) << 9)) >> 7)];
      v_24 = wide_packet_prmt(v_22, v_23, (((((uint)0 | (((uint)((((((((((((0 | (((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) & 1)) | (((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 1) & 1) << 7)) | (((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 2) & 1) << 2)) | (((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 3) & 1) << 3)) | (((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 4) & 1) << 4)) | (((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 5) & 1) << 5)) | (((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 6) & 1) << 6)) | (((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 7) & 1) << 1)) | (((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 8) & 1) << 8)) | (((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 9) & 1) << 10)) | (((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) >> 10) & 1) << 9)) & 3)) << (uint)0)) | (((uint)((((((((((((0 | ((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) & 1)) | ((((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 1) & 1) << 7)) | ((((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 2) & 1) << 2)) | ((((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 3) & 1) << 3)) | ((((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 4) & 1) << 4)) | ((((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 5) & 1) << 5)) | ((((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 6) & 1) << 6)) | ((((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 7) & 1) << 1)) | ((((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 8) & 1) << 8)) | ((((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 9) & 1) << 10)) | ((((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 1) >> 10) & 1) << 9)) & 3)) << (uint)4)) | (((uint)(((((((((((((0 | ((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 2) & 1)) | ((((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 1) & 1) << 7)) | ((((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 2) & 1) << 2)) | ((((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 3) & 1) << 3)) | ((((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 4) & 1) << 4)) | ((((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 5) & 1) << 5)) | ((((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 6) & 1) << 6)) | ((((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 7) & 1) << 1)) | ((((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 8) & 1) << 8)) | ((((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 9) & 1) << 10)) | ((((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 2) >> 10) & 1) << 9)) & 3) + 4)) << (uint)8)) | (((uint)(((((((((((((0 | ((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 3) & 1)) | ((((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 1) & 1) << 7)) | ((((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 2) & 1) << 2)) | ((((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 3) & 1) << 3)) | ((((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 4) & 1) << 4)) | ((((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 5) & 1) << 5)) | ((((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 6) & 1) << 6)) | ((((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 7) & 1) << 1)) | ((((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 8) & 1) << 8)) | ((((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 9) & 1) << 10)) | ((((((word_5 * 128) + ((((int)threadIdx.x) & 31) * 4)) + 3) >> 10) & 1) << 9)) & 3) + 4)) << (uint)12)));
      A[word_5] = v_24;
    }
    #pragma unroll
    ...
    for (int word_6 = 0; word_6 < 8; ++word_6) {
      ...
      Residual[word_6] = wide_packet_prmt((*(uint *)(&(v__4))), (*(uint *)(&(v__5))), condval_15);
    }
    __syncthreads();
    #pragma unroll
    for (int word_7 = 0; word_7 < 8; ++word_7) {
      ...
      uint _reinterpret_tmp_4 = v_27;
      S[((((((((int)threadIdx.x) >> 5) * 512) + (slab_2 * 256)) + ((word_7 >> 2) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + (word_7 & 3))] = (*(int *)(&(_reinterpret_tmp_4)));
    }
    __syncthreads();
    #pragma unroll
    for (int m_18 = 0; m_18 < 2; ++m_18) {
      ...
      for (int n_16 = 0; n_16 < 4; ++n_16) {
        int g_1 = AG[((((((int)threadIdx.x) >> 5) * 16) + (n_16 * 4)) + (((int)threadIdx.x) & 3))];
    ...
    for (int kp_3 = 0; kp_3 < 2; ++kp_3) {
      ...
      for (int pair_4 = 0; pair_4 < 2; ++pair_4) {
        *(int4*)(b_4 + 0) = *(int4*)(WP + ((((kp_3 * 512) + ((((int)threadIdx.x) >> 5) * 256)) + (pair_4 * 128)) + ((((int)threadIdx.x) & 31) * 4)));
        #pragma unroll
  ...
  for (int part = 0; part < 4; ++part) {
    ...
    v_42 = (((((int)blockIdx.x) / 20) * 2) + (v_41 >> 11));
    v_43 = (((((int)blockIdx.x) % 20) * 2) + ((v_41 & 2047) >> 10));
    int condval_20;
    if (((((0 <= v_42) & (0 <= v_43)) & (v_42 < 32)) & (v_43 < 40))) {
      condval_20 = ((((v_42 * 40960) + (v_43 * 1024)) + (((v_41 >> 9) & 1) * 512)) + (v_41 & 511));
    } else {
      condval_20 = -1;
    }
    v_44 = condval_20;
    int raw_1 = v_44;
    if ((0 <= raw_1) & (raw_1 <= 15957392)) {
      {
        int RW_local_cast[4];
        int4 __1;
        uint4 v__6 = *(uint4*)(A + (part * 4));
        __1.x = (int)(v__6.x);
        __1.y = (int)(v__6.y);
        __1.z = (int)(v__6.z);
        __1.w = (int)(v__6.w);
        *(int4*)(RW_local_cast + 0) = __1;
        *(int4*)(RW + (((raw_1 >> 4) * 4) + 11100160)) = *(int4*)(RW_local_cast + 0);
      }
    }
  }
  __syncthreads();
